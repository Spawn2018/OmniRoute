...
const NAV_ACTIONS = [
  ...
  { id: "nav-fleet", label: "Idź do floty", to: "/fleet" },
  { id: "nav-planning", label: "Idź do planowania", to: "/planning" },
  ...
  { id: "nav-tender-data-rooms", label: "Idź do pokoi danych przetargu", to: "/tender-data-rooms" },
  ...
  { id: "nav-charge-templates", label: "Idź do szablonów opłat", to: "/charge-templates" },
