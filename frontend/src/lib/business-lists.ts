export const BUSINESS_LISTS = {
  ...
  stopGroup: { route: "/stop-groups", tableKey: "stop_group" },
  palletBalance: { route: "/pallet-balances", tableKey: "pallet_balance" },
  palletLedger: { route: "/pallet-ledgers", tableKey: "pallet_ledger" },
  palletSynchroMark: { route: "/pallet-synchro-marks", tableKey: "pallet_synchro_mark" },
  ...
  handoverBindMark: {
    route: "/handover-bind-marks",
    tableKey: "handover_bind_mark",
  },
  productTicket: {
  ...
  localChargeBindMark: {
    route: "/local-charge-bind-marks",
    tableKey: "local_charge_bind_mark",
  },
  marginMatchMark: {
  ...
  invoiceMatchCandidate: { route: "/invoice-match-candidates", tableKey: "invoice_match_candidate" },
  createBlockMark: { route: "/create-block-marks", tableKey: "create_block_mark" },
  blocksCreateEnforcementMark: { route: "/blocks-create-enforcement-marks", tableKey: "blocks_create_enforcement_mark" },
  documentKindMatchMark: { route: "/document-kind-match-marks", tableKey: "document_kind_match_mark" },
  ...
  postalDispatchMark: { route: "/postal-dispatch-marks", tableKey: "postal_dispatch_mark" },
  shipmentMonitoringFiling: { route: "/shipment-monitoring-filings", tableKey: "shipment_monitoring_filing" },
  relationDocumentRequirement: { route: "/relation-document-requirements", tableKey: "relation_document_requirement" },
  ...
  task: { route: "/tasks", tableKey: "task" },
