...
export const OPS_JOBS = [
  ...
  {
    route: BUSINESS_LISTS.marginMatchMark.route,
    label: "Dopasowanie podłogi",
  ...
  {
    route: BUSINESS_LISTS.dataSource.route,
    label: "Zrodla danych",
  ...
  {
    route: BUSINESS_LISTS.cfoNarrativeMark.route,
    label: "Narracja CFO",
  ...
  {
    route: BUSINESS_LISTS.shipmentCloneMark.route,
    label: "Intencja klonu",
  ...
  {
    route: BUSINESS_LISTS.productTicket.route,
    label: "Ticket produktu",
    job: "katalog product_ticket HITL",
  },
  {
  ...
  {
    route: BUSINESS_LISTS.selfBillingMark.route,
    label: "Self-billing podwykonawcy",
    job: "katalog self_billing_mark HITL",
  },
  {
    route: BUSINESS_LISTS.purchaseInvoice.route,
    label: "Faktura zakupu",
    job: "katalog purchase_invoice HITL",
  },
  {
    route: BUSINESS_LISTS.invoiceMatchMark.route,
    label: "Dopasowanie FV zakupu",
  ...
  {
    route: BUSINESS_LISTS.postalDispatchMark.route,
    label: "Ksiazka PP",
  ...
  {
    route: BUSINESS_LISTS.relationDocumentRequirement.route,
    label: "Wymog dokumentow relacji",
    job: "katalog relation_document_requirement HITL",
  },
  {
    route: BUSINESS_LISTS.invoiceMatchCandidate.route,
    label: "Kandydat dopasowania FV",
  ...
  {
    route: BUSINESS_LISTS.documentKindMatchMark.route,
    label: "Dopasowanie rodzaju dokumentu",
    job: "katalog document_kind_match_mark HITL",
  },
  {
    route: BUSINESS_LISTS.filingBindMark.route,
    label: "Wiązanie zgłoszenia SENT/BDO",
    job: "katalog filing_bind_mark HITL",
  },
  {
    route: BUSINESS_LISTS.filingFkMark.route,
    label: "Cel FK zgłoszenia",
    job: "katalog filing_fk_mark HITL",
  },
  {
    route: BUSINESS_LISTS.aisImportMark.route,
    label: "AIS / AES / Intrastat",
    job: "katalog ais_import_mark HITL",
  },
  {
    route: BUSINESS_LISTS.wasteMark.route,
    label: "Odpady BDO / KPO / WSR",
  ...
  {
    route: BUSINESS_LISTS.costCategoryMark.route,
    label: "Cost category",
    job: "katalog cost_category_mark HITL",
  },
  {
    route: BUSINESS_LISTS.impactEdgeMark.route,
    label: "Krawedz skutku",
    job: "katalog impact_edge_mark HITL",
  },
  {
  ...
  {
    route: BUSINESS_LISTS.allocationKey.route,
    label: "Klucz alokacji",
  ...
  {
    route: BUSINESS_LISTS.crmDedupMark.route,
    label: "Dedup CRM",
    job: "katalog crm_dedup_mark HITL",
  },
  {
    route: BUSINESS_LISTS.crmLinkMark.route,
    label: "Link CRM",
  ...
  {
    route: BUSINESS_LISTS.shipperBindMark.route,
    label: "Bind załadowcy",
    job: "katalog shipper_bind_mark HITL",
  },
  {
    route: BUSINESS_LISTS.shipperAwardMark.route,
    label: "Award załadowcy",
  ...
  {
    route: BUSINESS_LISTS.shipperLikeMark.route,
    label: "Like-for-like załadowcy",
    job: "katalog shipper_like_mark HITL",
  },
  {
    route: BUSINESS_LISTS.shipperRoundMark.route,
    label: "Runda załadowcy",
    job: "katalog shipper_round_mark HITL",
  },
  {
