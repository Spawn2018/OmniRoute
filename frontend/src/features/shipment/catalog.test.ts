...
describe("shipment surface for 28.0 and 90.0", () => {
  ...
  it("records 90.0 as a live shipment table on /shipments", () => {
    ...
    expect(page).toContain("Flaga odpadu is_waste")
    expect(page).toContain("Data ETD etd")
    expect(page).toContain("Data załadunku loading_date")
    expect(page).toContain("Data wyładunku unloading_date")
    expect(page).toContain("Data faktury invoice_date")
    expect(ops).toContain('"628.0": "/shipments"')
    expect(page).not.toContain("qr")
    expect(page).not.toContain("parseFloat")
    expect(page).not.toContain("charge_sell_in_pln")
    expect(page).not.toContain("nbp_rate")
    ...
    expect(stop).toContain("weigh_in_kg")
    expect(stop).toContain("weigh_out_kg")
    ...
    expect(stop).toContain("no_show_at")
    ...
    expect(ops).toContain('"603.0": "/shipments"')
    expect(ops).toContain('"604.0": "/shipments"')
    expect(ops).toContain('"605.0": "/shipments"')
    expect(ops).toContain('"606.0": "/shipments"')
    ...
    expect(box).toContain("packaging_code")
