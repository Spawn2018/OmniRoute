...
export function TripRunPanel(args: { signedIn: boolean }) {
  ...
  return (
    <section className="grid gap-2 rounded-md border border-border p-3" data-trip="run">
      ...
      <label className="flex flex-col gap-1 text-xs">
        Etykieta trasy (opcjonalnie)
        <Input
          aria-label="Etykieta trasy przejazdu"
      ...
      <label className="flex flex-col gap-1 text-xs">
        Odległość planowana (opcjonalnie)
        <Input
          aria-label="Odległość planowana w kilometrach"
          placeholder="planned_distance_km"
