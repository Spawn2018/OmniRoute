...
class Stop(Base, TimestampMixin):
    ...
    weigh_out_kg: Mapped[Decimal | None] = mapped_column(Numeric(14, 4), nullable=True)
    ...
    pod_quality: Mapped[str | None] = mapped_column(String(12), nullable=True)
