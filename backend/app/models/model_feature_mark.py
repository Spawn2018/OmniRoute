...
class ModelFeatureMark(Base, TimestampMixin):
    __tablename__ = "model_feature_mark"
    __table_args__ = (
        UniqueConstraint(
            "organization_id",
            "id",
        ...
        Index("ix_model_feature_mark_organization_id", "organization_id"),
    )

    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True)
    # RLS: etykieta cechy modelu — HITL, nie live train.
