...
class MarginMatchMark(Base, TimestampMixin):
    __tablename__ = "margin_match_mark"
    __table_args__ = (
        CheckConstraint(
        ...
        Index("ix_margin_match_mark_organization_id", "organization_id"),
    )

    id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True)
    # RLS: stance dopasowania podłogi zmiany — HITL, nie matching SQL lane / auto charge.
