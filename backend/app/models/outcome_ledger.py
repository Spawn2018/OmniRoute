...
_KIND_SQL = "outcome_kind IN ('eta','rate','route','other')"
...
class OutcomeLedger(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(_KIND_SQL, name="ck_outcome_ledger_kind"),
        CheckConstraint(
            f"target_bc ~ '{_SNAKE}'",
    ...
    outcome_kind: Mapped[str] = mapped_column(String(16), nullable=False)
