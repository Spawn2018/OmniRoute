...
def require_mailbox_source_ref(raw: object) -> str:
    origin = require_source_ref(raw)
    if not origin.startswith(_MAILBOX_PREFIX):
        raise InvalidInboundMessage("source_ref: tylko imap://")
    return origin
