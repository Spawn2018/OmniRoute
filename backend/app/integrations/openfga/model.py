...
def _organization_ops_catalog_relations() -> dict[str, Userset]:
    return {
        ...
        "can_manage_pallet_ledgers": _member(),
        "can_manage_pallet_synchro_marks": _member(),
        "can_manage_document_templates": _member(),
        "can_manage_network_print_requirements": _member(),
        "can_manage_network_print_gate_marks": _member(),
        "can_manage_local_charge_warning_marks": _member(),
        "can_manage_rate_cards": _member(),
        "can_manage_charge_templates": _member(),
        "can_manage_task_templates": _member(),
        "can_manage_tasks": _member(),
...
def _organization_br_catalog_relations() -> dict[str, Userset]:
    return {
        ...
        "can_manage_product_tickets": _member(),
        "can_manage_risk_register_marks": _member(),
        "can_manage_article50_marks": _member(),
        "can_manage_data_sources": _member(),
        "can_manage_ingest_gate_marks": _member(),
        "can_manage_model_feature_marks": _member(),
        "can_manage_cfo_narrative_marks": _member(),
        "can_manage_kpi_definition_marks": _member(),
...
def _organization_f_invoice_relations() -> dict[str, Userset]:
    return {
        ...
        "can_manage_create_block_marks": _member(),
        "can_manage_document_kind_match_marks": _member(),
        "can_manage_filing_bind_marks": _member(),
...
def _organization_g_catalog_relations() -> dict[str, Userset]:
    return {
        ...
        **_organization_f_invoice_relations(),
        ...
        "can_manage_relation_document_requirements": _member(),
        ...
        "can_manage_impact_edge_marks": _member(),
        "can_manage_impact_node_marks": _member(),
...
def _organization_exp2_catalog_relations() -> dict[str, Userset]:
    return {
        ...
        "can_manage_postal_dispatch_marks": _member(),
