...
_DENIED = "Brak uprawnienia can_manage_crm_activities na organization"
_CALLS = (
    ("GET", "/api/v1/crm-activities", None, None),
    (
        "POST",
...
def test_crm_activity_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyActivityAuthz())
