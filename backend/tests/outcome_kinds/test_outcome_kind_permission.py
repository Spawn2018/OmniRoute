...
_DENIED = "Brak uprawnienia can_manage_outcome_kinds na organization"

_CALLS = (
    ("GET", "/api/v1/outcome-kinds", None, None),
    (
        "POST",
...
def test_outcome_kind_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyOutcomeKindAuthz())
