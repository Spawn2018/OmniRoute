...
_DENIED = "Brak uprawnienia can_manage_filing_bind_marks na organization"
_CALLS = (
    ("GET", "/api/v1/filing-bind-marks", None, None),
    (
        "POST",
...
def test_filing_bind_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
