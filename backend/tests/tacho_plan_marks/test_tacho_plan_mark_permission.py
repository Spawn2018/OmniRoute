...
_DENIED = "Brak uprawnienia can_manage_tacho_plan_marks na organization"
_CALLS = (
    ("GET", "/api/v1/tacho-plan-marks", None, None),
    (
        "POST",
...
def test_tacho_plan_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
