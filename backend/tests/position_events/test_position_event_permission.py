...
_DENIED = "Brak uprawnienia can_manage_position_events na organization"
_CALLS = (
    ("GET", "/api/v1/position-events", None, None),
    (
        "POST",
...
def test_position_event_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyPositionAuthz())
