...
_DENIED = "Brak uprawnienia can_manage_general_average_marks na organization"
_CALLS = (
    ("GET", "/api/v1/general-average-marks", None, None),
    (
        "POST",
...
def test_general_average_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_general_average_mark_relation() -> None:
