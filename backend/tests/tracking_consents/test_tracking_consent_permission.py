...
_DENIED = "Brak uprawnienia can_manage_tracking_consents na organization"
_CALLS = (
    ("GET", "/api/v1/tracking-consents", None, None),
    (
        "POST",
...
def test_tracking_consent_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyConsentAuthz())
