...
_DENIED = "Brak uprawnienia can_manage_time_to_fix_marks na organization"
_CALLS = (
    ("GET", "/api/v1/time-to-fix-marks", None, None),
    (
        "POST",
...
def test_time_to_fix_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_time_to_fix_mark_relation() -> None:
