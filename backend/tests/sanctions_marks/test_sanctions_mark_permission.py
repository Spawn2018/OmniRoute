...
_DENIED = "Brak uprawnienia can_manage_sanctions_marks na organization"
_CALLS = (
    ("GET", "/api/v1/sanctions-marks", None, None),
    (
        "POST",
...
def test_sanctions_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
