...
_DENIED = "Brak uprawnienia can_manage_nac_marks na organization"
_CALLS = (
    ("GET", "/api/v1/nac-marks", None, None),
    (
        "POST",
        "/api/v1/nac-marks",
        None,
...
def test_nac_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyNacAuthz())
