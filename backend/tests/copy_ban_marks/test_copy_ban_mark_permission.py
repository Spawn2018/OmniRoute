...
_DENIED = "Brak uprawnienia can_manage_copy_ban_marks na organization"

_CALLS = (
    ("GET", "/api/v1/copy-ban-marks", None, None),
    (
        "POST",
...
def test_copy_ban_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyCopyBanAuthz())
...
def test_fga_source_declares_copy_ban_mark_relation() -> None:
