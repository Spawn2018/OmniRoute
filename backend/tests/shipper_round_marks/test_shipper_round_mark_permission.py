...
_DENIED = "Brak uprawnienia can_manage_shipper_round_marks na organization"
_CALLS = (
    ("GET", "/api/v1/shipper-round-marks", None, None),
    (
        "POST",
...
def test_shipper_round_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
