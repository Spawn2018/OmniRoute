...
_DENIED = "Brak uprawnienia can_manage_chassis_marks na organization"

_CALLS = (
    ("GET", "/api/v1/chassis-marks", None, None),
    (
        "POST",
...
def test_chassis_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyChassisAuthz())
...
def test_fga_source_declares_chassis_mark_relation() -> None:
