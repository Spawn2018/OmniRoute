...
_DENIED = "Brak uprawnienia can_manage_remediation_options na organization"
_CALLS = (
    ("GET", "/api/v1/remediation-options", None, None),
    (
        "POST",
...
def test_remediation_option_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyRemediationAuthz())
