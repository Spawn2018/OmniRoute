...
_DENIED = "Brak uprawnienia can_manage_crm_leads na organization"
_CALLS = (
    ("GET", "/api/v1/crm-leads", None, None),
    (
        "POST",
        "/api/v1/crm-leads",
        None,
...
def test_crm_lead_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyLeadAuthz())
