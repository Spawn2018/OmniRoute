...
_DENIED = "Brak uprawnienia can_manage_what_if_marks na organization"
_CALLS = (
    ("GET", "/api/v1/what-if-marks", None, None),
    (
        "POST",
...
def test_what_if_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_what_if_mark_relation() -> None:
