...
_DENIED = "Brak uprawnienia can_manage_ocean_feeder_marks na organization"

_CALLS = (
    ("GET", "/api/v1/ocean-feeder-marks", None, None),
    (
        "POST",
...
def test_ocean_feeder_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyOceanFeederAuthz())
...
def test_fga_source_declares_ocean_feeder_mark_relation() -> None:
