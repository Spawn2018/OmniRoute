...
_DENIED = "Brak uprawnienia can_manage_delay_forecasts na organization"
_CALLS = (
    ("GET", "/api/v1/delay-forecasts", None, None),
    (
        "POST",
...
def test_delay_forecast_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyDelayForecastAuthz())
