...
_DENIED = "Brak uprawnienia can_manage_suggestion_kinds na organization"

_CALLS = (
    ("GET", "/api/v1/suggestion-kinds", None, None),
    (
        "POST",
...
def test_suggestion_kind_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenySuggestionKindAuthz())
