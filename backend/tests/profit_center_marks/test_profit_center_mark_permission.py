...
_DENIED = "Brak uprawnienia can_manage_profit_center_marks na organization"

_CALLS = (
    ("GET", "/api/v1/profit-center-marks", None, None),
    (
        "POST",
...
def test_profit_center_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyProfitCenterAuthz())
...
def test_fga_source_declares_profit_center_mark_relation() -> None:
