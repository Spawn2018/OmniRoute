...
_DENIED = "Brak uprawnienia can_manage_invoice_match_candidates na organization"
_CALLS = (
    ("GET", "/api/v1/invoice-match-candidates", None, None),
    (
        "POST",
        "/api/v1/invoice-match-candidates",
        None,
        {
            "candidate_code": "postal_01",
...
def test_invoice_match_candidate_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
