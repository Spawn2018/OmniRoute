...
_DENIED = "Brak uprawnienia can_manage_terms_ai_marks na organization"

_CALLS = (

    ("GET", "/api/v1/terms-ai-marks", None, None),
...
def test_terms_ai_mark_endpoints_are_forbidden_without_permission(
...
def test_fga_source_declares_terms_ai_mark_relation() -> None:
