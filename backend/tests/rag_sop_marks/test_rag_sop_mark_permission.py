...
_DENIED = "Brak uprawnienia can_manage_rag_sop_marks na organization"

_CALLS = (
    ("GET", "/api/v1/rag-sop-marks", None, None),
    (
        "POST",
...
def test_rag_sop_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyRagSopAuthz())
...
def test_fga_source_declares_rag_sop_mark_relation() -> None:
