...
_DENIED = "Brak uprawnienia can_manage_ocean_alliance_marks na organization"
_CALLS = (
    ("GET", "/api/v1/ocean-alliance-marks", None, None),
    (
        "POST",
...
def test_ocean_alliance_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_ocean_alliance_mark_relation() -> None:
