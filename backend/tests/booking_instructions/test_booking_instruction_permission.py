...
_DENIED = "Brak uprawnienia can_manage_shipments na organization"
_ENDPOINTS = (
    ("GET", "/api/v1/booking-instructions", {"shipment_id": str(uuid4())}, None),
    (
        "POST",
...
def test_booking_instruction_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
