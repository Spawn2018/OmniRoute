...
_DENIED = "Brak uprawnienia can_manage_e_cmr_marks na organization"
_CALLS = (
    ("GET", "/api/v1/e-cmr-marks", None, None),
    (
        "POST",
        "/api/v1/e-cmr-marks",
        None,
...
def test_e_cmr_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_e_cmr_mark_relation() -> None:
