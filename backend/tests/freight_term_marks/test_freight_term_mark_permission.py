...
_DENIED = "Brak uprawnienia can_manage_freight_term_marks na organization"

_CALLS = (
    ("GET", "/api/v1/freight-term-marks", None, None),
    (
        "POST",
...
def test_freight_term_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyFreightTermAuthz())
...
def test_fga_source_declares_freight_term_mark_relation() -> None:
