...
_DENIED = "Brak uprawnienia can_manage_twin_kinds na organization"

_CALLS = (
    ("GET", "/api/v1/twin-kinds", None, None),
    (
        "POST",
        "/api/v1/twin-kinds",
        None,
        {"kind_code": "tender", "source_ref": "fixture://twin-kind/a"},
    ),
)


class DenyTwinKindAuthz:
    async def check(
        self,
        *,
        user_id: UUID,
...
def test_twin_kind_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyTwinKindAuthz())
