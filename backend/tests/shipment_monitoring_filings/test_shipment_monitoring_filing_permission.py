...
_DENIED = "Brak uprawnienia can_manage_shipment_monitoring_filings na organization"
_CALLS = (
    ("GET", "/api/v1/shipment-monitoring-filings", None, None),
    (
        "POST",
        "/api/v1/shipment-monitoring-filings",
        None,
        {
            "filing_code": "postal_01",
            "status_kind": "open",
...
def test_shipment_monitoring_filing_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
