...
_DENIED = "Brak uprawnienia can_manage_waste_marks na organization"
_CALLS = (
    ("GET", "/api/v1/waste-marks", None, None),
    (
        "POST",
        "/api/v1/waste-marks",
        None,
...
def test_waste_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyWasteAuthz())
