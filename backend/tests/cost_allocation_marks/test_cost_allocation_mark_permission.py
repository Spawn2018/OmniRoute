...
_DENIED = "Brak uprawnienia can_manage_cost_allocation_marks na organization"
_CALLS = (
    ("GET", "/api/v1/cost-allocation-marks", None, None),
    (
        "POST",
...
def test_cost_allocation_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
