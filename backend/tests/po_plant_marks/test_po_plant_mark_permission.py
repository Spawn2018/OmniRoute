...
_DENIED = "Brak uprawnienia can_manage_po_plant_marks na organization"

_CALLS = (
    ("GET", "/api/v1/po-plant-marks", None, None),
    (
        "POST",
...
def test_po_plant_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyPoPlantAuthz())
...
def test_fga_source_declares_po_plant_mark_relation() -> None:
