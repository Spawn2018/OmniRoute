...
_DENIED = "Brak uprawnienia can_manage_named_place_marks na organization"

_CALLS = (
    ("GET", "/api/v1/named-place-marks", None, None),
    (
        "POST",
...
def test_named_place_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyNamedPlaceAuthz())
...
def test_fga_source_declares_named_place_mark_relation() -> None:
