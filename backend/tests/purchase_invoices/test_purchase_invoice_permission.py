...
_DENIED = "Brak uprawnienia can_manage_purchase_invoices na organization"
_CALLS = (
    ("GET", "/api/v1/purchase-invoices", None, None),
    (
        "POST",
...
def test_purchase_invoice_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyPurchaseAuthz())
