...
_DENIED = "Brak uprawnienia can_manage_legal_hold_marks na organization"
_CALLS = (
    ("GET", "/api/v1/legal-hold-marks", None, None),
    (
        "POST",
...
def test_legal_hold_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyLegalHoldAuthz())
