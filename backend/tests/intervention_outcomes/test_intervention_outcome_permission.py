...
_DENIED = "Brak uprawnienia can_manage_intervention_outcomes na organization"
_CALLS = (
    ("GET", "/api/v1/intervention-outcomes", None, None),
    (
        "POST",
...
def test_intervention_outcome_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyOutcomeAuthz())
