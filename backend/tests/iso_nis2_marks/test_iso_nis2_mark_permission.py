...
_DENIED = "Brak uprawnienia can_manage_iso_nis2_marks na organization"
_CALLS = (
    ("GET", "/api/v1/iso-nis2-marks", None, None),
    (
        "POST",
...
def test_iso_nis2_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_iso_nis2_mark_relation() -> None:
