...
_DENIED = "Brak uprawnienia can_manage_nvocc_marks na organization"
_CALLS = (
    ("GET", "/api/v1/nvocc-marks", None, None),
    (
        "POST",
        "/api/v1/nvocc-marks",
        None,
...
def test_nvocc_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_nvocc_mark_relation() -> None:
