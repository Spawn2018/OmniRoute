...
_DENIED = "Brak uprawnienia can_manage_cost_category_marks na organization"
_CALLS = (
    ("GET", "/api/v1/cost-category-marks", None, None),
    (
        "POST",
...
def test_cost_category_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
