...
_DENIED = "Brak uprawnienia can_manage_haulier_role_marks na organization"

_CALLS = (
    ("GET", "/api/v1/haulier-role-marks", None, None),
    (
        "POST",
...
def test_haulier_role_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyHaulierRoleAuthz())
...
def test_fga_source_declares_haulier_role_mark_relation() -> None:
