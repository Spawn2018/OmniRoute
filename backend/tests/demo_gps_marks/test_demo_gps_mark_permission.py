...
_DENIED = "Brak uprawnienia can_manage_demo_gps_marks na organization"

_CALLS = (
    ("GET", "/api/v1/demo-gps-marks", None, None),
    (
        "POST",
...
def test_demo_gps_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyDemoGpsAuthz())
...
def test_fga_source_declares_demo_gps_mark_relation() -> None:
