...
_DENIED = "Brak uprawnienia can_manage_tender_decline_reasons na organization"
_CALLS = (
    ("GET", "/api/v1/tender-decline-reasons", None, None),
    (
        "POST",
...
def test_tender_decline_reason_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_tender_decline_reason_relation() -> None:
