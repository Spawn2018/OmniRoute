...
_DENIED = "Brak uprawnienia can_manage_po_sku_marks na organization"

_CALLS = (
    ("GET", "/api/v1/po-sku-marks", None, None),
    (
        "POST",
        "/api/v1/po-sku-marks",
        None,
...
def test_po_sku_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyPoSkuAuthz())
...
def test_fga_source_declares_po_sku_mark_relation() -> None:
