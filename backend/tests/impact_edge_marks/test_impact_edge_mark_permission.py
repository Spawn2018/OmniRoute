...
_DENIED = "Brak uprawnienia can_manage_impact_edge_marks na organization"
_CALLS = (
    ("GET", "/api/v1/impact-edge-marks", None, None),
    (
        "POST",
...
def test_impact_edge_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
