...
_DENIED = "Brak uprawnienia can_manage_customer_po_marks na organization"

_CALLS = (
    ("GET", "/api/v1/customer-po-marks", None, None),
    (
        "POST",
...
def test_customer_po_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyCustomerPoAuthz())
...
def test_fga_source_declares_customer_po_mark_relation() -> None:
