...
_DENIED = "Brak uprawnienia can_manage_extraction_prompt_marks na organization"
_CALLS = (
    ("GET", "/api/v1/extraction-prompt-marks", None, None),
    (
        "POST",
...
def test_extraction_prompt_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
