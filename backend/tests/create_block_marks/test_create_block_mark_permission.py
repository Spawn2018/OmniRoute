...
_DENIED = "Brak uprawnienia can_manage_create_block_marks na organization"
_CALLS = (
    ("GET", "/api/v1/create-block-marks", None, None),
    (
        "POST",
...
def test_create_block_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
