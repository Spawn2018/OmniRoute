...
_DENIED = "Brak uprawnienia can_manage_rail_uic_marks na organization"

_CALLS = (
    ("GET", "/api/v1/rail-uic-marks", None, None),
    (
        "POST",
...
def test_rail_uic_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyRailUicAuthz())
...
def test_fga_source_declares_rail_uic_mark_relation() -> None:
