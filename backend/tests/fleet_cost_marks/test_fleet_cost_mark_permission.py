...
_DENIED = "Brak uprawnienia can_manage_fleet_cost_marks na organization"
_CALLS = (
    ("GET", "/api/v1/fleet-cost-marks", None, None),
    (
        "POST",
...
def test_fleet_cost_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_fleet_cost_mark_relation() -> None:
