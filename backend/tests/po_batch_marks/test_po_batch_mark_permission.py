...
_DENIED = "Brak uprawnienia can_manage_po_batch_marks na organization"

_CALLS = (
    ("GET", "/api/v1/po-batch-marks", None, None),
    (
        "POST",
...
def test_po_batch_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyPoBatchAuthz())
...
def test_fga_source_declares_po_batch_mark_relation() -> None:
