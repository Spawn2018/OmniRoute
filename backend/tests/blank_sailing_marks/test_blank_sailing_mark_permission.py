...
_DENIED = "Brak uprawnienia can_manage_blank_sailing_marks na organization"
_CALLS = (
    ("GET", "/api/v1/blank-sailing-marks", None, None),
    (
        "POST",
...
def test_blank_sailing_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyBlankSailingAuthz())
