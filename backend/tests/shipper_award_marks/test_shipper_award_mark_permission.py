...
_DENIED = "Brak uprawnienia can_manage_shipper_award_marks na organization"
_CALLS = (
    ("GET", "/api/v1/shipper-award-marks", None, None),
    (
        "POST",
...
def test_shipper_award_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
