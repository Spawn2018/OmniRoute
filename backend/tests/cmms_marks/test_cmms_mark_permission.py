...
_DENIED = "Brak uprawnienia can_manage_cmms_marks na organization"
_CALLS = (
    ("GET", "/api/v1/cmms-marks", None, None),
    (
        "POST",
        "/api/v1/cmms-marks",
        None,
...
def test_cmms_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyCmmsAuthz())
