...
_DENIED = "Brak uprawnienia can_manage_silk_corridor_marks na organization"
_CALLS = (
    ("GET", "/api/v1/silk-corridor-marks", None, None),
    (
        "POST",
...
def test_silk_corridor_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenySilkCorridorAuthz())
