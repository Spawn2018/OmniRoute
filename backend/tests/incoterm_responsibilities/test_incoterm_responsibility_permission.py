...
_ENDPOINTS = (
    (
        ...
        {"incoterm": "FOB", "trade_side": "export"},
        None,
    ),
    (
        "POST",
    ...
    ("POST", "/api/v1/incoterm-responsibilities/seed", None, None),
)
...
def test_incoterm_responsibility_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
