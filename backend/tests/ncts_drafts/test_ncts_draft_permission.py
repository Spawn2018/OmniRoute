...
_DENIED = "Brak uprawnienia can_manage_ncts_drafts na organization"
_CALLS = (
    ("GET", "/api/v1/ncts-drafts", None, None),
    (
        "POST",
        "/api/v1/ncts-drafts",
        None,
...
def test_ncts_draft_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyNctsAuthz())
