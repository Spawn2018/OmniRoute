...
_DENIED = "Brak uprawnienia can_manage_dual_ledger_marks na organization"

_CALLS = (
    ("GET", "/api/v1/dual-ledger-marks", None, None),
    (
        "POST",
...
def test_dual_ledger_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyDualLedgerAuthz())
...
def test_fga_source_declares_dual_ledger_mark_relation() -> None:
