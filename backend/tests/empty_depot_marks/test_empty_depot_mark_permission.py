...
_DENIED = "Brak uprawnienia can_manage_empty_depot_marks na organization"
_CALLS = (
    ("GET", "/api/v1/empty-depot-marks", None, None),
    (
        "POST",
...
def test_empty_depot_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
...
def test_fga_source_declares_empty_depot_mark_relation() -> None:
