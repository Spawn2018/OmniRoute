...
_DENIED = "Brak uprawnienia can_manage_lc_checklists na organization"
_CALLS = (
    ("GET", "/api/v1/lc-checklists", None, None),
    (
        "POST",
...
def test_lc_checklist_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyLcAuthz())
