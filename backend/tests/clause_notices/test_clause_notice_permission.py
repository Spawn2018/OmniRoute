...
_DENIED = "Brak uprawnienia can_manage_clause_notices na organization"
_CALLS = (
    ("GET", "/api/v1/clause-notices", None, None),
    (
        "POST",
...
def test_clause_notice_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyClauseAuthz())
