...
_DENIED = "Brak uprawnienia can_manage_quote_currency_marks na organization"

_CALLS = (
    ("GET", "/api/v1/quote-currency-marks", None, None),
    (
        "POST",
...
def test_quote_currency_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyQuoteCurrencyAuthz())
...
def test_fga_source_declares_quote_currency_mark_relation() -> None:
