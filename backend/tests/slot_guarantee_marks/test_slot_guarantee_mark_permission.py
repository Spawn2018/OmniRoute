...
_DENIED = "Brak uprawnienia can_manage_slot_guarantee_marks na organization"

_CALLS = (
    ("GET", "/api/v1/slot-guarantee-marks", None, None),
    (
        "POST",
...
def test_slot_guarantee_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenySlotGuaranteeAuthz())
...
def test_fga_source_declares_slot_guarantee_mark_relation() -> None:
