...
_DENIED = "Brak uprawnienia can_manage_high_value_marks na organization"

_CALLS = (
    ("GET", "/api/v1/high-value-marks", None, None),
    (
        "POST",
...
def test_high_value_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyHighValueAuthz())
...
def test_fga_source_declares_high_value_mark_relation() -> None:
