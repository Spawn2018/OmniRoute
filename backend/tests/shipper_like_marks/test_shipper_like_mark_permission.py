...
_DENIED = "Brak uprawnienia can_manage_shipper_like_marks na organization"
_CALLS = (
    ("GET", "/api/v1/shipper-like-marks", None, None),
    (
        "POST",
...
def test_shipper_like_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
