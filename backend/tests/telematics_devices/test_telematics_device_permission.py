...
_DENIED = "Brak uprawnienia can_manage_telematics_devices na organization"
_CALLS = (
    ("GET", "/api/v1/telematics-devices", None, None),
    (
        "POST",
...
def test_telematics_device_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyDeviceAuthz())
