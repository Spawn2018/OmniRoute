...
_DENIED = "Brak uprawnienia can_manage_impact_scenarios na organization"
_CALLS = (
    ("GET", "/api/v1/impact-scenarios", None, None),
    (
        "POST",
...
def test_impact_scenario_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyImpactAuthz())
