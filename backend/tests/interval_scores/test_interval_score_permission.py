...
_DENIED = "Brak uprawnienia can_manage_interval_scores na organization"


class DenyIntervalScoreAuthz:
    async def check(
        self,
        *,
        user_id: UUID,
...
def test_interval_score_get_is_forbidden_without_permission() -> None:
    set_authz_checker(DenyIntervalScoreAuthz())
