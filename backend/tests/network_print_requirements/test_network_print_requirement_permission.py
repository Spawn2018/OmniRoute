...
_DENIED = "Brak uprawnienia can_manage_network_print_requirements na organization"
_CALLS = (
    ("GET", "/api/v1/network-print-requirements", None, None),
    (
        "POST",
...
def test_network_print_requirement_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenyPrintAuthz())
