...
_DENIED = "Brak uprawnienia can_manage_groupage_dispatcher_marks na organization"
_CALLS = (
    ("GET", "/api/v1/groupage-dispatcher-marks", None, None),
    (
        "POST",
...
def test_groupage_dispatcher_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
