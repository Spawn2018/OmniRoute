...
_DENIED = "Brak uprawnienia can_manage_self_billing_marks na organization"
_CALLS = (
    ("GET", "/api/v1/self-billing-marks", None, None),
    (
        "POST",
...
def test_self_billing_mark_endpoints_are_forbidden_without_permission(
    method: str,
    path: str,
    params: dict[str, str] | None,
    json_body: dict[str, object] | None,
) -> None:
    set_authz_checker(DenySelfBillingAuthz())
