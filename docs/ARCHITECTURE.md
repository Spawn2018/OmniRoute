...
<!-- os-status:start -->
**Status:** **53.0** U-condensed trzeci tryb gęstości na `/rate-lines` (zarchiwizowany). **Etap:** Plaster. **Następny:** 54.0 U-primitives-json pin Radix w `components.json`. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
