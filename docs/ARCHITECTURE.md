...
<!-- os-status:start -->
**Status:** **103.0** S41 koszt obsługi (M-46). **Etap:** Plan. **Następny:** `/plan-modul` **S42** — żywe M-47 księgowość. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
