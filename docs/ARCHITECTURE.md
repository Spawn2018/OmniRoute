...
<!-- os-status:start -->
**Status:** **97.0** S35 numer sesji KSeF na fakturze (M-40). **Etap:** Plan. **Następny:** `/plaster` **98.0** — S36 rozliczenie wyceny z fakturą (M-41). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
...
backend/app/
  ...
  services/        carrier_inquiries · channel_quotes · charge_codes · charges · commodity_codes · customer_rfqs · dangerous_goods · edi_messages · extraction · geography · inbound_messages · mail_drafts · nbp_rates · networks · operational_exceptions · operator_decisions · operator_notices · organization_settings · outbox_events · parties · port_surcharges · quotations · rate_lines · sales_invoices · shipment_documents · shipments · tenancy · tracking_events
