...
<!-- os-status:start -->
**Status:** **39.0** M-46 `cost_to_serve` tablica `/cost-to-serve` (zarchiwizowany). **Etap:** Plan. **Następny:** M-47 Księgowość (integracja) (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
