...
<!-- os-status:start -->
**Status:** **279.0** leftover HITL `routing_guide`. **Etap:** Plan. **Następny:** leftover Fala CT / pin — CT3 OTIF katalog albo CT1 auto shipment compose (parked z powodem) / egzekucja 409 / CT2 gdy CI5. CT5 EDI live = park. CT8 AIS = park live. Nie CI1 extract. Nie live p44. Leftover HITL/SQL = praca. Park = live HTTP bez testu albo sekretu. Nie zgaduj 71–279. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
