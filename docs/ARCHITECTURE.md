...
<!-- os-status:start -->
**Status:** **542.0** N1 opcjonalny `stop_id` na przesyłce. **Etap:** Plan — park AI3-payload / Plat-HD / G0-SH; komenda `/plan-modul`. **Następny:** park **AI3-payload** / **Plat-HD** / **G0-SH**. Nie SH-R16-13. Nie AI0. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
