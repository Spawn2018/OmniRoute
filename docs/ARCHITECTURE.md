...
<!-- os-status:start -->
**Status:** **71.0** S8 prefiks i szablon w organization_setting. **Etap:** Plan. **Następny:** `/plaster` **72.0** — numer na dokumencie oferty. Print 57.0 jest. Nie send. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
