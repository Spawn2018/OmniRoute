...
<!-- os-status:start -->
**Status:** **46.0** M-56 `gdpr` tablica `/gdpr` (zarchiwizowany). **Etap:** Plaster. **Następny:** 47.0 M-57 `ai_copilot` tablica `/ai`. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
