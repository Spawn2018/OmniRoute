...
<!-- os-status:start -->
**Status:** **308.0** `/refaktor` CatalogSourceRefField (prospect/win-loss/data-room). **Etap:** Refaktor. **Następny:** leftover label-form (tender lot/lane/quote / rate-card / …) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
