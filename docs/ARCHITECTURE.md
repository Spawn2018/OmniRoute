...
<!-- os-status:start -->
**Status:** **28.0** M-35 `shipment` tablica `/shipments` (zarchiwizowany). **Etap:** Plan. **Następny:** M-36 Tracking (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
