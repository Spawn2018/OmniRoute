...
<!-- os-status:start -->
**Status:** **290.0** leftover CT4 matching lane/mode na shipment. **Etap:** Kod. **Następny:** **291.0** leftover CT1 HITL promote ASN → shipment. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
