...
<!-- os-status:start -->
**Status:** **105.0** S43 zbiorcza faktura (M-91). **Etap:** Plan. **Następny:** `/plaster` **106.0** — S44 tablica faktów z FV (M-15). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
