...
<!-- os-status:start -->
**Status:** **104.0** S42 księgowość (M-47). **Etap:** Plan. **Następny:** `/plaster` **105.0** — S43 zbiorcza faktura (M-91). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
