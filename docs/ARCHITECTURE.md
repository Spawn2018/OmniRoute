...
<!-- os-status:start -->
**Status:** **30.0** M-37 `operational_exception` tablica `/exceptions` (zarchiwizowany). **Etap:** Plan. **Następny:** M-38 Dokumenty zlecenia (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
