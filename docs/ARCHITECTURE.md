...
<!-- os-status:start -->
**Status:** **338.0** EXP2.1 HITL `working_capital_mark`. **Etap:** Plan — wolno `/plan-modul` **339.0** EXP2.2. **Następny:** **339.0** EXP2.2 make-or-buy (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
