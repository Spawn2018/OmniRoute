...
<!-- os-status:start -->
**Status:** **282.0** leftover HITL `capa_mark`. **Etap:** Plan. **Następny:** leftover Fala CT / pin — egzekucja 409 z `routing_guide` albo CT9/CT10/CT11 gdy węższe HITL. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
