...
<!-- os-status:start -->
**Status:** **340.0** EXP2.3 HITL `cost_allocation_mark`. **Etap:** Plan — wolno `/plan-modul` **341.0** EXP2.4. **Następny:** **341.0** EXP2.4 cargo_cover (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
