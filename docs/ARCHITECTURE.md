...
<!-- os-status:start -->
**Status:** **97.0** S35 numer sesji KSeF na fakturze (M-40). **Etap:** Plan. **Następny:** `/plan-modul` **S36** — rozliczenie wyceny z fakturą (M-41). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
