...
<!-- os-status:start -->
**Status:** **306.0** `/refaktor` CatalogSourceRefField (otif/enforcement/task-template). **Etap:** Refaktor. **Następny:** leftover label-form (tender-* / rate-card / …) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
