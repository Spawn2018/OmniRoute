...
<!-- os-status:start -->
**Status:** **309.0** `/refaktor` CatalogSourceRefField (lot/lane/quote). **Etap:** Refaktor. **Następny:** leftover label-form (tender round/matrix/side / rate-card / …) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
