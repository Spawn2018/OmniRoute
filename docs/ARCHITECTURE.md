...
<!-- os-status:start -->
**Status:** **519.0** AI6.0 — HITL `impact_node_mark`. **Etap:** Plan — delta **520.0** zaakceptowana (`/noc 7`); wolno `/plaster`. **Następny:** **520.0** AI6.0 leftover — HITL `impact_edge_mark` (para from/to; nie SQL; nie EBITDA) Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
