...
<!-- os-status:start -->
**Status:** **45.0** M-53 `sanctions` tablica `/sanctions` (zarchiwizowany). **Etap:** Plan. **Następny:** M-54 (`/plan-modul`). Nie zgaduj nazwy ani schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
