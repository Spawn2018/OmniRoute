...
<!-- os-status:start -->
**Status:** **44.0** M-51 `ocean_lcl` tablica `/lcl` (zarchiwizowany). **Etap:** Plan. **Następny:** M-53 Sankcje (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
