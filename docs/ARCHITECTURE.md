...
<!-- os-status:start -->
**Status:** **339.0** EXP2.2 HITL `make_or_buy_mark`. **Etap:** Plan — wolno `/plan-modul` **340.0** EXP2.3. **Następny:** **340.0** EXP2.3 cost allocation (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
