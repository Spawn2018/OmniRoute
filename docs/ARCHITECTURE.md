...
<!-- os-status:start -->
**Status:** **33.0** M-40 `sales_invoice` tablica `/invoices` (zarchiwizowany). **Etap:** Plan. **Następny:** M-41 Rozliczenie wyceny z fakturą (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
