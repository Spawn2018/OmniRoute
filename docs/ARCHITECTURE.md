...
<!-- os-status:start -->
**Status:** **289.0** leftover CT4 matching lane/mode na ASN. **Etap:** Kod. **Następny:** **290.0** leftover CT4 matching lane/mode na shipment (przy `block_409`). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
