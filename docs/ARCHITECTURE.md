...
<!-- os-status:start -->
**Status:** **293.0** `/refaktor` CatalogSourceRefHintField (Q-E1 leftover). **Etap:** Plan. **Następny:** leftover Fala CT / pin — U1 masowy / wspólny SELECT / CT2 albo następny wąski HITL. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
