...
<!-- os-status:start -->
**Status:** **90.0** S28 tabela `shipment` (M-35). **Etap:** Plan. **Następny:** `/plaster` **91.0** — S29 zdarzenia trackingu (M-36). Nie mapa w paczce JS. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
