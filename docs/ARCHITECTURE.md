...
<!-- os-status:start -->
**Status:** **15.0** M-15 `finance_board` (zarchiwizowany). **Etap:** Plan. **Następny:** 16.0 M-23 waluty w ofercie (`/plan-modul`). Czyta `nbp_rate`. LLM nie liczy. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
