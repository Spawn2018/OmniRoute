...
<!-- os-status:start -->
**Status:** **50.0** M-70 `tenant_rollout` tablica `/rollout` (zarchiwizowany). **Etap:** Plaster. **Następny:** 51.0 U-oklch-dark tokeny `oklch` + `.dark`. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
