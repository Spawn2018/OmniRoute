...
<!-- os-status:start -->
**Status:** **280.0** leftover HITL `otif_mark`. **Etap:** Plan. **Następny:** leftover Fala CT / pin — CT6 HITL konektor SAP/Oracle (jak F9) albo CT12 CAPA katalog albo egzekucja 409 z `routing_guide`. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
