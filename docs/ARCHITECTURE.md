...
<!-- os-status:start -->
**Status:** **314.0** CI4 HITL `delay_forecast`. **Etap:** Plan (delta zaakceptowana `/noc`) — wolno `/plaster` **315.0**. **Następny:** **315.0** CI6 HITL `remediation_option` (delta `docs/deltas/open/315.0-remediation-option.md`). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
