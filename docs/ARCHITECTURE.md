...
<!-- os-status:start -->
**Status:** **515.0** AI3.1 leftover — undo z `payload.history`. **Etap:** Plan — delta **516.0** zaakceptowana (`/noc 7`); wolno `/plaster`. **Następny:** **516.0** AI7.0 — HITL `allocation_key` (otwarty słownik kluczy; nie SQL; nie druga marża) Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
