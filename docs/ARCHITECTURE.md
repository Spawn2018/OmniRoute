...
<!-- os-status:start -->
**Status:** **284.0** leftover HITL `collaboration_mark`. **Etap:** Plan. **Następny:** leftover Fala CT / pin — egzekucja 409 z `routing_guide` albo CT9 gdy węższe HITL. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
