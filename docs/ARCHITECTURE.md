...
<!-- os-status:start -->
**Status:** **38.0** M-45 `cash_flow` tablica `/cashflows` (zarchiwizowany). **Etap:** Plaster. **Następny:** 39.0 M-46 `cost_to_serve` tablica `/cost-to-serve`. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
