...
<!-- os-status:start -->
**Status:** **113.0** S51 reklamacja ładunku (M-55). **Etap:** Plan. **Następny:** `/plaster` **114.0** — S52 oszustwo (M-54). Nie scoring osoby. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
