...
<!-- os-status:start -->
**Status:** **123.0** leftover S12 filtr kind na tablicy 27.0 (M-34). **Etap:** Plaster (delta 124.0 zaakceptowana `/noc`). **Następny:** `/plaster` leftover S32 kafelki liczników na `/watchtower`. Nie leaflet. Nie AIS. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
