...
<!-- os-status:start -->
**Status:** **346.0** EXP2.9 HITL `time_to_fix_mark`. **Etap:** Plan — wolno `/plan-modul` **347.0** EXP2.10. **Następny:** **347.0** EXP2.10 what-if (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
