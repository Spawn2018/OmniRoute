...
<!-- os-status:start -->
**Status:** **332.0** G12 HITL `filing_scheme_mark`. **Etap:** Plan — wolno `/plan-modul` **333.0** G13. **Następny:** **333.0** G13 EDI parser → draft (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
