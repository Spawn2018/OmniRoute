...
<!-- os-status:start -->
**Status:** **303.0** `/refaktor` CatalogSourceRefField (po-line/visibility/sap). **Etap:** Refaktor. **Następny:** leftover label-form albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
