...
<!-- os-status:start -->
**Status:** **25.0** M-32 `mail_integration` tablica `/mail` (zarchiwizowany). **Etap:** Plan. **Następny:** 26.0 M-33 Dodatek do Outlooka (`/plan-modul`). Nie zgaduj schematu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
