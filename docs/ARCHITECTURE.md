...
<!-- os-status:start -->
**Status:** **324.0** G3 HITL `lc_checklist`. **Etap:** Plan — wolno `/plan-modul` **G4**. **Następny:** **G4** NCTS szkic (Plan). Pin po G3. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
