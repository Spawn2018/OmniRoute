...
<!-- os-status:start -->
**Status:** **73.0** S10 SOP `blocks_auto`. **Etap:** Plan. **Następny:** `/plaster` **74.0** — szyna `operator_decision` (M-71). Nie M-57. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
