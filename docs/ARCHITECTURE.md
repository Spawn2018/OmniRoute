...
<!-- os-status:start -->
**Status:** **21.0** M-28 `customer_inquiry` przy `quotation` (zarchiwizowany). **Etap:** Plan. **Następny:** 22.0 M-29 `offer_acceptance` (`/plaster`). Pending z wycen. Nie tabela. Nie HITL accept. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
