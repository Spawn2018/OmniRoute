...
<!-- os-status:start -->
**Status:** **123.0** leftover S12 filtr kind na tablicy 27.0 (M-34). **Etap:** Plan. **Następny:** `/plan-modul` leftover S32 kafelki na `/watchtower`. Nie leaflet. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
