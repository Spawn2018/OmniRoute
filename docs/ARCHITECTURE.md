...
<!-- os-status:start -->
**Status:** **291.0** leftover CT1 HITL promote ASN → shipment. **Etap:** Plan. **Następny:** leftover Fala CT / pin — U1 masowy / wspólny SELECT / CT2 albo następny wąski HITL. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
