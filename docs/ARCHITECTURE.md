...
<!-- os-status:start -->
**Status:** **89.0** S27 sankcje HTTP na `party` (M-53). **Etap:** Plan. **Następny:** `/plan-modul` **S28** — tabela `shipment` (M-35). Tablica wycen ≠ zlecenie. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
