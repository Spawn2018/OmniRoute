...
<!-- os-status:start -->
**Status:** **105.0** S43 zbiorcza faktura (M-91). **Etap:** Plan. **Następny:** `/plan-modul` **S44** — żywe M-15 tablica faktów (teraz z FV). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
