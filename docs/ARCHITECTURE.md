...
<!-- os-status:start -->
**Status:** **69.0** S6 ewaluacja `applies_when` w SQL. **Etap:** Plan. **Następny:** S7 `/plan-modul` — HS/CN na RFQ/wycenie. Katalog jest. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
