...
<!-- os-status:start -->
**Status:** **54.0** U-primitives-json pin Radix w `components.json` (zarchiwizowany). **Etap:** Plan. **Następny:** U-i18n-structure (`/plan-modul`). PLAN § Wave FE leftover. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
