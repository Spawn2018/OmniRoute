...
<!-- os-status:start -->
**Status:** **91.0** S29 zdarzenia trackingu (M-36). **Etap:** Plan. **Następny:** `/plaster` **92.0** — S30 dokumenty na zleceniu (M-38). Nie PDF. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
