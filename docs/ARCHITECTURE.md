...
<!-- os-status:start -->
**Status:** **301.0** `/refaktor` CatalogSourceRefField (erp/idp/contract). **Etap:** Refaktor. **Następny:** leftover label-form connector (terminal-slot / kek / PO / visibility) albo wąski HITL. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
