...
<!-- os-status:start -->
**Status:** **11.0** M-16 `customer_sop` (zarchiwizowany). **Etap:** Plan. **Następny:** 12.0 M-18 `port_surcharge` (`/plaster`). Nie Fala 8. Nie zgaduj zakresu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
