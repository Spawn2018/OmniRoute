...
<!-- os-status:start -->
**Status:** **343.0** EXP2.6 HITL `subcontract_edge_mark`. **Etap:** Plan — wolno `/plan-modul` **344.0** EXP2.7. **Następny:** **344.0** EXP2.7 schedule_exception (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
