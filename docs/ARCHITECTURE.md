...
<!-- os-status:start -->
**Status:** **299.0** `/refaktor` CatalogSourceRefField (rank/executive/memory). **Etap:** Refaktor. **Następny:** leftover label-form prediction/weather albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
