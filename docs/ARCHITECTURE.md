...
<!-- os-status:start -->
**Status:** **344.0** EXP2.7 HITL `schedule_exception_mark`. **Etap:** Plan — wolno `/plan-modul` **345.0** EXP2.8. **Następny:** **345.0** EXP2.8 cutoffy rozdzielone (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
