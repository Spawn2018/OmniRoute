...
<!-- os-status:start -->
**Status:** **96.0** S34 tabela faktury sprzedaży (M-40). **Etap:** Plan. **Następny:** `/plaster` **97.0** — S35 numer sesji KSeF na fakturze (M-40). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
