...
<!-- os-status:start -->
**Status:** **38.0** M-45 `cash_flow` tablica `/cashflows` (zarchiwizowany). **Etap:** Plan. **Następny:** M-46 Koszt obsługi klienta (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
