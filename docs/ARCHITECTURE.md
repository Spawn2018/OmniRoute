...
<!-- os-status:start -->
**Status:** **40.0** M-47 `bookkeeping` tablica `/bookkeeping` (zarchiwizowany). **Etap:** Plan. **Następny:** M-48 Transport drogowy (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
