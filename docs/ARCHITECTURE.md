...
<!-- os-status:start -->
**Status:** **52.0** U-money-align oś dziesiętna na `<Money/>` (zarchiwizowany). **Etap:** Plan. **Następny:** U-condensed (`/plan-modul`). PLAN § Wave FE leftover. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
