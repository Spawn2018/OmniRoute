...
<!-- os-status:start -->
**Status:** **122.0** leftover S7 UN na RFQ/wycenie (M-52). **Etap:** Plan. **Następny:** `/plaster` **123.0** — leftover S12 filtr kind na tablicy 27.0. Nie auto-INSERT. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
