...
<!-- os-status:start -->
**Status:** **36.0** M-43 `money_cost` tablica `/money-cost` (zarchiwizowany). **Etap:** Plan. **Następny:** M-44 Różnice kursowe (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
