...
<!-- os-status:start -->
**Status:** **313.0** CI1 HITL `sla_clause`. **Etap:** Plan. **Następny:** leftover CI1 ciphertext/kara SQL **parked** — wąski HITL z pinu (CI2 / G / EXP) albo kolejny pin bez park live. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
