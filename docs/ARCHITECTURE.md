...
<!-- os-status:start -->
**Status:** **106.0** S44 tablica faktów z FV (M-15). **Etap:** Plan. **Następny:** `/plan-modul` **S45** — wniosek/usuwanie RODO (M-56). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
