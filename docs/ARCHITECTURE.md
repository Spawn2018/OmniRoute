...
<!-- os-status:start -->
**Status:** **335.0** G15 HITL `yard_mark`. **Etap:** Plan — wolno `/plan-modul` **336.0** G16. **Następny:** **336.0** G16 SaaS billing Omni (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
