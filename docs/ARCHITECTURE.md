...
<!-- os-status:start -->
**Status:** **318.0** CI7 HITL `calibration_mark`. **Etap:** Plan — wolno `/plan-modul` **319.0**. **Następny:** **319.0** CI8 HITL `repair_playbook` (playbook_code + stance_kind + source_ref; bez auto-send S11). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
