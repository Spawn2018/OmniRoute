...
<!-- os-status:start -->
**Status:** **83.0** S20 zapytanie do agenta (M-30). **Etap:** Plan. **Następny:** `/plaster` **84.0** — porównanie → `charge` (M-31). Spread = `margin()`. Nie odejmuj w JS. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
