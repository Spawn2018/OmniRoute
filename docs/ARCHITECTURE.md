...
<!-- os-status:start -->
**Status:** **42.0** M-49 `intermodal_rail` tablica `/rail` (zarchiwizowany). **Etap:** Plaster. **Następny:** 43.0 M-50 `china_rail` tablica `/china-rail`. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
