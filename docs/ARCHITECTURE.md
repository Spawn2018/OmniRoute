...
<!-- os-status:start -->
**Status:** **341.0** EXP2.4 HITL `cargo_cover_mark`. **Etap:** Plan — wolno `/plan-modul` **342.0** EXP2.5. **Następny:** **342.0** EXP2.5 sanctions (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
