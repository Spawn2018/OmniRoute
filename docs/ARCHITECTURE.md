...
<!-- os-status:start -->
**Status:** **345.0** EXP2.8 HITL `cutoff_mark`. **Etap:** Plan — wolno `/plan-modul` **346.0** EXP2.9. **Następny:** **346.0** EXP2.9 TIME-TO-FIX (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
