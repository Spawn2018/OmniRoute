...
<!-- os-status:start -->
**Status:** **288.0** leftover HITL `routing_guide_match`. **Etap:** Plan. **Następny:** leftover Fala CT / pin — silnik matching lane/mode albo następny wąski HITL z PLAN. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
