...
<!-- os-status:start -->
**Status:** **25.0** M-32 `mail_integration` tablica `/mail` (zarchiwizowany). **Etap:** Plan. **Następny:** 26.0 M-33 `mail_client` (`/plaster`). `mailto:` na `/mail`. Nie Office.js. Nie Graph. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
