...
<!-- os-status:start -->
**Status:** **337.0** EXP7.2 HITL `registry_poll_mark`. **Etap:** Plan — wolno `/plan-modul` **338.0** EXP2.1. **Następny:** **338.0** EXP2.1 working capital DSO / cash-at-risk / aging (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
