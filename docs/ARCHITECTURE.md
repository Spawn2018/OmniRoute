...
<!-- os-status:start -->
**Status:** **51.0** U-oklch-dark tokeny `oklch` + `.dark` (zarchiwizowany). **Etap:** Plaster. **Następny:** 52.0 U-money-align oś dziesiętna na `<Money/>`. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
