...
<!-- os-status:start -->
**Status:** **37.0** M-44 `fx_difference` tablica `/fx-differences` (zarchiwizowany). **Etap:** Plan. **Następny:** M-45 Przepływy (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
