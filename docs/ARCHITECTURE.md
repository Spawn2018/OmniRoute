...
<!-- os-status:start -->
**Status:** **93.0** S31 tabela wyjątków (M-37). **Etap:** Plan. **Następny:** `/plan-modul` **S32** — Watchtower (lista + S11 + lazy mapa). Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
