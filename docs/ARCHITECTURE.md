...
<!-- os-status:start -->
**Status:** **304.0** `/refaktor` CatalogSourceRefField (asn/routing-guide/capa). **Etap:** Refaktor. **Następny:** leftover label-form (freight-audit / collaboration / match) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
