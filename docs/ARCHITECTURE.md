...
<!-- os-status:start -->
**Status:** **50.0** M-70 `tenant_rollout` tablica `/rollout` (zarchiwizowany). **Etap:** Plan. **Następny:** U-oklch-dark (`/plan-modul`). PLAN § Wave FE leftover — nie Q1, po Fali 11. Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
