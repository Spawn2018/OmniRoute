...
<!-- os-status:start -->
**Status:** **21.0** M-28 `customer_inquiry` przy `quotation` (zarchiwizowany). **Etap:** Plan. **Następny:** 22.0 M-29 Wykrywanie akceptacji (`/plan-modul`). Nie zgaduj schematu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
