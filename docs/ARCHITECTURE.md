...
<!-- os-status:start -->
**Status:** **320.0** CI2 HITL `spend_mark`. **Etap:** Plan — wolno `/plan-modul` **321.0**. **Następny:** **321.0** CI5 HITL `penalty_mark` (mark_code + breach_kind + source_ref; bez kara SQL). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
