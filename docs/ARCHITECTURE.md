...
<!-- os-status:start -->
**Status:** **120.0** S27b karta z decyzji oferty (M-13). **Etap:** Plan. **Następny:** `/plan-modul` leftover S11 **`changed`** na `operator_decision`. Nie accept extractu. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
