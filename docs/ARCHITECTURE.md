...
<!-- os-status:start -->
**Status:** **315.0** CI6 HITL `remediation_option`. **Etap:** Plan — wolno `/plan-modul` **316.0**. **Następny:** **316.0** CI6 HITL `impact_scenario` (scenario_code + chain_label + source_ref; bez EBITDA SQL). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
