...
<!-- os-status:start -->
**Status:** **329.0** G8 HITL `legal_hold_mark`. **Etap:** Plan — wolno `/plan-modul` **330.0** G10. **Następny:** **330.0** G10 multi-company w tenancie (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
