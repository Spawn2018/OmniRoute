...
<!-- os-status:start -->
**Status:** **300.0** `/refaktor` CatalogSourceRefField (prediction/weather/exchange). **Etap:** Refaktor. **Następny:** leftover label-form connector/header albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
