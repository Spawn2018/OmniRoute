...
<!-- os-status:start -->
**Status:** **16.0** M-23 `nbp_rate` przy `quotation` (zarchiwizowany). **Etap:** Plan. **Następny:** 17.0 M-24 Ryzyko oferty (`/plan-modul`). Nie zgaduj schematu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
