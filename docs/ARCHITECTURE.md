...
<!-- os-status:start -->
**Status:** **32.0** M-39 `edi_message` tablica `/edi` (zarchiwizowany). **Etap:** Plan. **Następny:** M-40 Fakturowanie i KSeF (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
