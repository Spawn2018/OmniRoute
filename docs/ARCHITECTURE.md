...
<!-- os-status:start -->
**Status:** **68.0** S5 istniejący silnik wyceny na `customer_rfq`. **Etap:** Plaster. **Następny:** 69.0 S6 `/plaster` — ewaluacja `applies_when` w SQL. Nie zapis marży do `charge`. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
