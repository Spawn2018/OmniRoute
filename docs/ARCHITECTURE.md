...
<!-- os-status:start -->
**Status:** **342.0** EXP2.5 HITL `sanctions_mark`. **Etap:** Plan — wolno `/plan-modul` **343.0** EXP2.6. **Następny:** **343.0** EXP2.6 subcontract_edge (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
