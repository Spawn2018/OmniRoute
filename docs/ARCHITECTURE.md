...
<!-- os-status:start -->
**Status:** **19.0** M-26 `offer_document` przy `quotation` (zarchiwizowany). **Etap:** Plan. **Następny:** 20.0 M-27 Wycena wsadowa (`/plan-modul`). Nie zgaduj schematu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
