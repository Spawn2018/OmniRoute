...
<!-- os-status:start -->
**Status:** **46.0** M-56 `gdpr` tablica `/gdpr` (zarchiwizowany). **Etap:** Plan. **Następny:** M-57 (`/plan-modul`). Nie zgaduj nazwy ani schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
