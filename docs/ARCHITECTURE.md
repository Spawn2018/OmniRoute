...
<!-- os-status:start -->
**Status:** **509.0** AI3.3 leftover — golden ≥500. **Etap:** Plan — delta **510.0** AI3.3 leftover golden ≥2000 (przed `/plaster`). **Następny:** **510.0** AI3.3 leftover — pętla golden ≥2000 pytest (nie DocLayNet; nie live vision) Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
