...
<!-- os-status:start -->
**Status:** **100.0** S38 koszt pieniądza (M-43). **Etap:** Plan. **Następny:** `/plan-modul` **S39** — żywe M-44 różnice kursowe. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
