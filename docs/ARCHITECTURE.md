...
<!-- os-status:start -->
**Status:** **289.0** leftover CT4 matching lane/mode na ASN. **Etap:** Plan. **Następny:** leftover Fala CT / pin — matching na shipment albo następny wąski HITL z PLAN. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
