...
<!-- os-status:start -->
**Status:** **42.0** M-49 `intermodal_rail` tablica `/rail` (zarchiwizowany). **Etap:** Plan. **Następny:** M-50 Kolej z Chin (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
