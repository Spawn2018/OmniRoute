...
<!-- os-status:start -->
**Status:** **317.0** CI3 HITL `clause_notice`. **Etap:** Plan — wolno `/plan-modul` **318.0**. **Następny:** **318.0** CI7 HITL `calibration_mark` (mark_code + sample_ready + source_ref; bez MAE SQL). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
