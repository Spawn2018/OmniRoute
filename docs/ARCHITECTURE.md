...
<!-- os-status:start -->
**Status:** **302.0** `/refaktor` CatalogSourceRefField (kek/PO/terminal-slot). **Etap:** Refaktor. **Następny:** leftover label-form (po-line / visibility / sap) albo wąski HITL. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
