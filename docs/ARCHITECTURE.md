...
<!-- os-status:start -->
**Status:** **319.0** CI8 HITL `repair_playbook`. **Etap:** Plan — wolno `/plan-modul` **320.0**. **Następny:** **320.0** CI2 HITL `spend_mark` (mark_code + leakage_kind + source_ref; bez SQL FV vs charge). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
