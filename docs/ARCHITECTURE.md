...
<!-- os-status:start -->
**Status:** **347.0** EXP2.10 HITL `what_if_mark`. **Etap:** Plan — wolno `/plan-modul` **348.0** EXP2.11. **Następny:** **348.0** EXP2.11 cabotage (węższa z kolejki; delta do utworzenia). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
