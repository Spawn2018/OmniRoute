...
<!-- os-status:start -->
**Status:** **312.0** `/refaktor` CatalogSourceRefField (local-charge/charge-template/cod). **Etap:** Plan. **Następny:** wąski HITL z pinu **2026-09-08c** (nie park: U1 masowy / wspólny SELECT / live HTTP / CAPA workflow). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
