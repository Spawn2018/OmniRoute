...
<!-- os-status:start -->
**Status:** **92.0** S30 dokumenty na zleceniu (M-38). **Etap:** Plan. **Następny:** `/plaster` **93.0** — S31 tabela wyjątków (M-37). Nie mapa. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
...
backend/app/
  ...
  services/        carrier_inquiries · channel_quotes · charge_codes · charges · commodity_codes · customer_rfqs · dangerous_goods · extraction · geography · inbound_messages · mail_drafts · nbp_rates · networks · operator_decisions · operator_notices · organization_settings · outbox_events · parties · port_surcharges · quotations · rate_lines · shipment_documents · shipments · tenancy · tracking_events
