...
<!-- os-status:start -->
**Status:** **522.0** AI5.0 — HITL `data_source`. **Etap:** Plan — delta **523.0** zaakceptowana (`/noc 7`); wolno `/plaster`. **Następny:** **523.0** AI5.0 leftover — HITL `ingest_gate_mark` (brama źródło/właściciel/wyjątek; nie live ingest) Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
