...
<!-- os-status:start -->
**Status:** **307.0** `/refaktor` CatalogSourceRefField (rfp-intake/playbook/consortium). **Etap:** Refaktor. **Następny:** leftover label-form (tender-* reszta / rate-card / …) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
