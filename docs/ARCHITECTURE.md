...
<!-- os-status:start -->
**Status:** **15.0** M-15 `finance_board` (zarchiwizowany). **Etap:** Plan. **Następny:** 16.0 M-23 `nbp_rate` przy `quotation` (`/plaster`). Czyta katalog 6.0. Nie mnożenie kwoty. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
