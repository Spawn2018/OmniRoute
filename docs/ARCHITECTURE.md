...
<!-- os-status:start -->
**Status:** **321.0** CI5 HITL `penalty_mark`. **Etap:** Plan — wolno `/plan-modul` **322.0**. **Następny:** **322.0** leftover Fala CI wyczerpane HITL katalogów — Plan G/EXP wąski z pinu (czytaj PLAN § Kolejka). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
