...
<!-- os-status:start -->
**Status:** **281.0** leftover HITL `sap_connector`. **Etap:** Plan. **Następny:** leftover Fala CT / pin — CT12 CAPA katalog albo egzekucja 409 z `routing_guide`. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
