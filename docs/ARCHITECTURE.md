...
<!-- os-status:start -->
**Status:** **526.0** AI5.0 leftover — HITL `kpi_definition_mark`. **Etap:** Plan — brak delty **527.0**; `/plan-modul`. **Następny:** **527.0** N6 — `margin_floor` Decimal per tenant/lane (409 albo S11; nie LLM) Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
