...
<!-- os-status:start -->
**Status:** **529.0** N11 — HITL `handover_sbar_mark`. **Etap:** Plan **530.0** — wolno `/plan-modul` (N2 trips_to_bill). **Następny:** **530.0** N2 — HITL `trips_to_bill` (po T2+F1) Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
