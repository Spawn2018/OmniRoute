...
<!-- os-status:start -->
**Status:** **305.0** `/refaktor` CatalogSourceRefField (freight-audit/collaboration/match). **Etap:** Refaktor. **Następny:** leftover label-form (otif / enforcement / inne mark) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
