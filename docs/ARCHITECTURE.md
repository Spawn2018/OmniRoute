...
<!-- os-status:start -->
**Status:** **290.0** leftover CT4 matching lane/mode na shipment. **Etap:** Plan. **Następny:** leftover Fala CT / pin — wspólny SELECT / auto shipment / CT2 albo następny wąski HITL z PLAN. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
