...
<!-- os-status:start -->
**Status:** **314.0** CI4 HITL `delay_forecast`. **Etap:** Plan — wolno `/plan-modul` **315.0**. **Następny:** **315.0** CI6 HITL `remediation_option` (kind + source_ref; bez kwoty). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
