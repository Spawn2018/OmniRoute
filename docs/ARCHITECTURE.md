...
<!-- os-status:start -->
**Status:** **82.0** S19 `network_member` (M-12). **Etap:** Plan. **Następny:** `/plaster` **83.0** — zapytanie do agenta (M-30). Buy side. Tabela. Nie live HTTP. Nie F9.1. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
