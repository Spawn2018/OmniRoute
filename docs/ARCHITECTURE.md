...
<!-- os-status:start -->
**Status:** **316.0** CI6 HITL `impact_scenario`. **Etap:** Plan — wolno `/plan-modul` **317.0**. **Następny:** **317.0** CI3 HITL `clause_notice` (notice_code + clause_label + source_ref; bez 409). Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
