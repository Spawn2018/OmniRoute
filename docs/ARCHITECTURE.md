...
<!-- os-status:start -->
**Status:** **297.0** `/refaktor` CatalogSourceRefField (circle/lane-km/plan-snapshot). **Etap:** Refaktor. **Następny:** leftover label-form `source_ref` (Q-E1) albo wąski HITL z pinu. Plan: [PLAN-REALIZACJA.md](PLAN-REALIZACJA.md).
<!-- os-status:end --> 
