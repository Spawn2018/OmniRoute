...
| zasób floty | resource | T2; pojazd / kierowca / naczepa; 259.0 trasa `/fleet`; 589.0 `capacity_kg` / 590.0 `capacity_ldm` / 591.0 `capacity_m3` HITL; 592.0 `resource_document` (rodzaj + data, nie odliczanie); 593.0 `inventory_no` HITL; 594.0 `adr_certified` HITL; 595.0 `reefer` HITL; 596.0 `tail_lift` HITL; 597.0 `phone` HITL; nie trip; nie GPS |
