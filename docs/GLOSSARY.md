...
| punkt operacyjny | stop | T1; ZA/WY na zleceniu; miejsce ze słownika; 213.0 opcjonalny `stop_group_code`; 215.0 opcjonalny `notes_for_driver`; 247.0 opcjonalny `weight_kg`; 248.0 opcjonalny `quantity`; 249.0 opcjonalny `packaging_code`; 250.0 opcjonalny `seal_in`; nie mapa |
