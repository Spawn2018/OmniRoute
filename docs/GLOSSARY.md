...
| wiadomość przychodząca | inbound_message | 64.0 tabela per tenant; 66.0 treść → extract HITL; 78.0 ingest `graph://` + `external_id`; nie live HTTP; nie IMAP; nie send; nie blob |
