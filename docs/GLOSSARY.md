...
| dopłata lokalna | local_charge | 166.0 THC/ISPS/seal/amendment + Decimal; 207.0 opcjonalny `port_unlocode`; 208.0 opcjonalny `iso_size_type`; leftover P4b armator/serwis = **633.0**; nie warning; nie `port_surcharge` |
