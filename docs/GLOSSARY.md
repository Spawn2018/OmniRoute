...
| grupa punktów | stop_group | T1b; HITL nagłówek grupy na zleceniu (`group_code` + `shipment_id`); 213.0 `stop_group_code` na punkcie zostaje; członkostwo FK leftover; nie mapa |
