...
| przejazd | trip | T2; status + opcjonalny zasób; 212.0 opcjonalny `driver2_id`; 214.0 opcjonalny `route_label`; 256.0 opcjonalny `planned_distance_km`; 167.0 snapshot `expected_buy`; nie liczenie km; nie wariancja |
