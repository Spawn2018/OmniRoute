...
- **277.0 leftover:** ASN / EDI 856; auto `shipment` (U1); CT8 AIS live (TO_VERIFY licencja); live p44; CI1 extract. 277.0 = linia SKU, nie ASN. Lock trasy: `SHIPPED_CHARGE_ROUTES["277.0"]` w `routes-breadth.test.ts`.
- **276.0 leftover:** `po_line` DONE 277.0. Zostaje ASN / EDI 856; auto `shipment` (U1); CT8 AIS live (TO_VERIFY licencja); live p44; CI1 extract. 276.0 = nagłówek. Lock trasy: `SHIPPED_CHARGE_ROUTES["276.0"]` w `routes-breadth.test.ts`.
- **275.0 leftover:** live p44 / FourKites / Shippeo (TO_VERIFY umowa); CT8 AIS live; CT1 `po_line` / ASN. 275.0 = fixture `p44`, nie live track. Lock trasy: `SHIPPED_CHARGE_ROUTES["275.0"]` w `routes-breadth.test.ts`.
