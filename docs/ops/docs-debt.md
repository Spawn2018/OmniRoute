...
- **233.0 leftover:** leftover T3 `free_time_dest_h` DONE 234.0. leftover T3 `si_cutoff_at` DONE 235.0. leftover T3 `ams_cutoff_at` DONE 236.0. Zostaje leftover T3 `cy_cutoff_at`; `carrier_party_id` FK; PIN; VGM/cutoffy; booking. Tu tylko `free_time_origin_h` HITL. Nie odliczanie. Nie PIN.
- **234.0 leftover:** leftover T3 `si_cutoff_at` DONE 235.0. leftover T3 `ams_cutoff_at` DONE 236.0. Zostaje leftover T3 `cy_cutoff_at`; `carrier_party_id` FK; PIN; VGM/cutoffy; booking. Tu tylko `free_time_dest_h` HITL. Nie odliczanie. Nie PIN.
- **235.0 leftover:** leftover T3 `ams_cutoff_at` DONE 236.0. Zostaje leftover T3 `cy_cutoff_at`; `carrier_party_id` FK; PIN; VGM/cutoffy; booking. Tu tylko `si_cutoff_at` HITL. Nie live HTTP. Nie PIN.
- **236.0 leftover:** leftover T3 `cy_cutoff_at`; `carrier_party_id` FK; PIN; VGM/cutoffy; booking. Tu tylko `ams_cutoff_at` HITL. Nie live HTTP. Nie PIN.
