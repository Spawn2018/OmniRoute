...
- **178.0 leftover:** `draft_kind=tender_rfp` + gałąź accept (G2.9b); prospecting / four-eyes / TED / CO₂ (G2.10–G2.18). Tu tylko `tender_rfp_intake` HITL + `source_ref`. Nie zapis z LLM. Nie kwota. Nie auto-award.
