...
- **285.0 leftover:** żywy HTTP 409 przy zapisie zlecenia/ASN poza guide; wspólny SELECT; CT9; auto shipment; CT2; CT5/CT8 live. 285.0 = katalog trybu. Lock trasy: `SHIPPED_CHARGE_ROUTES["285.0"]`.
- **284.0 leftover:** wspólny SELECT; tuple OpenFGA 3 strony; egzekucja 409 (katalog trybu DONE 285.0); CT9; auto shipment; CT2; CT5/CT8 live. 284.0 = katalog roli. Lock trasy: `SHIPPED_CHARGE_ROUTES["284.0"]`.
- **283.0 leftover:** SQL FV vs `charge`; druga marża; egzekucja 409 (katalog trybu DONE 285.0); auto shipment; CT2; CT5/CT8 live; CT9/CT11. 283.0 = katalog rodzaju. Lock trasy: `SHIPPED_CHARGE_ROUTES["283.0"]`.
- **282.0 leftover:** workflow CAPA/8D; egzekucja 409 (katalog trybu DONE 285.0); auto shipment; CT2; CT5/CT8 live. 282.0 = katalog rodzaju. Lock trasy: `SHIPPED_CHARGE_ROUTES["282.0"]`.
- **281.0 leftover:** live SOAP/RFC/SQL do SAP; CT12 CAPA; egzekucja 409 (katalog trybu DONE 285.0); auto shipment; CT2; CT5/CT8 live. 281.0 = katalog. Lock trasy: `SHIPPED_CHARGE_ROUTES["281.0"]`.
- **280.0 leftover:** OTIF% SQL / egzekucja na stop/SKU; egzekucja 409 z `routing_guide` (katalog trybu DONE 285.0); CT1 auto shipment; CT2 klej CI5; CT5 EDI live; CT8 AIS live. 280.0 = katalog zakresu. Lock trasy: `SHIPPED_CHARGE_ROUTES["280.0"]`.
- **279.0 leftover:** egzekucja 409 z `routing_guide` (katalog trybu DONE 285.0); CT1 auto shipment (compose + quotation); CT2 klej CI5; CT3 OTIF% (katalog zakresu DONE 280.0); CT5 EDI live; CT8 AIS live. 279.0 = katalog, nie 409. Lock trasy: `SHIPPED_CHARGE_ROUTES["279.0"]`.
...
- **262.0 leftover:** rollup SQL marży po `parent_shipment_id` (brak `charge.shipment_id`). Tu tylko GET listy `sell_amount - buy_amount` w SQL. Nie generated column.
