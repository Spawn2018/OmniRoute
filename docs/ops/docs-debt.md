...
- **179.0 leftover:** prospecting HITL / bid/no-bid / four-eyes / TED / CO₂ (G2.10–G2.18). Tu tylko `draft_kind=tender_rfp` + accept → `tender_rfp_intake`. Nie zapis z LLM. Nie kwota. Nie auto-award.
