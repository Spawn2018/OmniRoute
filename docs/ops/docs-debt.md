...
- **278.0 leftover:** auto `shipment` (U1) z ASN; CT5 EDI 856 live; CT8 AIS live (TO_VERIFY licencja); live p44; CI1 extract. 278.0 = awizo HITL, nie live EDI. Lock trasy: `SHIPPED_CHARGE_ROUTES["278.0"]` w `routes-breadth.test.ts`.
- **277.0 leftover:** ASN DONE 278.0. Zostaje auto `shipment` (U1); CT5 EDI 856 live; CT8 AIS live (TO_VERIFY licencja); live p44; CI1 extract. 277.0 = linia SKU. Lock trasy: `SHIPPED_CHARGE_ROUTES["277.0"]` w `routes-breadth.test.ts`.
- **276.0 leftover:** `po_line` DONE 277.0; ASN DONE 278.0. Zostaje auto `shipment` (U1); CT5 EDI 856 live; CT8 AIS live (TO_VERIFY licencja); live p44; CI1 extract. 276.0 = nagłówek. Lock trasy: `SHIPPED_CHARGE_ROUTES["276.0"]` w `routes-breadth.test.ts`.
- **275.0 leftover:** live p44 / FourKites / Shippeo (TO_VERIFY umowa); CT8 AIS live; CT1 ASN DONE 278.0. 275.0 = fixture `p44`, nie live track. Lock trasy: `SHIPPED_CHARGE_ROUTES["275.0"]` w `routes-breadth.test.ts`.
