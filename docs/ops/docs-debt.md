...
- **75.0 leftover — filtr 27.0 i send (dlaczego nie w tym plasterze):** S12 = tabela inbox. Tablica HITL/wycen pending zostaje odczytem, nie źródłem wierszy. Auto-INSERT i Graph send = S13/S18.
