...
- **25.0 leftover — live IMAP / sekrety (dlaczego nie w tym plasterze):** leftover HC magazynu kluczy tenanta. Tabela skrzynki = zgadywanie schematu. Outlook = M-33. `just dup` 2,69%.
