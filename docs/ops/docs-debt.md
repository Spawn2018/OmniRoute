...
- **230.0 leftover:** leftover T3 `return_terminal`; `carrier_party_id` FK; PIN; VGM/cutoffy; booking. Tu tylko `pickup_terminal` HITL. Nie FK. Nie PIN.
