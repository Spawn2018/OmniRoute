...
- **458.0 leftover:** parowanie z `resource`; cykl życia poza kind; silnik awarii; live poll; BR2.2 zgoda. Tu tylko `telematics_device` HITL `device_kind` + `source_ref`. Nie live. Nie konektor V5.
