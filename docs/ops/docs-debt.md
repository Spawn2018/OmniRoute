...
- **457.0 leftover:** współrzędne jako dane; `observed_at`; FK resource/trip; live poll; BR2.1 urządzenie. Tu tylko `position_event` HITL `source_kind` + `source_ref`. Nie live GPS. Nie `tracking_event`.
