...
- **174.0 leftover:** extract RFP HITL; playbook; four-eyes; TED (G2.6–G2.18). FK `charge` leftover. Tu tylko `tender_matrix_cell` Decimal z P. Nie LLM kolumny. Nie druga marża. Nie auto-award.
