- **439.0 leftover:** AI1.4 FK `twin_mark` (440.0) · `data_source` (park AI5) · `outcome_ledger.outcome_kind` CHECK; trzy BC; silnik AI4.1; CRPS (AI2). 439.0 = FK `suggestion_ledger` → `suggestion_kind`.
