...
**648.0 DONE:** `rate_line.index_id` opcjonalny pin FSC/BAF/CAF HITL. Nie FK fuel_index. Nie float. Nie mnożenie FSC. Leftover: charge_code waiting/no_show/diversion/stamp → **649.0** · FK fuel_index · spot_or_contract na quotation · matching · live MQC.
**649.0 PLAN:** seed `charge_code` waiting/no_show/diversion/stamp + source_ref. Nie matching. Nie float. Nie druga marża.
