...
- **71.0 leftover — numer na ofercie (dlaczego nie w tym plasterze):** S8 = prefiks i token w M-03. `quotation.document_number` + licznik = S9 dokument, nie nowy silnik w ustawieniach.
