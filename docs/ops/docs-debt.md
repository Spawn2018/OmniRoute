...
- **276.0 leftover:** `po_line` (sku, qty Decimal, uom, plant, batch, serial, coo); ASN / EDI 856; auto `shipment` (U1); CT8 AIS live (TO_VERIFY licencja); live p44; CI1 extract. 276.0 = nagłówek, nie linia. Lock trasy: `SHIPPED_CHARGE_ROUTES["276.0"]` w `routes-breadth.test.ts`.
