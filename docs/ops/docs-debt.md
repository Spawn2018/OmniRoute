...
- **28.0 leftover — tabela `shipment` / odcinki / tracking (dlaczego nie w tym plasterze):** CURRENT zakazał zgadywania schematu. HBL, kontenery, dwie marże = makieta, nie kod. M-36 tracking = osobny Plan. `just dup` 2,71%.
