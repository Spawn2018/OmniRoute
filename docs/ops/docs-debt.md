...
- **49.0 leftover — scoring / tabela QA / `ab_delta_chars` (dlaczego nie w tym plasterze):** CURRENT zakazał zgadywania schematu. LLM/JS nie liczy jakości. M-70 wdrożenie = osobny Plan.
