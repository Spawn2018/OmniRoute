...
- **26.0 leftover — dodatek Office / Graph (dlaczego nie w tym plasterze):** CURRENT zakazał zgadywania schematu. Auth0 odroczone. M-34 powiadomienia = osobny Plan. `just dup` 2,69%.
