...
- **629.0 DONE:** `pallet_ledger` HITL ruch sztuk ze znakiem. Nie mutuje salda. Leftover: D7b giełda park live · synchro stance · auto-UPDATE salda park.
- **623.0 DONE:** `pallet_balance.pallet_kind` przyjmuje `epal`. Leftover: D7b giełda park live · D7c ledger = **629.0** DONE · synchro stance.
