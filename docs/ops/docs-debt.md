...
- **27.0 leftover — tabela zdarzeń / push / SMTP (dlaczego nie w tym plasterze):** CURRENT zakazał zgadywania schematu. Outbox = M-02 parked. Fala 5 zlecenie = osobny Plan. `just dup` 2,67%.
