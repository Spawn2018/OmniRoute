...
Po **każdym** plasterze: `docs/ops/post-plaster.md` (dług w diffie, max 3 poprawki).
Ten plik = slot tygodniowy na ruchy poza plasterem. Nie łącz z domeną. Nie fałszuj `refactor_ratio` w plasterze.
