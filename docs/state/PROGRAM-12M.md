...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **18.0** M-25 `offer_negotiation` przy `quotation` (zarchiwizowany) **Następny:** 19.0 M-26 `offer_document` przy `quotation` (`/plaster`). Podgląd faktów. Nie PDF. Nie U-print.
<!-- os-status:end -->
