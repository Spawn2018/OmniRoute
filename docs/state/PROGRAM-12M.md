...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **40.0** M-47 `bookkeeping` tablica `/bookkeeping` (zarchiwizowany) **Następny:** M-48 Transport drogowy (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
