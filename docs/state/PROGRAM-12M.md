...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **123.0** leftover S12 filtr kind na tablicy 27.0 (M-34) **Następny:** `/plaster` leftover S32 kafelki liczników na `/watchtower`. Nie leaflet. Nie AIS. Nie F9.1.
<!-- os-status:end -->
