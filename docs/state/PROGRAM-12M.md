...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **31.0** M-38 `shipment_document` tablica `/shipment-documents` (zarchiwizowany) **Następny:** M-39 EDI (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
