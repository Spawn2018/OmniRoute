...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **589.0** T2 `resource.capacity_kg` (gate success) **Następny:** **590.0** T2 leftover HITL `resource.capacity_ldm` (delta open). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3.
<!-- os-status:end -->
