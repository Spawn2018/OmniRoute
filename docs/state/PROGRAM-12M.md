...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **613.0** T4 `charge.shipment_id` (gate success) **Następny:** **614.0** widok SQL marży korzenia i bezpośrednich dzieci. Nie generated column. Nie kurs. Nie wnuki. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
