...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **557.0** C8 `document_kind_match_mark` **Następny:** **558.0** C1 leftover HITL `filing_bind_mark`. Nie AI3-payload. Nie G0-SH. Nie PUESC. Nie FK shipment.
<!-- os-status:end -->
