...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **478.0** BR7.0 — HITL `ops_room_mark` **Następny:** **BR7.1** wpływ na linię produkcyjną — warstwa liczona — wskaż Q z [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) § Kolejka
<!-- os-status:end -->
