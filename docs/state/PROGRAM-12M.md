...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **624.0** D4b `document_kind=rod` (CI po push) **Następny:** **625.0** D5b objętość na cenniku drobnicy (HITL, nie kalkulator). Daty bazowe zlecenia / matching T5 / FK kontekstu / T8 live / D6b konsolidacja / D7b giełda = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
