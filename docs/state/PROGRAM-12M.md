...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **418.0** EXP0.6 HITL `named_place_mark` **Następny:** **419.0** EXP0.3 HITL `slot_guarantee_mark` (capability|non_guarantee|other; bez live T8) — kolejka po cutoff.
<!-- os-status:end -->
