...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **617.0** T7c `fx_rate_day` (testy lokalne; CI po push) **Następny:** po gate success plan **618.0** T7d SQL przy FV. Matching T5 / FK kontekstu = park. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
