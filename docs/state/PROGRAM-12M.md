...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **25.0** M-32 `mail_integration` tablica `/mail` (zarchiwizowany) **Następny:** 26.0 M-33 `mail_client` (`/plaster`). `mailto:` na `/mail`. Nie Office.js. Nie Graph.
<!-- os-status:end -->
