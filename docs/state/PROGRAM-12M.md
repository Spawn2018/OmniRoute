...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **599.0** T2 `resource.vehicle_profile` (gate success) **Następny:** **600.0** T1b leftover HITL (po T2: HW park). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3. Nie HW.
<!-- os-status:end -->
