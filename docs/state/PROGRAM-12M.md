...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **313.0** CI1 HITL `sla_clause` **Następny:** leftover CI1 ciphertext/kara SQL **parked** — wąski HITL z pinu (CI2 / G / EXP) albo kolejny pin bez park live.
<!-- os-status:end -->
