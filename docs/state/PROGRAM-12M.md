...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **614.0** T4 `shipment_tree_margin` (testy lokalne; CI po push) **Następny:** po gate success kolejny Q z PLAN poza HW, UXCL, N3, AI3, G0-SH. Wnuki rollup zostają. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
