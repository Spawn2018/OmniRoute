...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **39.0** M-46 `cost_to_serve` tablica `/cost-to-serve` (zarchiwizowany) **Następny:** 40.0 M-47 `bookkeeping` tablica `/bookkeeping`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
