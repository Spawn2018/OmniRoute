...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **33.0** M-40 `sales_invoice` tablica `/invoices` (zarchiwizowany) **Następny:** M-41 Rozliczenie wyceny z fakturą (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
