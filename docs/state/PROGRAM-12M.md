...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **51.0** U-oklch-dark tokeny `oklch` + `.dark` (zarchiwizowany) **Następny:** 52.0 U-money-align oś dziesiętna na `<Money/>`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
