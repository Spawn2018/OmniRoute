...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **449.0** AI3.2 — `payload.extract_path` text|image (etykieta) **Następny:** **450.0** własny zbiór golden + bramka pytest. Nie liczby z papieru. Nie Excel. Nie live vision.
<!-- os-status:end -->
