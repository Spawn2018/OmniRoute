...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **567.0** V3 `container.detention_free_days` (gate success) **Następny:** **568.0** V3 leftover HITL `container.mixed_dd_days`. Nie countdown N3. Nie szkic charge. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
