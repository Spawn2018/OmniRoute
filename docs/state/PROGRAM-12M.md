...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **577.0** T3 `container.return_date` (gate success) **Następny:** **578.0** leftover T3 HITL `container.gate_in_date`. Nie `delivery_date`. Nie cutoff timestamptz. Nie `temp_min`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
