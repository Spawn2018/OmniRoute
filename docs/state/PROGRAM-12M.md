...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **600.0** T1b `stop_group` tabela (gate success) **Następny:** **601.0** T1b leftover bind (`stop.stop_group_id` / sync z `stop_group_code`). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3. Nie HW.
<!-- os-status:end -->
