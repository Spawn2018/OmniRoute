...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **65.0** S2 `resolve_email` na `inbound_message` **Następny:** 66.0 S3 `/plaster` — treść `inbound_message` → extract HITL. Serwis nie zapisuje `rate_line`. Nie IMAP. Nie F9.1.
<!-- os-status:end -->
