...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **31.0** M-38 `shipment_document` tablica `/shipment-documents` (zarchiwizowany) **Następny:** `/plaster` 32.0 M-39 `edi_message` tablica `/edi`. Nie nowa tabela. Nie zgaduj schematu X12.
<!-- os-status:end -->
