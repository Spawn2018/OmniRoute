...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **535.0** EXPLAIN · rytuały **SH-R16-12/14/15** DONE · **13** czeka (nie `/noc`) **Następny:** leftover O8 rfc822 · albo UXCL-L1 · G0. SH-R16-13 tylko poza nocą. Nie AI0.
<!-- os-status:end -->
