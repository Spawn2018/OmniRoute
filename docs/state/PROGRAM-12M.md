...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **579.0** T3 `container.delivery_date` (gate success) **Następny:** **580.0** leftover T3 HITL `container.unload_date`. Nie `temp_min`. Nie cutoff timestamptz. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
