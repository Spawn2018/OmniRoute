...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **614.0** T4 `shipment_tree_margin` (gate success) **Następny:** **615.0** opcjonalne nadpisanie kursu na opłacie (tokeny jak 211.0). Nie mnożenie NBP. Nie T7c. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
