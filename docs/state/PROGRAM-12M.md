...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **431.0** EXP1 HITL `quote_validity_mark` **Następny:** **AI1.0** `suggestion_ledger` — podpowiedź: BC, encja, przedział/pewność, wersja modelu i promptu, reakcja `accept|modify|reject` i na co zmienił.
<!-- os-status:end -->
