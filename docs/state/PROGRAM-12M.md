...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **492.0** BR6.1 leftover — `volume_label` tekst na `sales_lane` **Następny:** **493.0** BR6.2 leftover — HITL `shipper_round_mark` (`round_kind` first|second|final|other; nie Alpega)
<!-- os-status:end -->
