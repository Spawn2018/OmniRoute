...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **4.1** M-05 `location` + strefy taryfowe (zarchiwizowany) **Następny:** **4.2** M-05 `terminal` (ISPS, operator jako tekst) + pola World Port Index na `port`. Spec: `docs/spec/geography.md`. Nie Q2.
<!-- os-status:end -->
