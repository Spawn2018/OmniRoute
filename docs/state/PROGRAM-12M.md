...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **590.0** T2 `resource.capacity_ldm` (gate success) **Następny:** **591.0** T2 leftover HITL `resource.capacity_m3` (delta open). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3.
<!-- os-status:end -->
