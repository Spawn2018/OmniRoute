...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **453.0** AI4.1 — FK `counterfactual_run` → `plan_snapshot` + widok `what_if_replay` **Następny:** **454.0** symulacja kółek w SQL (do 500k). Nie solver w Pythonie. Nie kwota.
<!-- os-status:end -->
