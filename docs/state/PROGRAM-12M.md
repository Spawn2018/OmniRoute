...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **48.0** M-68 `observability` tablica `/health` (zarchiwizowany) **Następny:** 49.0 M-69 `extraction_quality` tablica `/quality`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
