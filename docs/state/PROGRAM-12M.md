...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **582.0** T3 `container.temp_max` (CI po push) **Następny:** **583.0** leftover T3 HITL `container.needs_external_power`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
