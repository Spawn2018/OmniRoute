...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **51.0** U-oklch-dark tokeny `oklch` + `.dark` (zarchiwizowany) **Następny:** U-money-align (`/plan-modul`). PLAN § Wave FE leftover. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
