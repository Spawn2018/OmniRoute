...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **19.0** M-26 `offer_document` przy `quotation` (zarchiwizowany) **Następny:** 20.0 M-27 `quotation_batch` (`/plaster`). Wiele kodów, jedna lane. Nie CSV. Nie nowa tabela.
<!-- os-status:end -->
