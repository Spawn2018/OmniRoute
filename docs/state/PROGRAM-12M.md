...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **290.0** leftover CT4 matching lane/mode na shipment **Następny:** leftover Fala CT / pin — wspólny SELECT / auto shipment / CT2 albo następny wąski HITL z PLAN.
<!-- os-status:end -->
