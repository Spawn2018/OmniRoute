...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **308.0** `/refaktor` CatalogSourceRefField (prospect/win-loss/data-room) **Następny:** leftover label-form (tender lot/lane/quote / rate-card / …) albo wąski HITL z pinu.
<!-- os-status:end -->
