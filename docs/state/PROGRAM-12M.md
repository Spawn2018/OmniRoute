...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **63.0** Q-E4 threat model tenant+HITL + CodeQL **Następny:** 64.0 S1 `/plaster` — `inbound_message` + draft + fixture. RLS, `source_ref`. Nie Graph, nie IMAP, nie send, nie `shipment`. Nie F9.1.
<!-- os-status:end -->
