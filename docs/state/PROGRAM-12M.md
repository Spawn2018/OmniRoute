...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **619.0** U3c pule HAWB/MAWB (lokalnie; CI po push) **Następny:** **620.0** U3 leftover e-rates IATA HITL (`channel_quote` + `source_ref`). Daty bazowe zlecenia / matching T5 / FK kontekstu / T8 live / cyfra kontrolna IATA = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
