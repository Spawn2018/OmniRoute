...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **22.0** M-29 `offer_acceptance` przy `quotation` (zarchiwizowany) **Następny:** 23.0 M-30 Zapytania do agentów/armatorów (`/plan-modul`). Nie zgaduj schematu.
<!-- os-status:end -->
