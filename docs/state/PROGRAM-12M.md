...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **41.0** M-48 `road_transport` tablica `/road` (zarchiwizowany) **Następny:** M-49 Kolej intermodalna (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
