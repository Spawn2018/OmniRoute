...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **550.0** F10 `invoice_match_mark` **Następny:** **551.0** F10 leftover HITL `invoice_alloc_mark` (`purchase_invoice_allocation`). Nie ranking SQL. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
