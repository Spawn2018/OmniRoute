...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **448.0** AI3.1 — `payload.revision` + `bbox_text` / `confidence_text` **Następny:** **449.0** obraz wprost vs tekst (challenger). Nie Excel. Nie golden. Nie zapis z modelu.
<!-- os-status:end -->
