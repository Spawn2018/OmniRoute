...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **493.0** BR6.2 leftover — HITL `shipper_round_mark` **Następny:** **494.0** BR6.2 leftover — HITL `shipper_like_mark` (`like_kind` match|gap|bench|other; nie Alpega)
<!-- os-status:end -->
