...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **623.0** D7d `pallet_kind=epal` (gate success) **Następny:** **624.0** D4b POD/ROD na dokumencie zlecenia (HITL, nie skan). Daty bazowe zlecenia / matching T5 / FK kontekstu / T8 live / D6b konsolidacja / D7b giełda = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
