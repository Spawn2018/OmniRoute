...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **566.0** V3 `container.demurrage_free_days` (lokalnie; CI po push) **Następny:** **567.0** V3 leftover HITL `container.detention_free_days`. Nie countdown N3. Nie szkic charge. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
