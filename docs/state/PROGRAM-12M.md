...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **592.0** T2 `resource_document` (lokalne; CI po push) **Następny:** **593.0** T2 leftover HITL `resource.inventory_no` (delta open). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3.
<!-- os-status:end -->
