...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **573.0** T3 `container.quantity` (CI po push) **Następny:** **574.0** leftover T3 HITL `container.weight_kg`. Nie `stop.weight_kg`. Nie VGM. Nie quantity. Nie TEU. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
