...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **444.0** AI2.1 `version_score` — średnie MAE/CRPS per `model_version` **Następny:** **445.0** AI2.1 leftover: dryf per `model_version` (oś czasu). Nie auto-champion. Nie Brier.
<!-- os-status:end -->
