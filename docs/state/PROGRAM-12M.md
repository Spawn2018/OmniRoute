...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **41.0** M-48 `road_transport` tablica `/road` (zarchiwizowany) **Następny:** 42.0 M-49 `intermodal_rail` tablica `/rail`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
