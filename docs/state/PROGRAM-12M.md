...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **53.0** U-condensed trzeci tryb gęstości na `/rate-lines` (zarchiwizowany) **Następny:** 54.0 U-primitives-json pin Radix w `components.json`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
