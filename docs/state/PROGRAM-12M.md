...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **68.0** S5 istniejący silnik wyceny na `customer_rfq` **Następny:** 69.0 S6 `/plaster` — ewaluacja `applies_when` w SQL. Nie zapis marży do `charge`. Nie F9.1.
<!-- os-status:end -->
