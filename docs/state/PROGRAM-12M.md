...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **80.0** S17 ingest IMAP na `inbound_message` (M-32) **Następny:** `/plaster` **81.0** — świadomy `mailto:` po S11+S10 (M-33). Auto-send zakazane. Nie Graph HTTP. Nie F9.1.
<!-- os-status:end -->
