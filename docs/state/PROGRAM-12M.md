...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **517.0** AI7.0 leftover — HITL `cost_category_mark` **Następny:** **518.0** AI7.0 leftover — HITL `allocation_level` (otwarty słownik poziomów; nie SQL; nie TCM)
<!-- os-status:end -->
