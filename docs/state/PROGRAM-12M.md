...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **111.0** S49 odcinek drobnicy morskiej (M-51) **Następny:** `/plan-modul` **S50** — flota (arch. M-111), tylko gdy job „własne auto”; inaczej pominąć. Nie F9.1.
<!-- os-status:end -->
