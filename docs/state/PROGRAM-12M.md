...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **287.0** leftover CT4 409 na shipment poza guide **Następny:** **288.0** leftover CT4 HITL `routing_guide_match` (tryb guide_code_only|lane_label|mode_label).
<!-- os-status:end -->
