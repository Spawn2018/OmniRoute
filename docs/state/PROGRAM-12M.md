...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **418.0** EXP0.6 HITL `named_place_mark` **Następny:** **419.0** EXP0.7 HITL `holding_mark` (holding|hq|branch|other; bez drugiego tenanta) — kolejka po cutoff.
<!-- os-status:end -->
