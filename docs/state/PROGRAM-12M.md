...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **40.0** M-47 `bookkeeping` tablica `/bookkeeping` (zarchiwizowany) **Następny:** 41.0 M-48 `road_transport` tablica `/road`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
