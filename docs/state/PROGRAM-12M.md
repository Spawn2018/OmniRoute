...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **628.0** T7 daty bazowe HITL na `shipment` (gate po push) **Następny:** **629.0** D7c ledger ruchu palet HITL. D9c 409 / D9d PDF-QR / D9e skan / D9f pdf-zpl / matching T5 / FK kontekstu / T8 live / D6b / D7b / fx×FV = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
