...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **38.0** M-45 `cash_flow` tablica `/cashflows` (zarchiwizowany) **Następny:** M-46 Koszt obsługi klienta (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
