...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **615.0** T7b `fx_rate_*` na `charge` (gate success) **Następny:** plan kolejnego Q z PLAN poza HW, UXCL, N3, AI3, G0-SH. T7c zostaje. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
