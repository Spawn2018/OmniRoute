...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **23.0** M-30 `carrier_inquiry` przy `quotation` (zarchiwizowany) **Następny:** 24.0 M-31 `response_comparison` (`/plaster`). Zestawienie kwot na POL/POD. Nie tabela. Nie spread w JS.
<!-- os-status:end -->
