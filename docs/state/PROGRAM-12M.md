...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **430.0** EXP1 HITL `quote_currency_mark` **Następny:** **431.0** EXP1 HITL `quote_validity_mark` (open|revised|superseded|other) — leftover valid_until/revision.
<!-- os-status:end -->
