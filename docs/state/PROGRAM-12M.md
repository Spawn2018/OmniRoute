...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **578.0** T3 `container.gate_in_date` (gate success) **Następny:** **579.0** leftover T3 HITL `container.delivery_date`. Nie `unload_date`. Nie cutoff timestamptz. Nie `temp_min`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
