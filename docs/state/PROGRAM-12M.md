...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **78.0** S15 ingest Graph na `inbound_message` (M-32) **Następny:** `/plan-modul` **S16** — outbox M-02, pierwsze zdarzenie „wiadomość zapisana”. Nie live HTTP. Nie send. Nie F9.1.
<!-- os-status:end -->
