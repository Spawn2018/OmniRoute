...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **609.0** T3 EXP1 `alliance_service` (gate success) **Następny:** **610.0** T3 `pol_unlocode` na `container`. `pod_unlocode` / `destination_city` parked. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
