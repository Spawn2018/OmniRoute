...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **564.0** C6 `shipment.is_waste` **Następny:** **565.0** V3 leftover HITL `blank_sailing_mark`. Nie countdown N3. Nie szkic charge. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
