...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **268.0** leftover HITL `erp_connector` Optima fixture **Następny:** leftover T8 → S53 Auth0 → portale/diada → CT7/CI9/reszta pinu 2026-09-08c. Leftover HITL/SQL = praca. Park = live HTTP bez testu albo sekretu, nie skip pola. Live M-02 konsument / Auth0 / portale tylko gdy ten ID jest bieżącym Q. P6c auto-award zakaz. Nic z pinu nie wypada. Nie zgaduj 71–269.
<!-- os-status:end -->
