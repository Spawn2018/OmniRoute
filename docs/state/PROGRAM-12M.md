...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **433.0** AI1.1 HITL `outcome_ledger` **Następny:** **434.0** AI1.2 HITL `counterfactual_run` — scenariusz + punkt odniesienia + dźwignie + wynik; niemutowalny.
<!-- os-status:end -->
