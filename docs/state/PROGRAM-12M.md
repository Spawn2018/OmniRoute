...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **533.0** O8 — buy-desk group-by + saved view **Następny:** park — leftover O6 `quote_recorded` przy accept · leftover O7/O8 EXPLAIN · SH-R16-12…15 · G0. Nie AI0.
<!-- os-status:end -->
