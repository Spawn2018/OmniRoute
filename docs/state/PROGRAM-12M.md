...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **499.0** BR6.2 leftover — HITL `shipper_award_mark` **Następny:** **500.0** AI3.0 leftover — PATCH `candidates` na `quotation` / `customer_rfq` (nie live vision; nie próg 70%)
<!-- os-status:end -->
