...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **443.0** AI2.0 `interval_score` — MAE/CRPS liczone w Postgresie **Następny:** **AI2.1** champion/challenger + dryf (po 443.0). Nie zapis `prediction_ledger`. Nie Brier.
<!-- os-status:end -->
