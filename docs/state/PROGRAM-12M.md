...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **570.0** T3 `container.pin_code` (gate success) **Następny:** **571.0** leftover T3 HITL `container.payload_kg`. Nie quantity. Nie TEU. Nie kalkulator VGM. Nie countdown N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
