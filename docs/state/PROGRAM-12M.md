...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **604.0** T1 EXP1 `no_show_at` (lokalne; CI po push) **Następny:** **605.0** T1 EXP1 leftover `weigh_in_kg`. `weigh_out_kg` parked. **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3. Nie HW.
<!-- os-status:end -->
