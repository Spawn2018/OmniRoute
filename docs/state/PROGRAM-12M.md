...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **34.0** M-41 `quote_invoice_settlement` tablica `/quote-invoices` (zarchiwizowany) **Następny:** M-42 Bank i płatności (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
