...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **580.0** T3 `container.unload_date` (gate success) **Następny:** **581.0** leftover T3 HITL `container.temp_min`. Nie `temp_max`. Nie `needs_external_power`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
