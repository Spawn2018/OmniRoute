...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **297.0** `/refaktor` CatalogSourceRefField (circle/lane-km/plan-snapshot) **Następny:** leftover label-form `source_ref` (Q-E1) albo wąski HITL z pinu.
<!-- os-status:end -->
