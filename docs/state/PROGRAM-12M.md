...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **470.0** BR4.4 — HITL `silk_corridor_mark` **Następny:** `/plan-modul` **BR5.0** faktoring (integracja z partnerem). Nie live HTTP bez nazwy partnera. Nie zgaduj plaster ID.
<!-- os-status:end -->
