...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **337.0** EXP7.2 HITL `registry_poll_mark` **Następny:** **338.0** EXP2.1 working capital DSO / cash-at-risk / aging (węższa z kolejki; delta do utworzenia).
<!-- os-status:end -->
