...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **609.0** T3 EXP1 `alliance_service` (lokalne; CI po push) **Następny:** po pushu 609.0 — kolejny leftover HITL z PLAN (nie HW, nie UXCL, nie N3). **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
