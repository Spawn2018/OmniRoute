...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **26.0** M-33 `mail_client` `mailto:` na `/mail` (zarchiwizowany) **Następny:** 27.0 M-34 `operator_notice` (`/plaster`). Tablica HITL pending + wyceny pending. Nie tabela. Nie wysyłka.
<!-- os-status:end -->
