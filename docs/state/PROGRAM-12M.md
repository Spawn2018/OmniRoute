...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **621.0** D6c pule HBL/MBL z M-03 (gate po push) **Następny:** **622.0** U3 leftover cyfra kontrolna IATA (HITL, nie live). Daty bazowe zlecenia / matching T5 / FK kontekstu / T8 live / D6b konsolidacja = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
