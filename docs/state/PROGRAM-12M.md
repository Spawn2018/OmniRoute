...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **595.0** T2 `resource.reefer` (gate success) **Następny:** **596.0** T2 leftover HITL `resource.tail_lift` (delta open). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3.
<!-- os-status:end -->
