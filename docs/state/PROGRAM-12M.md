...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **565.0** V3 `blank_sailing_mark` **Następny:** **566.0** V3 leftover HITL `container.demurrage_free_days`. Nie countdown N3. Nie szkic charge. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
