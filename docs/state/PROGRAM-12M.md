...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **309.0** `/refaktor` CatalogSourceRefField (lot/lane/quote) **Następny:** leftover label-form (tender round/matrix/side / rate-card / …) albo wąski HITL z pinu.
<!-- os-status:end -->
