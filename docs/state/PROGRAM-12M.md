...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **496.0** BR6.0 leftover — HITL `crm_link_mark` **Następny:** **497.0** BR6.1 leftover — HITL `sales_bind_mark` (`bind_kind` opportunity|party|other; nie HubSpot, nie FK UUID)
<!-- os-status:end -->
