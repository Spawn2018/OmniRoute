...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **37.0** M-44 `fx_difference` tablica `/fx-differences` (zarchiwizowany) **Następny:** M-45 Przepływy (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
