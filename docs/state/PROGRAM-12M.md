...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **477.0** BR1.3 — HITL `inventory_collateral_mark` **Następny:** **BR7.0** sala operacyjna — warstwa działająca — wskaż Q z [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) § Kolejka
<!-- os-status:end -->
