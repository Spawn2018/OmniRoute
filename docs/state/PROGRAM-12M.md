...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **36.0** M-43 `money_cost` tablica `/money-cost` (zarchiwizowany) **Następny:** 37.0 M-44 `fx_difference` tablica `/fx-differences`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
