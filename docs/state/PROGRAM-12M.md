...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **622.0** U3 cyfra kontrolna IATA na MAWB (CI po push) **Następny:** **623.0** D7d `pallet_kind` `epal` na saldzie palet (HITL, nie giełda). Daty bazowe zlecenia / matching T5 / FK kontekstu / T8 live / D6b konsolidacja = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
