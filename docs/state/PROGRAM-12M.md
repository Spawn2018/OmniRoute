...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **34.0** M-41 `quote_invoice_settlement` tablica `/quote-invoices` (zarchiwizowany) **Następny:** 35.0 M-42 `bank_payment` tablica `/payments`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
