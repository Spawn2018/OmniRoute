...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **608.0** T3 EXP1 `vessel_imo` (lokalne; CI po push) **Następny:** **609.0** T3 EXP1 `alliance_service` HITL na `container` (nie live alliance). Leftover HW/UXCL/N3 parked. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
