...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **610.0** T3 `pol_unlocode` (lokalne; CI po push) **Następny:** plan **611.0** T3 `pod_unlocode` (nie HW, nie UXCL, nie N3). `destination_city` parked. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
