...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **439.0** AI1.4 leftover FK `suggestion_ledger` → `suggestion_kind` **Następny:** **440.0** AI1.4 leftover FK `twin_mark.twin_kind` → `twin_kind` (`ON DELETE RESTRICT`).
<!-- os-status:end -->
