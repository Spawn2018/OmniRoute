...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **30.0** M-37 `operational_exception` tablica `/exceptions` (zarchiwizowany) **Następny:** `/plaster` 31.0 M-38 `shipment_document` tablica `/shipment-documents`. Nie nowa tabela. Nie zgaduj schematu HBL.
<!-- os-status:end -->
