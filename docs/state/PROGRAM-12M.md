...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **292.0** `/refaktor` CatalogSourceRefField (Q-E1 leftover) **Następny:** leftover Fala CT / pin — U1 masowy / wspólny SELECT / CT2 albo następny wąski HITL.
<!-- os-status:end -->
