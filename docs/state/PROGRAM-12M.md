...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **120.0** S27b karta z decyzji oferty (M-13) **Następny:** `/plaster` **121.0** — leftover S11 `changed` na `operator_decision`. Nie accept extractu. Nie F9.1.
<!-- os-status:end -->
