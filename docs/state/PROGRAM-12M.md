...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **280.0** leftover HITL `otif_mark` **Następny:** leftover Fala CT / pin — CT6 HITL konektor SAP/Oracle (jak F9) albo CT12 CAPA katalog albo egzekucja 409 z `routing_guide`.
<!-- os-status:end -->
