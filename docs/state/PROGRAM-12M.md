...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **37.0** M-44 `fx_difference` tablica `/fx-differences` (zarchiwizowany) **Następny:** 38.0 M-45 `cash_flow` tablica `/cashflows`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
