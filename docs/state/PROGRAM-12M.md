...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **52.0** U-money-align oś dziesiętna na `<Money/>` (zarchiwizowany) **Następny:** 53.0 U-condensed trzeci tryb gęstości na `/rate-lines`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
