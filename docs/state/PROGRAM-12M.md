...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **612.0** T3 `destination_city` (lokalne; CI po push) **Następny:** plan kolejnego Q z karty T3 poza HW, UXCL, N3, AI3, G0-SH. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
