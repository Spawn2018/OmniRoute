...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **306.0** `/refaktor` CatalogSourceRefField (otif/enforcement/task-template) **Następny:** leftover label-form (tender-* / rate-card / …) albo wąski HITL z pinu.
<!-- os-status:end -->
