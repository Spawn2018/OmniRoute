...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **586.0** T3 409 gdy temp bez `reefer` (CI po push) **Następny:** **587.0** leftover SH-R16-4 UXCL-L1 banner zgody (eventy + privacy). Nie scoring. Nie AI3-payload. Nie G0-SH. Nie N3.
<!-- os-status:end -->
