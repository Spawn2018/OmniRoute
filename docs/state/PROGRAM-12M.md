...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **598.0** T2 `resource.driver_card_no` (gate success) **Następny:** **599.0** T2 leftover HITL `resource.vehicle_profile` (delta w open). HW = park `/noc`. **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3.
<!-- os-status:end -->
