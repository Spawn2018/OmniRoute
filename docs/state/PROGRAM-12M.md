...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **38.0** M-45 `cash_flow` tablica `/cashflows` (zarchiwizowany) **Następny:** 39.0 M-46 `cost_to_serve` tablica `/cost-to-serve`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
