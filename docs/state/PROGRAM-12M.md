...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **486.0** AI8.2 leftover — HITL `quality_descent_mark` **Następny:** **487.0** AI9.1 leftover — ui-04 pewność per pole (katalog HITL; nie przebudowa splitu)
<!-- os-status:end -->
