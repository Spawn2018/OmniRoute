...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **476.0** BR1.2 — HITL `inventory_finance_mark` **Następny:** **BR1.3** zabezpieczenie na towarze — wskaż Q z [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) § Kolejka
<!-- os-status:end -->
