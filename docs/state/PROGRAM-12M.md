...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **613.0** T4 `charge.shipment_id` (testy lokalne; CI po push) **Następny:** plan widoku SQL marży drzewa zleceń (klucz `charge.shipment_id` już jest). Nie generated column. Nie FK portu. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
