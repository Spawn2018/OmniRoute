...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **504.0** AI3.0 leftover — partial accept `candidate_indexes` **Następny:** **505.0** AI3.0 leftover — próg pewności HITL w `organization_setting` (nie live vision; nie Instructor)
<!-- os-status:end -->
