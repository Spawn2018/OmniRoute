...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **22.0** M-29 `offer_acceptance` przy `quotation` (zarchiwizowany) **Następny:** 23.0 M-30 `carrier_inquiry` (`/plaster`). Ślad `channel_quote` przy lane. Nie tabela RFQ. Nie live HTTP.
<!-- os-status:end -->
