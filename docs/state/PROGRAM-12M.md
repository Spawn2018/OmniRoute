...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **470.0** BR4.4 — HITL `silk_corridor_mark` **Następny:** akceptacja delty **471.0** → `/plaster` HITL `factoring_connector`. Nie live SMEO HTTP. Nie zgaduj plaster ID.
<!-- os-status:end -->
