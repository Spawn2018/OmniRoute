...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **35.0** M-42 `bank_payment` tablica `/payments` (zarchiwizowany) **Następny:** 36.0 M-43 `money_cost` tablica `/money-cost`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
