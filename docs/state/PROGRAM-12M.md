...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **13.0** M-19 `channel_quote` (zarchiwizowany) **Następny:** `/plan-modul` M-14 ocena kredytowa (zakaz auto-scoringu `natural_person` / JDG). Nie Fala 8. Nie zgaduj zakresu.
<!-- os-status:end -->
