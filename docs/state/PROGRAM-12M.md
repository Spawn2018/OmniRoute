...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **494.0** BR6.2 leftover — HITL `shipper_like_mark` **Następny:** **495.0** BR6.0 leftover — HITL `crm_dedup_mark` (`dedup_kind` nip|vat|email|other; nie cold-send)
<!-- os-status:end -->
