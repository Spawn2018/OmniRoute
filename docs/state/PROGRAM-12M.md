...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **617.0** T7c `fx_rate_day` (gate success) **Następny:** **618.0** T7d SQL `charge_sell_in_pln`. Daty bazowe zlecenia = park. Matching T5 / FK kontekstu = park. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
