...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **53.0** U-condensed trzeci tryb gęstości na `/rate-lines` (zarchiwizowany) **Następny:** U-primitives-json (`/plan-modul`). PLAN § Wave FE leftover. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
