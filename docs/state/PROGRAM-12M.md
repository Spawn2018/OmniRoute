...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **575.0** T3 `container.volume_m3` (gate success) **Następny:** **576.0** leftover T3 HITL `container.pickup_date`. Nie `return_date`. Nie cutoff timestamptz. Nie `temp_min`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
