...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **626.0** D9c `network_print_requirement` (gate po push) **Następny:** **627.0** D9f branding HITL (nie PDF). D9c 409 / D9d PDF-QR / D9e skan / daty bazowe / matching T5 / FK kontekstu / T8 live / D6b / D7b = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
