...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **56.0** U-playwright-axe trzy ścieżki E2E + axe (zarchiwizowany) **Następny:** U-print (`/plan-modul`). PLAN § Wave FE leftover. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
