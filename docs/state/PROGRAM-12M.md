...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **492.0** BR6.1 leftover — `volume_label` tekst na `sales_lane` **Następny:** **493.0** BR6.2 leftover — HITL rundy przetargu załadowcy (`shipper_round_mark`; nie Alpega live)
<!-- os-status:end -->
