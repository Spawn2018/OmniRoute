...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **310.0** `/refaktor` CatalogSourceRefField (round/matrix/side) **Następny:** leftover label-form (rate-card / fuel / groupage / local-charge…) albo wąski HITL z pinu.
<!-- os-status:end -->
