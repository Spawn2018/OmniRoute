...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **272.0** leftover HITL `customer_contract` nagłówek **Następny:** leftover CI9 ciphertext/KEK (park KMS/unwrap) albo CT7 parked live / reszta pinu 2026-09-08c. Leftover HITL/SQL = praca. Park = live HTTP bez testu albo sekretu, nie skip pola. Live M-02 konsument / Auth0 I1/I2 / portale / giełda live tylko gdy ten ID jest bieżącym Q. P6c auto-award zakaz. Nic z pinu nie wypada. Nie zgaduj 71–273.
<!-- os-status:end -->
