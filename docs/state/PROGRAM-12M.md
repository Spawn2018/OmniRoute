...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **287.0** leftover CT4 409 na shipment poza guide **Następny:** leftover Fala CT / pin — matching lane/mode przewodnika albo następny wąski HITL z PLAN.
<!-- os-status:end -->
