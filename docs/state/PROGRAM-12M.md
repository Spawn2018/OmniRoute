...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **42.0** M-49 `intermodal_rail` tablica `/rail` (zarchiwizowany) **Następny:** 43.0 M-50 `china_rail` tablica `/china-rail`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
