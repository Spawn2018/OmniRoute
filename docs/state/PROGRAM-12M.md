...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **27.0** M-34 `operator_notice` tablica `/notifications` (zarchiwizowany) **Następny:** 28.0 M-35 `shipment` (`/plaster`). Tablica wycen z `party_id`. Nie tabela. Nie tracking.
<!-- os-status:end -->
