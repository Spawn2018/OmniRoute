...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **431.0** EXP1 HITL `quote_validity_mark` **Następny:** **432.0** AI1.0 HITL `suggestion_ledger` — target_bc + entity_id + przedział Decimal + reaction + changed_to.
<!-- os-status:end -->
