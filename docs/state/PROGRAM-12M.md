...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **577.0** T3 `container.return_date` (CI po push) **Następny:** leftover T3 HITL `container.gate_in_date` (daty SPEED). Nie cutoff timestamptz. Nie `temp_min`. Nie N3 countdown. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
