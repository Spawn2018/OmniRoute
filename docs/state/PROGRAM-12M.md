...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **296.0** `/refaktor` CatalogSourceRefHintField (paper-form #3 tender) **Następny:** leftover paper-form / label-form `source_ref` (Q-E1) albo wąski HITL z pinu.
<!-- os-status:end -->
