...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **583.0** T3 `container.needs_external_power` (CI po push) **Następny:** **584.0** leftover T3 HITL `container.container_release_party_id`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
