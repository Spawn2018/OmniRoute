...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **30.0** M-37 `operational_exception` tablica `/exceptions` (zarchiwizowany) **Następny:** M-38 Dokumenty zlecenia (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
