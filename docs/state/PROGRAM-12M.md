...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **487.0** AI9.1 leftover — HITL `field_confidence_mark` **Następny:** **488.0** AI9.2 leftover — HITL `compliance_program_mark` (program zgodności; nie PDF; nie U-art50)
<!-- os-status:end -->
