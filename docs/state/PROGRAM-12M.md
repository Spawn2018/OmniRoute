...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **21.0** M-28 `customer_inquiry` przy `quotation` (zarchiwizowany) **Następny:** 22.0 M-29 `offer_acceptance` (`/plaster`). Pending z wycen. Nie tabela. Nie HITL accept.
<!-- os-status:end -->
