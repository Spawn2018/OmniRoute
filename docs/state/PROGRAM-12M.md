...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **443.0** AI2.0 `interval_score` — MAE/CRPS liczone w Postgresie **Następny:** **444.0** AI2.1 widok: `pair_count` + średnie MAE/CRPS per `model_version`. Nie auto-champion. Nie dryf.
<!-- os-status:end -->
