...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **300.0** `/refaktor` CatalogSourceRefField (prediction/weather/exchange) **Następny:** leftover label-form connector/header albo wąski HITL z pinu.
<!-- os-status:end -->
