...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **574.0** T3 `container.weight_kg` (CI po push) **Następny:** **575.0** leftover T3 HITL `container.volume_m3`. Nie kalkulator CBM. Nie `weight_kg`. Nie quantity. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
