...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **307.0** `/refaktor` CatalogSourceRefField (rfp-intake/playbook/consortium) **Następny:** leftover label-form (tender-* reszta / rate-card / …) albo wąski HITL z pinu.
<!-- os-status:end -->
