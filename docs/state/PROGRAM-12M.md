...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **301.0** `/refaktor` CatalogSourceRefField (erp/idp/contract) **Następny:** leftover label-form connector (terminal-slot / kek / PO / visibility) albo wąski HITL.
<!-- os-status:end -->
