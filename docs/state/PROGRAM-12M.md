...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **631.0** leftover 528 `clone_carry_mark` HITL (gate po push) **Następny:** **632.0** leftover D9c 409 stance HITL. D9d PDF-QR / D9e skan / D9f pdf-zpl / matching T5 / FK kontekstu / T8 live / D6b / D7b / fx×FV / auto-copy U1 / similar SQL / F2b / auto-UPDATE salda = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
