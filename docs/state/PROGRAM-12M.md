...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **581.0** T3 `container.temp_min` (CI po push) **Następny:** **582.0** leftover T3 HITL `container.temp_max`. Nie `needs_external_power`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
