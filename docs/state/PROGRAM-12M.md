...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **578.0** T3 `container.gate_in_date` (CI po push) **Następny:** leftover T3 HITL `container.delivery_date` (daty SPEED). Nie cutoff timestamptz. Nie `temp_min`. Nie N3 countdown. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
