...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **614.0** T4 `shipment_tree_margin` (gate success) **Następny:** plan kolejnego Q z PLAN poza HW, UXCL, N3, AI3, G0-SH. Wnuki rollup zostają. **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
