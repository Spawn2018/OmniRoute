...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **52.0** U-money-align oś dziesiętna na `<Money/>` (zarchiwizowany) **Następny:** U-condensed (`/plan-modul`). PLAN § Wave FE leftover. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
