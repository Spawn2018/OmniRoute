...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **50.0** M-70 `tenant_rollout` tablica `/rollout` (zarchiwizowany) **Następny:** 51.0 U-oklch-dark tokeny `oklch` + `.dark`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
