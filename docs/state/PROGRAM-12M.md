...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **461.0** BR6.2 — HITL `shipper_tender_mark` (tryb załadowcy) **Następny:** **462.0** HITL znacznik kampanii. Nie atrybucja live. Nie `funnel_mark`. Nie Expo.
<!-- os-status:end -->
