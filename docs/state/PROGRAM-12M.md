...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **419.0** EXP0.3 HITL `slot_guarantee_mark` **Następny:** **420.0** EXP1 HITL `freight_term_mark` (prepaid|collect|third_party|other) — kolejka po cutoff.
<!-- os-status:end -->
