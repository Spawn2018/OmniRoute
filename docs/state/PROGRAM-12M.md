...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **27.0** M-34 `operator_notice` tablica `/notifications` (zarchiwizowany) **Następny:** M-35 Zlecenie (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
