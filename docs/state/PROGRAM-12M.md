...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **29.0** M-36 `tracking` tablica `/tracking` (zarchiwizowany) **Następny:** `/plaster` 30.0 M-37 `operational_exception` tablica `/exceptions`. Nie nowa tabela. Nie zgaduj schematu zdarzeń.
<!-- os-status:end -->
