...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **560.0** C8 `blocks_create_enforcement_mark` **Następny:** **561.0** C1 leftover HITL `filing_fk_mark`. Nie live FK shipment/scheme. Nie PUESC. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
