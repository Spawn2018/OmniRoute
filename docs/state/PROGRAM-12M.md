...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **289.0** leftover CT4 matching lane/mode na ASN **Następny:** **290.0** leftover CT4 matching lane/mode na shipment (`plant_label`/`carrier_label` + ten sam gate co ASN).
<!-- os-status:end -->
