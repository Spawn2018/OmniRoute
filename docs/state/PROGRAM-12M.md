...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **33.0** M-40 `sales_invoice` tablica `/invoices` (zarchiwizowany) **Następny:** 34.0 M-41 `quote_invoice_settlement` tablica `/quote-invoices`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
