...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **312.0** `/refaktor` CatalogSourceRefField (local/charge-template/cod) **Następny:** **313.0** CI1 HITL `sla_clause` (delta `docs/deltas/open/313.0-sla-clause.md`).
<!-- os-status:end -->
