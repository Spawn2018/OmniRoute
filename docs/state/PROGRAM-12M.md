...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **572.0** T3 `container.teu` (lokalnie; CI po push) **Następny:** **573.0** leftover T3 HITL quantity na kontenerze. Nie `stop.quantity`. Nie TEU. Nie kalkulator. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
