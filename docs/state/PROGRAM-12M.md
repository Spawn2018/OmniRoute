...
<!-- os-status:start -->
**Stan (z CURRENT.md):** **39.0** M-46 `cost_to_serve` tablica `/cost-to-serve` (zarchiwizowany) **Następny:** M-47 Księgowość (integracja) (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
