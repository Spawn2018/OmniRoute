...
| 2026-09-01 | Plan 7.0 | M-52 | delta `docs/deltas/open/7.0-dangerous-good.md` + spec. Katalog UN/IMDG per tenant. Nie podpięcie do wyceny. Nie M-08 `charge`. Następny: `/plaster` 7.0. |
