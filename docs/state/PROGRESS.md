...
| 2026-09-02 | Plan 10.0 | M-13 | delta `docs/deltas/open/10.0-party-scorecard.md` + spec. Snapshot `party_scorecard` per party. Nie SQL-refresh, nie scoring osoby, nie RFQ. Następny: `/plaster` 10.0. |
