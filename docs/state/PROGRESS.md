...
| 2026-09-02 | Plan 23.0 | M-30 | delta `docs/deltas/open/23.0-carrier-inquiry.md` + spec. Ślad `channel_quote` przy lane. Nie tabela RFQ, nie live HTTP. Następny: `/plaster` 23.0. |
