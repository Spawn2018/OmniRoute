...
| 2026-09-01 | Plan 5.0 | M-10 | delta `docs/deltas/open/5.0-party.md` + spec `parties.md`. Cały katalog M-10 w jednym plastrze. Następny: `/plaster` 5.0 w nowej rozmowie. Nie Q3. |
