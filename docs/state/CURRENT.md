...
**Faza:** Oś pinu — po **591.0**; SH-R16-4 UXCL park; **592.0** T2 resource_document

**Repo:** https://github.com/Spawn2018/OmniRoute

**Ostatni plaster:** **591.0** T2 `resource.capacity_m3` (gate success)

**Etap:** Plan — delta **592.0** zaakceptowana (`/noc`); wolno `/plaster`
...
**Spec (jedyna na sesję produktu):** [deltas/open/592.0-resource-document.md](../deltas/open/592.0-resource-document.md)
