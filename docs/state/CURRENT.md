...
**Spec (jedna na sesję):** [docs/deltas/open/95.0-edi-message.md](../deltas/open/95.0-edi-message.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 95.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
