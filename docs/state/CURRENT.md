...
**Ostatni plaster:** **604.0** T1 EXP1 `no_show_at` (gate success)

**Etap:** Plaster — delta **605.0** zaakceptowana (`/noc`); wolno `/plaster`
...
**Spec (jedyna na sesję produktu):** brak — delta `docs/deltas/open/605.0-stop-weigh-in.md`
