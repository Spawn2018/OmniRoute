...
**Spec (jedna na sesję):** następna delta po `/plan-modul` S20. Zamknięte: [82.0-network-member.md](../deltas/archived/82.0-network-member.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** 82.0 zamknięty (`/noc`). Następny S20 `/plan-modul`. Nie F9.1.
