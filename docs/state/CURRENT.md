...
**Ostatni plaster:** **131.0** M10-1 identyfikatory biznesowe `party` (M-10)  
**Etap:** Kod  
...
**Spec (jedna na sesję):** [docs/spec/parties.md](../spec/parties.md) + [karty-pol-fala-o.md](../analysis/karty-pol-fala-o.md) § M10-2. Delta: [132.0-party-roles-jdg.md](../deltas/open/132.0-party-roles-jdg.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj [operator-notice.md](../spec/operator-notice.md).
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. P0 **129.0**, O0 **130.0**, M10-1 **131.0** zamknięte. Delta **132.0** M10-2 zaakceptowana `/noc` — wolno kod.
