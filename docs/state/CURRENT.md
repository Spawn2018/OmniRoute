...
**Spec (jedna na sesję):** [docs/deltas/open/118.0-sop-drafts.md](../deltas/open/118.0-sop-drafts.md). Nie otwieraj [finance-board.md](../spec/finance-board.md).
...
**2026-09-04:** plan 118.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
