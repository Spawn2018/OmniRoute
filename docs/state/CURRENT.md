...
**Spec (jedna na sesję):** [docs/deltas/open/79.0-outbox.md](../deltas/open/79.0-outbox.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 79.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
