...
**Spec (jedna na sesję):** brak otwartej delty — `/plan-modul` S26. Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plaster 87.0 zamknięty (`/noc`). Wskazanie recenzji na wycenie. Nie scoring. Nie F9.1.
