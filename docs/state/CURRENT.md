...
**Ostatni plaster:** **186.0** G2.23 `kreptd_licence`  
**Etap:** Kod  
...
**Spec (jedna na sesję):** [docs/deltas/open/187.0-monitoring-scheme.md](../deltas/open/187.0-monitoring-scheme.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8. Nie auto-award. Nie scrape. Nie Citizen API. Nie circle_sim. Nie kalkulator kg. Nie live PUESC/KSeF. ExtractionService nie importuje tenders/rates.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Delta **187.0** zaakceptowana (`/noc`). Wolno `/plaster`. Nie auto-award. Nie T-SQL. Nie scrape. Nie live HTTP. Nie kalkulator kg. Nie circle_sim. Nie „SENT-Europa”.
