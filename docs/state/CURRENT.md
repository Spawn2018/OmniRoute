...
**Ostatni plaster:** **291.0** leftover CT1 HITL promote ASN → shipment  
**Etap:** Plan  
...
Park: U1 masowy · qty float · wspólny SELECT · SQL FV vs charge · workflow CAPA · live SOAP · CT2 · CT5/CT8 live · live p44. Nie CI1 extract. Nie zgaduj 71–291.
...
**2026-09-08c:** **291.0** zamknięty (`/noc`) — promote ASN→shipment. Następne Q = plan leftover CT / pin.
