...
**Spec (jedna na sesję):** brak — `/plan-modul` pisze. Nie otwieraj `quotation-nbp.md` jako kolejki 17.0.
...
**2026-09-02:** 16.0 na origin. Następny: `/plan-modul` 17.0 M-24 (nie zgaduj schematu).
