...
**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. Impersonate ≠ decrypt. `charge.source_ref` **jest** (129.0 / 072) — nie otwieraj plastra AI0. **AI1.0–AI1.4** i **443.0** w kodzie. `data_source` = AI5. Wpisane CRPS na `prediction_ledger` zostaje do leftoveru fali AI2.
