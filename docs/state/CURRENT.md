...
**Ostatni plaster:** **341.0** EXP2.4 HITL `cargo_cover_mark`

**Etap:** Plan — wolno `/plan-modul` **342.0** EXP2.5
...
**2026-09-11:** Plaster **341.0** zamknięty (`/noc`) — HITL `cargo_cover_mark` bez live insurance.
