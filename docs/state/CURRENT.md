...
Park: Graph live · Expo/EAS · GPS live poll · unwrap umów. Nie zgaduj 71–412.

**Spec (jedyna na sesję):** [docs/deltas/open/412.0-demo-sim-mark.md](../deltas/open/412.0-demo-sim-mark.md).
...
**2026-09-12:** Plan **412.0** — HITL `demo_sim_mark` (bez live sim).
