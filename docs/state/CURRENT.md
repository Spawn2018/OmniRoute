...
**Spec (jedna na sesję):** [docs/deltas/open/167.0-trip-expected-buy.md](../deltas/open/167.0-trip-expected-buy.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Delta **167.0** zaakceptowana (`/noc`). Wolno `/plaster`. Nie druga marża. Nie T-SQL.
