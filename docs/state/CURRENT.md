...
**Spec (jedna na sesję):** [docs/spec/offer-document.md](../spec/offer-document.md) — nie otwieraj `offer-negotiation.md` jako kolejki 19.0.
...
**2026-09-02:** Plan 19.0 na kolejce. Następny: `/plaster` 19.0 (nie nowa rozmowa w `/noc`).
