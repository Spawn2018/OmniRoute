...
**Spec (jedna na sesję):** [docs/deltas/open/169.0-tender.md](../deltas/open/169.0-tender.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Delta **169.0** zaakceptowana (`/noc`). Wolno `/plaster`. Nie auto-award. Nie T-SQL.
