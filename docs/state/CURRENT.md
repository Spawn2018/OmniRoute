...
**Następny:** M-44 Różnice kursowe (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.  
M-02 **parked**. Auth0 **odroczone**. Exit Wave FE **nie** claim. Leftovery UI ADR-0003 **nie** zamiast Fali 6.

**Spec (jedna na sesję):** brak do `/plan-modul` — nie otwieraj [money-cost.md](../spec/money-cost.md) jako kolejki M-44.
...
**2026-09-02:** 36.0 na kolejce zamknięcia. Następny: `/plan-modul` M-44 (nie nowa rozmowa w `/noc`).
