...
**Spec (jedna na sesję):** po 153.0 — `/plan-modul` U3. Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Następny = U3 `shipment_leg` air. Nie live IATA.
