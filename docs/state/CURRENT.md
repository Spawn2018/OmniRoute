...
**Spec (jedna na sesję):** brak — `/plan-modul` pisze. Nie otwieraj `carrier-inquiry.md` jako kolejki 24.0.
...
**2026-09-02:** 23.0 na origin. Następny: `/plan-modul` 24.0 M-31 (nie zgaduj schematu).
