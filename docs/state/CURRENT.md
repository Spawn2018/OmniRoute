...
**Spec (jedna na sesję):** [docs/deltas/open/186.0-kreptd-licence.md](../deltas/open/186.0-kreptd-licence.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8. Nie auto-award. Nie scrape KREPTD. Nie Citizen API. Nie circle_sim. ExtractionService nie importuje tenders/rates.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Delta **186.0** zaakceptowana (`/noc`). Wolno `/plaster`. Nie auto-award. Nie T-SQL. Nie scrape. Nie Citizen API. Nie kalkulator kg.
