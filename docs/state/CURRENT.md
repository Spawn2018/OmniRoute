...
**Spec (jedyna na sesję):** brak — najpierw delta **491.0** (`/plan-modul`).

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–490.0** w kodzie.

**Środowisko lokalne:** `just`, `lint-imports`, `psql`, `pg_ctl` w PATH. PG 16: `tools\pg16`.

**2026-09-15:** Plaster **490.0** zamknięty (`/noc 8`) — HITL `crm_pipeline_mark`.
**2026-09-15:** Plan **490.0** (`/noc 8`) — BR6.0 leftover katalog `crm_pipeline_mark`.
