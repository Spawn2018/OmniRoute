...
**Ostatni plaster:** **489.0** BR6.0 leftover — HITL `crm_activity`
...
**Spec (jedyna na sesję):** brak — najpierw delta **490.0** (`/plan-modul`).

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–489.0** w kodzie.

**Środowisko lokalne:** `just`, `lint-imports`, `psql`, `pg_ctl` w PATH. PG 16: `tools\pg16`.

**2026-09-15:** Plaster **489.0** zamknięty (`/noc 8`) — HITL `crm_activity`.
