...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **277.0** zamknięty — HITL `po_line`. Delta **278.0** zaakceptowana (`/noc`) — HITL `asn`, nie live EDI, nie auto shipment. Następne Q po kodzie = leftover auto shipment / reszta pinu. CT8 AIS = park live. Nie CI1. `/noc` nie pomija osi. LLM nie liczy.
