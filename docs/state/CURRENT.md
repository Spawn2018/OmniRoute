...
**Spec (jedna na sesję):** [tenant-rollout.md](../spec/tenant-rollout.md) — delta [50.0-tenant-rollout.md](../deltas/open/50.0-tenant-rollout.md).
...
**2026-09-02:** delta 50.0 zaakceptowana `/noc`. Wolno `/plaster`.
