...
**Spec (jedna na sesję):** [docs/analysis/karty-pol-g2-tender.md](../analysis/karty-pol-g2-tender.md) § G2.2 `tender_lane`. Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **170.0** zamknięty. Następny Plan G2.2. Nie auto-award. Nie T-SQL.
