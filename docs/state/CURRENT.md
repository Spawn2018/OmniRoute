...
**Spec (jedna na sesję):** [road-transport.md](../spec/road-transport.md) — delta [41.0-road-transport.md](../deltas/open/41.0-road-transport.md).
...
**2026-09-02:** delta 41.0 zaakceptowana `/noc`. Wolno `/plaster`.
