...
**Następny:** `/plan-modul` **S36** — rozliczenie wyceny z fakturą (M-41). Nie F9.1.  
M-02 **fundament 79.0**. Auth0 **odroczone** (S53). Portale **parked** (S55). S21 live HTTP **parked**. Exit Wave FE **nie** claim.

**Spec (jedna na sesję):** [docs/spec/quote-invoice-settlement.md](../spec/quote-invoice-settlement.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plaster 97.0 zamknięty (`/noc`). Następny: plan S36. Nie F9.1.
