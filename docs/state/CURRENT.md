...
**Spec (jedna na sesję):** [docs/spec/cash-flow.md](../spec/cash-flow.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plaster 101.0 zamknięty (`/noc`). Następny: `/plan-modul` S40. Nie F9.1.
