...
**Faza:** Oś pinu — Plaster **644.0** (leftover EXP0.9 limited quantity HITL)

**Repo:** https://github.com/Spawn2018/OmniRoute

**Ostatni plaster:** **643.0** leftover EXP0.9 `marine_pollutant` HITL (gate success + 643.0b)

**Etap:** Plaster **644.0** — delta zaakceptowana `/noc 7`. Wolno `/plaster`.
...
**Spec (jedyna na sesję produktu):** [docs/deltas/open/644.0-dangerous-good-limited-quantity.md](../deltas/open/644.0-dangerous-good-limited-quantity.md)
