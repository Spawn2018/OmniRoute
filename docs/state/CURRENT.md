...
**Spec (jedna na sesję):** [docs/deltas/open/101.0-fx-difference.md](../deltas/open/101.0-fx-difference.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 101.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
