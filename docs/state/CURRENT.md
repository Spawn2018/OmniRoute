...
**Spec (jedna na sesję):** [docs/deltas/open/92.0-shipment-document.md](../deltas/open/92.0-shipment-document.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 92.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
