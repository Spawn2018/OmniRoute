...
**Faza:** Oś pinu — po **597.0**; SH-R16-4 UXCL park; **598.0** T2 driver card

**Repo:** https://github.com/Spawn2018/OmniRoute

**Ostatni plaster:** **597.0** T2 `resource.phone` (gate success)

**Etap:** Plan — delta **598.0** zaakceptowana `/noc`; wolno `/plaster`
...
**Spec (jedyna na sesję produktu):** [598.0-resource-driver-card-no.md](../deltas/open/598.0-resource-driver-card-no.md)
