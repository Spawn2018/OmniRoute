...
**Spec (jedna na sesję):** następna delta po `/plan-modul` S21. Zamknięte: [83.0-carrier-inquiry.md](../deltas/archived/83.0-carrier-inquiry.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** 83.0 zamknięty (`/noc`). Następny S21 `/plan-modul`. Nie F9.1.
