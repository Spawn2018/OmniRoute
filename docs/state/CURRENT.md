...
**Następny:** M-41 Rozliczenie wyceny z fakturą (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.  
M-02 **parked**. Auth0 **odroczone**. Exit Wave FE **nie** claim. Leftovery UI ADR-0003 **nie** zamiast Fali 6.

**Spec (jedna na sesję):** brak do `/plan-modul` — nie otwieraj [sales-invoice.md](../spec/sales-invoice.md) jako kolejki M-41.
...
**2026-09-02:** 33.0 na kolejce zamknięcia. Następny: `/plan-modul` M-41 (nie nowa rozmowa w `/noc`).
