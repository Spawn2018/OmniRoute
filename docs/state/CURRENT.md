...
**Spec (jedna na sesję):** [docs/deltas/open/91.0-tracking-event.md](../deltas/open/91.0-tracking-event.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 91.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
