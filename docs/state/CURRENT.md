...
**Spec (jedyna na sesję):** [docs/deltas/open/486.0-quality-descent-mark.md](../deltas/open/486.0-quality-descent-mark.md)

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–485.0** w kodzie.
