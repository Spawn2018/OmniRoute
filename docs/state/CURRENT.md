...
**Spec (jedna na sesję):** brak delty produktu w `docs/deltas/open/` (poza OS-*). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8. Nie auto-award. Nie scrape KREPTD. Nie Citizen API. Nie circle_sim. Nie kalkulator kg. ExtractionService nie importuje tenders/rates.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **186.0** zamknięty. Billing GitHub zablokowany — nie czekaj na zielone CI. Nie auto-award. Nie T-SQL. Nie scrape. Nie Citizen API. Nie kalkulator kg. Nie circle_sim.
