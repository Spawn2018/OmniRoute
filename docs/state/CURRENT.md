...
**Ostatni plaster:** **566.0** V3 `container.demurrage_free_days` (lokalnie; CI po push)
...
**Spec (jedyna na sesję produktu):** brak — najpierw delta `567.0`
...
**2026-09-18:** Plaster **566.0** demurrage_free_days zamknięty (CI po push). `/noc 17`.
