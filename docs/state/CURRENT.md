...
**Spec (jedna na sesję):** Plan **184.0** G2.14 CO₂ (HITL, nie kalkulator). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8. Nie auto-award. Nie TED scrape. ExtractionService nie importuje tenders/rates.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **183.0** zamknięty. Wolno `/plan-modul` **184.0**. Nie auto-award. Nie T-SQL. Nie scrape.
