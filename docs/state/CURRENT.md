...
**Spec (jedna na sesję):** [oklch-dark.md](../spec/oklch-dark.md) — delta [51.0-oklch-dark.md](../deltas/open/51.0-oklch-dark.md).
...
**2026-09-02:** delta 51.0 zaakceptowana `/noc`. Wolno `/plaster`.
