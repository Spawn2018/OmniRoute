...
**Spec (jedna na sesję):** [karty-pol-g2-tender.md](../analysis/karty-pol-g2-tender.md) § Dalej `tender_data_room`. Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Plaster **172.0** zamknięty (`/noc`). Następny: `/plan-modul` **173.0**. Nie auto-award. Nie T-SQL.
