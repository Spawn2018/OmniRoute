...
**Spec (jedna na sesję):** leftover G2.15–G2.18 kg/CBAM — najpierw `/plan-modul`. Nie kalkulator kg. Nie CBAM katalog (kolizja M-52 `dangerous_good`). Nie otwieraj spec C8. Nie auto-award. Nie TED scrape. ExtractionService nie importuje tenders/rates.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **184.0** zamknięty. Billing GitHub zablokowany — nie czekaj na zielone CI. Następny: plan leftover G2.15–G2.18 (nie kalkulator). Nie auto-award. Nie T-SQL. Nie scrape.
