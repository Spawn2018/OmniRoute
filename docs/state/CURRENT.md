...
**Spec (jedna na sesję):** [ocean-lcl.md](../spec/ocean-lcl.md) — delta [44.0-ocean-lcl.md](../deltas/open/44.0-ocean-lcl.md).
...
**2026-09-02:** delta 44.0 zaakceptowana `/noc`. Wolno `/plaster`.
