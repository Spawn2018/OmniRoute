...
**Spec (jedna na sesję):** [docs/deltas/open/178.0-tender-rfp-intake.md](../deltas/open/178.0-tender-rfp-intake.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Delta **178.0** zaakceptowana (`/noc`). Wolno `/plaster`. Nie auto-award. Nie T-SQL. Nie TED scrape.
