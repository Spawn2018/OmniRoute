...
**Spec (jedna na sesję):** [docs/deltas/open/78.0-graph-ingest.md](../deltas/open/78.0-graph-ingest.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 78.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
