...
**Faza:** Oś pinu — po **605.0**; SH-R16-4 UXCL park; T2 HW park

**Repo:** https://github.com/Spawn2018/OmniRoute

**Ostatni plaster:** **605.0** T1 EXP1 `weigh_in_kg` (lokalne; CI po push)

**Etap:** Plan — **606.0** T1 EXP1 `weigh_out_kg` (po gate 605)
...
**Spec (jedyna na sesję produktu):** brak — najpierw delta `606.0`
...
**2026-09-20:** Plaster **605.0** T1 EXP1 `weigh_in_kg` zamknięty (lokalne; CI po push). `/noc 8`.
