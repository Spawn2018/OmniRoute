...
**Spec (jedna na sesję):** [docs/analysis/karty-pol-g2-tender.md](../analysis/karty-pol-g2-tender.md) § G2.3 `tender_round`. Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **171.0** zamknięty. Następny Plan G2.3. Nie auto-award. Nie T-SQL.
