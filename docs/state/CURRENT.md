...
**Następny:** M-45 Przepływy (`/plan-modul`). Nie zgaduj schematu. Nie nowa tabela.  
M-02 **parked**. Auth0 **odroczone**. Exit Wave FE **nie** claim. Leftovery UI ADR-0003 **nie** zamiast Fali 6.

**Spec (jedna na sesję):** brak do `/plan-modul` — nie otwieraj [fx-difference.md](../spec/fx-difference.md) jako kolejki M-45.
...
**2026-09-02:** 37.0 na kolejce zamknięcia. Następny: `/plan-modul` M-45 (nie nowa rozmowa w `/noc`).
