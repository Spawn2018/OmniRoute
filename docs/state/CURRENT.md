...
**Etap:** Plan — leftover BR6.1 FK stance. Komenda `/plan-modul`.
...
**Spec (jedyna na sesję):** brak — najpierw delta **497.0**.

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–496.0** w kodzie.
