...
**Spec (jedna na sesję):** leftover parked — nie otwieraj T4b SQL na `charge` / U3c pule / P4c / P1c–d / D9c–f / live HTTP / auto-award / circle_sim / 409 na shipment / T5 outbox. Oś: karty `karty-pol-fala-*.md`. Nie RAG na stawkach / umowach CI. Nie pgvector. Nie T8 live API. Nie drugi czat. Nie N8 koalescencja. Nie mapa. ExtractionService nie importuje tenders/rates. LLM nie sumuje.
