...
**Etap:** Plaster — delta **510.0** zaakceptowana (`/noc 15`); wolno `/plaster`

**Noc:** `/noc 15` do **2026-09-15T15:00+02**.

**Następny:** **510.0** AI3.3 leftover — golden ≥2000 vs MockExtractor (nie DocLayNet; nie live vision)
...
**Spec (jedyna na sesję):** [docs/deltas/open/510.0-extraction-golden-2000.md](../deltas/open/510.0-extraction-golden-2000.md)

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–509.0** w kodzie.
