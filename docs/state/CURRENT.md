...
**Spec (jedna na sesję):** [docs/deltas/open/89.0-party-sanctions-screen.md](../deltas/open/89.0-party-sanctions-screen.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 89.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
