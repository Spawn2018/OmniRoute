...
**Spec (jedna na sesję):** [docs/deltas/open/80.0-imap-ingest.md](../deltas/open/80.0-imap-ingest.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 80.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
