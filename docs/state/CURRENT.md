...
**Następny:** 22.0 M-29 `offer_acceptance` (`/plaster`). Pending z wycen. Nie tabela. Nie HITL accept.  
M-02 **parked**. Auth0 **odroczone**. Exit Wave FE **nie** claim. Leftovery UI ADR-0003 **nie** zamiast Fali 3.

**Spec (jedna na sesję):** [docs/spec/offer-acceptance.md](../spec/offer-acceptance.md) — nie otwieraj `customer-inquiry.md` jako kolejki 22.0.
...
**2026-09-02:** Plan 22.0 na kolejce. Następny: `/plaster` 22.0 (nie nowa rozmowa w `/noc`).
