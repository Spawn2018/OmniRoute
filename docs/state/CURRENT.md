...
**Następny:** `/plaster` **105.0** — S43 zbiorcza faktura (M-91). Nie F9.1.  
M-02 **fundament 79.0**. Auth0 **odroczone** (S53). Portale **parked** (S55). S21 live HTTP **parked**. Exit Wave FE **nie** claim.

**Spec (jedna na sesję):** [docs/deltas/open/105.0-collective-invoice.md](../deltas/open/105.0-collective-invoice.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 105.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
