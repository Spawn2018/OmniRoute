...
**Spec (jedna na sesję):** [print-sheet.md](../spec/print-sheet.md) — delta [57.0-print-sheet.md](../deltas/open/57.0-print-sheet.md).
...
**2026-09-02:** delta 57.0 zaakceptowana `/noc`. Wolno `/plaster`.
