...
**Spec (jedyna na sesję):** [docs/deltas/open/518.0-allocation-level.md](../deltas/open/518.0-allocation-level.md)

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–517.0** w kodzie.
