...
**Faza:** Oś pinu — **584.0** leftover T3 HITL `container.container_release_party_id`
...
**Następny:** **584.0** leftover T3 HITL `container.container_release_party_id`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
