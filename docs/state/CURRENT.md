...
**Faza:** Oś pinu — po **602.0** (gate success); plan **603.0**; SH-R16-4 UXCL park; T2 HW park

**Repo:** https://github.com/Spawn2018/OmniRoute

**Ostatni plaster:** **602.0** T1b sync `stop_group_code` ← `stop_group_id` (gate success)

**Etap:** Plan — delta **603.0** zaakceptowana `/noc`; wolno `/plaster`
...
**Park / czeka w PLAN:** HW · SH-R16-4 UXCL · `no_show_at` · AI3-payload · G0-SH · PUESC · MOS live · live FK UUID · N3 countdown · …

**Spec (jedyna na sesję produktu):** [docs/deltas/open/603.0-stop-appointment-status.md](../deltas/open/603.0-stop-appointment-status.md)
