...
**Spec (jedna na sesję):** [docs/deltas/open/81.0-mail-send.md](../deltas/open/81.0-mail-send.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 81.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
