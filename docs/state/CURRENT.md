...
**Spec (jedna na sesję):** [bookkeeping.md](../spec/bookkeeping.md) — delta [40.0-bookkeeping.md](../deltas/open/40.0-bookkeeping.md).
...
**2026-09-02:** delta 40.0 zaakceptowana `/noc`. Wolno `/plaster`.
