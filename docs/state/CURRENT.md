...
**Spec (jedna na sesję):** [docs/deltas/open/130.0-network-member-party.md](../deltas/open/130.0-network-member-party.md). Oś: karty `karty-pol-fala-*.md` + [karty-pol-g2-tender.md](../analysis/karty-pol-g2-tender.md) + [karty-pol-fala-exp.md](../analysis/karty-pol-fala-exp.md). Nie otwieraj [operator-notice.md](../spec/operator-notice.md).
