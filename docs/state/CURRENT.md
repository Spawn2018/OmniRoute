...
**Następny:** 53.0 U-condensed trzeci tryb gęstości na `/rate-lines`. Nie zgaduj schematu. Nie nowa tabela.  
M-02 **parked**. Auth0 **odroczone**. Portale **parked**. Exit Wave FE **nie** claim.

**Spec (jedna na sesję):** [table-condensed.md](../spec/table-condensed.md) — delta [53.0-table-condensed.md](../deltas/open/53.0-table-condensed.md).
...
**2026-09-02:** delta 53.0 zaakceptowana `/noc`. Wolno `/plaster`.
