...
**Spec (jedna na sesję):** [docs/spec/shipment-document.md](../spec/shipment-document.md)
...
**2026-09-02:** 30.0 zamknięty. Plan 31.0 M-38 na `/shipment-documents`. Następny: `/plaster` (nie nowa rozmowa w `/noc`).
