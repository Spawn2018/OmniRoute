...
**Spec (jedyna na sesję):** [docs/deltas/open/521.0-article50-mark.md](../deltas/open/521.0-article50-mark.md)

**Kanon:** [PLAN-REALIZACJA.md](../PLAN-REALIZACJA.md) — jedyny plan. Wizja: [VISION.md](../VISION.md).

**Uczciwość:** HITL zostaje. LLM nie liczy. `charge` = marża. **443.0–520.0** w kodzie.
