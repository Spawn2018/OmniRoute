...
Q1.1 = 4.1 `location`+strefy (najpierw Plan). Q1.2 = 4.2 `terminal`+WPI (Plan). Q2 = M-10 **po** 4.2. M-02 **parked**. Auth0 **odroczone**. Exit Wave FE **nie** claim. Leftovery UI ADR-0003 **nie** zamiast 4.0.

**Spec (jedna na sesję):** [docs/spec/geography.md](../spec/geography.md) · delta [docs/deltas/open/4.0-port.md](../deltas/open/4.0-port.md)
...
**2026-09-01:** Plan Q1 zaakceptowany. M-05 = 4.0 → 4.1 → 4.2, potem Q2.
