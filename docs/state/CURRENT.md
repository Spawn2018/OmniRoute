...
**Spec (jedna na sesję):** [65.0-inbound-resolve-email.md](../deltas/open/65.0-inbound-resolve-email.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-02:** Delta 65.0 zaakceptowana (`/noc`). Następny: `/plaster` 65.0 S2. Nie F9.1.
