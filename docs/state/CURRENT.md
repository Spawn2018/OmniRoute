...
Park: U1 masowy · qty float · wspólny SELECT · SQL FV vs charge · workflow CAPA · live SOAP · CT2 · CT5/CT8 live · live p44 · paper-form source_ref. Nie CI1 extract. Nie zgaduj 71–292.
...
**2026-09-08c:** **292.0** zamknięty (`/refaktor`) — `CatalogSourceRefField`. Następne Q = plan leftover CT / pin.
