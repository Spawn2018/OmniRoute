...
**Następny:** 21.0 M-28 Zapytania od klientów (`/plan-modul`). Nie zgaduj schematu.  
M-02 **parked**. Auth0 **odroczone**. Exit Wave FE **nie** claim. Leftovery UI ADR-0003 **nie** zamiast Fali 3.

**Spec (jedna na sesję):** brak — `/plan-modul` pisze. Nie otwieraj `quotation-batch.md` jako kolejki 21.0.
...
**2026-09-02:** 20.0 na origin. Następny: `/plan-modul` 21.0 M-28 (nie zgaduj schematu).
