...
**Spec (jedna na sesję):** [docs/deltas/open/188.0-party-document.md](../deltas/open/188.0-party-document.md). Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C1 filing. Nie auto-award. Nie scrape. Nie Citizen API. Nie circle_sim. Nie kalkulator kg. Nie live PUESC/KSeF. Nie 409 na shipment. ExtractionService nie importuje tenders/rates.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. Delta **188.0** zaakceptowana (`/noc`). Wolno `/plaster`. Nie auto-award. Nie T-SQL. Nie scrape. Nie live HTTP. Nie kalkulator kg. Nie circle_sim. Nie 409 na shipment.
