...
**Spec (jedna na sesję):** [docs/analysis/karty-pol-g2-tender.md](../analysis/karty-pol-g2-tender.md) § G2.1 `tender_lot`. Oś: karty `karty-pol-fala-*.md`. Nie otwieraj spec C8.
...
**2026-09-08c:** pin całości rozmowy Luki i ulepszenia. **169.0** zamknięty. Następny Plan G2.1. Nie auto-award. Nie T-SQL.
