...
**Spec (jedna na sesję):** następna delta po `/plan-modul` S18. Zamknięte: [80.0-imap-ingest.md](../deltas/archived/80.0-imap-ingest.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** 80.0 zamknięty (`/noc`). Następny S18 `/plan-modul`. Nie F9.1.
