...
**Faza:** Oś pinu — Plan **656.0** (leftover EXP1 quotation currency_account/pay)

**Repo:** https://github.com/Spawn2018/OmniRoute

**Ostatni plaster:** **655.0** leftover EXP1 quotation mqc_window

**Etap:** Plan **656.0** — po zamknięciu 655.0. Wolno `/plan-modul`.

**Noc:** `/noc 7` do 07:00 Europe/Warsaw (2026-09-25).

**Miejsce pracy:** produkt = to repo + GitHub.

**Następny:** **656.0** leftover EXP1 opcjonalny `currency_account` / `currency_pay` na `quotation` (po `mqc_window` 655.0) — HITL tekst waluty, nie float, nie NBP. supersedes_id / spot_or_contract na quotation / Deadline Engine / liable_party S11 / live GPS / D9d PDF-QR / D9e skan / D9f pdf-zpl live / matching T5 / FK kontekstu / T8 live / D6b / D7b / fx×FV / auto-copy U1 / similar SQL / F2b / auto-resync salda / live 409 / live poll / Expo BR2.3 / warning-jako-fakt / N8 / T6 live / P5c / N6 auto charge / live IMO / grupy 1.xA = park `/noc`. **588.0** SH-R16-4 UXCL = park `/noc`.
...
**Spec (jedyna na sesję produktu):** (brak — Etap Plan)
...
**2026-09-25:** Plaster **655.0** leftover EXP1 quotation mqc_window (`/noc 7`).
**2026-09-25:** Plan **655.0** leftover EXP1 quotation mqc_window (`/noc 7`). 654.0 na `main`.
**2026-09-25:** Plaster **654.0** leftover EXP1 quotation mqc_teu (`/noc 7`).
