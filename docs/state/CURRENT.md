...
**Spec (jedna na sesję):** [docs/deltas/open/76.0-mail-draft.md](../deltas/open/76.0-mail-draft.md). Nie otwieraj [print-sheet.md](../spec/print-sheet.md).
...
**2026-09-03:** plan 76.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
