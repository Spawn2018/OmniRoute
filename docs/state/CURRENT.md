...
**Spec (jedna na sesję):** [docs/deltas/open/110.0-shipment-leg-china-rail.md](../deltas/open/110.0-shipment-leg-china-rail.md). Nie otwieraj [intermodal-rail.md](../spec/intermodal-rail.md).
...
**2026-09-03:** plan 110.0 zaakceptowany (`/noc`). Wolno `/plaster`. Nie F9.1.
