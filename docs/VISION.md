...
| 2026-09-15 | **489.0** `crm_activity` w kodzie (`CONFIRMED`, git). Następny = leftover BR6.0 pipeline (`REQUIREMENT`). FK lead/opportunity / cold-send `REJECTED` na tym wierszu. |
