...
Ostatni ukończony plaster: **471.0** (HITL `factoring_connector`).
Następny = **472.0** plaster `po_financing_mark` po akceptacji delty (`REQUIREMENT`).
AI1.0–AI1.4 oraz 443.0–471.0 są w kodzie (`CONFIRMED`); `data_source`
...
- **Przetargi korporacyjne po stronie załadowcy** — katalog HITL
  `shipper_tender_mark` jest (`CONFIRMED`, 461.0); leftover rundy i
