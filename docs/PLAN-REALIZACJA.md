...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **77.0** — lock optymistyczny na `operator_decision` (M-71). Dwa okna, dwa Akceptuj. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S13 zamknięte; S14 plaster 77.0 | Plan → plaster | **następny** |
...
| S14 | Arch. **M-187** lock optymistyczny na decyzji | 77.0 | **następny** | `lock_version` na M-71. Nie nowa tabela |
