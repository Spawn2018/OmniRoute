...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **85.0** — wynik negocjacji (M-25). Wskazanie `channel_quote`, nie nowa kwota. Nie zamiast `margin()`. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S22 zamknięte (S21 parked); S23 plaster 85.0 | Plan → plaster | **następny** |
...
| S23 | Żywe **M-25** wynik negocjacji | 85.0 | **następny** | Wskazanie kanału. Nie zamiast `margin()` |
