...
<!-- os-status:start -->
**Następny (zablokowany):** 38.0 M-45 `cash_flow` tablica `/cashflows`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| F6.5 | **M-45 Przepływy** | Plan | kolejka (`/plan-modul`; nie zgaduj schematu) |
...
| M-40–M-47 | Finanse | Fala 6 (M-40–M-44 DONE fundament 33.0–37.0) |
