...
| W3 | memory graph na `entity_event` | delta [201.0](deltas/open/201.0-memory-edge.md) HITL `memory_edge` bez RAG; leftover graf / pgvector / FK zdarzeń | RAG na stawkach / umowach CI |
