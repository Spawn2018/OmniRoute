...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **97.0** — S35 numer sesji KSeF na fakturze (M-40). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S34 zamknięte (S21 parked); S35 plan 97.0 | Plan → plaster | **następny** |
...
| **S35** | KSeF (osobny plaster) | 97.0 | plan (`docs/deltas/open/97.0-ksef-ref.md`) | Numer sesji, nie live HTTP |
