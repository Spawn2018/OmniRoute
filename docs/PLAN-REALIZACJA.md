...
<!-- os-status:start -->
**Następny (zablokowany):** 37.0 M-44 `fx_difference` tablica `/fx-differences`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| F6.4 | **M-44 Różnice kursowe** | Plan | kolejka (`/plan-modul`; nie zgaduj schematu) |
...
| M-40–M-47 | Finanse | Fala 6 (M-40–M-43 DONE fundament 33.0–36.0) |
