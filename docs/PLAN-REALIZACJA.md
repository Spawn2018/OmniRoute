...
| AI8.1 | `STYLE FIDELITY SCORE`, bramka 85% | po AI8.0 | szkic niebrzmiący jak ten użytkownik nie jest proponowany; plan **485.0** HITL `style_fidelity_mark` (stancja pass/hold/reject/exempt); leftover: silnik score · auto-bramka |
