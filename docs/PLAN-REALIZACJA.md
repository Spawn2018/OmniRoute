...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S47** — odcinek kolejowy na `shipment_leg` (M-49). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S46 zamknięte (S21 parked); S47 plan | Plan → plaster | **następny** |
...
| S46–S49 | M-48…M-51 obiekt nogi | 108.0 | S46 zamknięty (`docs/deltas/archived/108.0-shipment-leg.md`); S47 plan | Nie druga mapa. S47–S49 leftover |
