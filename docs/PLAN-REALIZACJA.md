...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S22** — porównanie odpowiedzi (M-31). Spread w `charge`. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S20 zamknięte; S21 parked; S22 porównanie | Plan → plaster | **następny** |
...
| S22 | Żywe **M-31** porównanie | Plan → plaster | **następny** | Spread w `charge` |
