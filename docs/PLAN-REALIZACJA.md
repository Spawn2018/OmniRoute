...
| BR5.1 | finansowanie zamówienia (PO Financing) | po BR1.2 + BR5.0 | **472.0** plan HITL `po_financing_mark` (po|release|advance|other); leftover FK PO · wycena zapasu BR1.2 |
