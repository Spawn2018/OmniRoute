...
<!-- os-status:start -->
**Następny (zablokowany):** 20.0 M-27 Wycena wsadowa (`/plan-modul`). Nie zgaduj schematu.
<!-- os-status:end -->
...
| F3.4 | **M-27 Wycena wsadowa** | Plan → plaster | kolejka (`/plan-modul`; nie zgaduj schematu) |
