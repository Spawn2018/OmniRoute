...
| **B0a** | `entity_event` append-only | Plan → plaster | **delta 133.0 zaakceptowana** | Kind: `inquiry_queued` / `inquiry_sent` / `quote_recorded`. Ledger/what-if = B0b po T2 |
