...
| AI9.2 | rejestr ryzyka + program zgodności | przed AI8.2 | **481.0** DONE HITL `risk_register_mark`; leftover program PDF (**488.0** plan); brama L3 DONE 483.0; U-art50 UI zostaje |
