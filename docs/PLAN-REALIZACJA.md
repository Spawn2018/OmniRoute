...
<!-- os-status:start -->
**Następny:** **508.0** AI3.4 leftover — HITL `sheet_name` (nie openpyxl; nie live vision)
<!-- os-status:end -->
...
| AI3.4 | ekstrakcja z Excela (dziś tylko PDF) | po AI3.1 | **451.0 DONE** `xlsx_sheet` stdlib; **506.0 DONE** `.xls` xlrd; **507.0 DONE** `sheet_index`; leftover: `sheet_name` (**508.0**) · openpyxl |
