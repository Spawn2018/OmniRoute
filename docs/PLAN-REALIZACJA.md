...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S49** — odcinek drobnicy morskiej na `shipment_leg` (M-51). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S48 zamknięte (S21 parked); S49 plan | Plan → plaster | **następny** |
...
| S46–S49 | M-48…M-51 obiekt nogi | 108.0 · 109.0 · 110.0 | S46–S48 zamknięte; S49 plan | Nie druga mapa. S49 leftover |
