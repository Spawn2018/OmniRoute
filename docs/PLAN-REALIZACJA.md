...
| **N6** | `margin_floor` per tenant/lane → 409 albo S11 | zamknięty HITL ([527.0](deltas/archived/527.0-margin-floor.md); 409 API [539.0](deltas/archived/539.0-margin-floor-409.md); S11 [544.0](deltas/archived/544.0-margin-floor-s11.md); leftover UI UN / matching / auto charge) | Decimal; nie LLM |
...
| **Plat-HD-flow** | Obieg ticket→owner | Plan→plaster | zamknięty HITL wpis ([545.0](deltas/archived/545.0-product-ticket.md); leftover S11 owner · Mob · auto-fix) | G0+G1 + D2 owner |
