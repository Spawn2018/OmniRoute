...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **76.0** — draft `mail_draft` obok extract (M-57). Accept przez S11. Nie czat. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S12 zamknięte; S13 plaster 76.0 | Plan → plaster | **następny** |
...
| S13 | Żywe **M-57** draft maila obok extract | 76.0 | **następny** | Tabela `mail_draft`. Accept przez S11. Nie czat |
