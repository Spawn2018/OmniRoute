...
**Stan:** B + C.1–C.5 + 0.11–0.15 leftover + **Exit Wave A (D0–0.23)** + **0.25 Money** + **1.0–1.3 charge** + **U-art50** + **U-palette-ops** + D minimal · następny **U-density** (Wave FE; nie Exit Wave FE; Auth0 I1 po U-*)
...
|---|---|---|
| następny | U-density compact + toggle na listach | nie tylko users; nie Exit Wave FE |
