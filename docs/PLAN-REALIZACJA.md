...
| W5 | procurement ranking + szkic maila | delta [203.0](deltas/open/203.0-rank-mark.md) HITL `rank_mark` bez auto-award; leftover ranking SQL / N szkiców | auto-award |
