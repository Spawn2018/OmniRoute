...
<!-- os-status:start -->
**Następny:** **520.0** AI6.0 leftover — HITL `impact_edge_mark` (para from/to; nie SQL; nie EBITDA)
<!-- os-status:end -->
...
| AI6.0 | graf skutku biznesowego: Shipment → Inventory → SKU → Production Line → Customer Order → Revenue → Margin → Cash | po AI5.1 + CI1 | Watch Tower technicznie; **519.0** DONE HITL `impact_node_mark`; **520.0** plan HITL `impact_edge_mark`; leftover: SQL · EBITDA · CT |
