...
<!-- os-status:start -->
**Następny:** **328.0** G7 HITL `cmms_mark` (delta `docs/deltas/open/328.0-cmms-mark.md`).
<!-- os-status:end -->
...
| G7 | CMMS + DTC | 328.0 Plan HITL `cmms_mark` (work_kind); leftover work_order/DTC/V5 | kara kierowcy |
