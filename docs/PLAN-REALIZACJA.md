...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S14** — lock optymistyczny na decyzji (arch. M-187). Dwa okna, dwa Akceptuj. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S13 zamknięte; S14 plan | Plan → plaster | **następny** |
...
| S14 | Arch. **M-187** lock optymistyczny na decyzji | Plan → plaster | **następny** | Dwa okna, dwa Akceptuj |
