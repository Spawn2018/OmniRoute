...
| AI3.4 | ekstrakcja z Excela (dziś tylko PDF) | po AI3.1 | **451.0 DONE** `xlsx_sheet` stdlib; **506.0 DONE** `.xls` xlrd; **507.0 DONE** `sheet_index`; **508.0 DONE** `sheet_name`; leftover: openpyxl (**512.0**) |
