...
| AI1.4 | Słowniki otwarte: `twin_kind`, `data_source`, `autonomy_level`, `suggestion_kind` | **część w kodzie** (436.0 / 346 `suggestion_kind`) | leftover: `twin_kind` / `data_source` / `autonomy_level` + zdjęcie CHECK + FK |
