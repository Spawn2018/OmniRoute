...
| BR6.0 | CRM ponad leada: okazja, aktywność, etap | **start HHL** | **456.0** DONE HITL `crm_opportunity`; **489.0** DONE HITL `crm_activity`; **490.0** DONE HITL `crm_pipeline_mark`; **495.0** DONE HITL `crm_dedup_mark`; leftover: FK · cold-send |
