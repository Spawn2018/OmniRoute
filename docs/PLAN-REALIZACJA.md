...
| AI3.2 | ścieżka **obraz wprost** jako challenger dla obecnej ścieżki przez tekst | po AI3.1 | **449.0** plan `/noc` = `extract_path` text|image jako etykieta; leftover: live vision · pomiar u siebie |
