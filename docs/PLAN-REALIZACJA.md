...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **92.0** — S30 dokumenty na zleceniu (M-38). Nie PDF. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S29 zamknięte (S21 parked); S30 plan 92.0 | Plan → plaster | **następny** |
...
| **S30** | Żywe **M-38** + arch. M-205 dokumenty | 92.0 | plan (`docs/deltas/open/92.0-shipment-document.md`) | Skan = M-20 |
