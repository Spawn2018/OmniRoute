...
<!-- os-status:start -->
**Następny:** **330.0** G10 HITL `company_mark` (delta `docs/deltas/open/330.0-company-mark.md`).
<!-- os-status:end -->
...
| G10 | multi-company w tenancie | 330.0 Plan HITL `company_mark` (seat_kind); leftover company_id FK / drugi tenant | drugi tenant |
