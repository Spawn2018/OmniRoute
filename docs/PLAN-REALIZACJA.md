...
<!-- os-status:start -->
**Następny (zablokowany):** **176.0** G2.7 `tender_win_loss` → G2.8–G2.23 → F → C → V → W → S53 → X → WA1 → Plat → Demo-1 → CT → CI9–CI8 → G → EXP → Mob → K0. D8 parked. D9 leftover D9b–f. P1 leftover P1b–d. P2 leftover P2c. P3 leftover P3b–d. P4 leftover P4b–c. P5 leftover P5b–c. P6 leftover P6c. G2 leftover G2.8–G2.18. Named parks parked — `/noc` pomija aż CURRENT wskaże S53. Nic z pinu 2026-09-08c nie wypada. Nie zgaduj 71–212.
<!-- os-status:end -->
...
| G2.7 | win/loss `tender_win_loss` (wynik + source_ref) | delta [176.0](deltas/open/176.0-tender-win-loss.md) | po G2.6; nie extract RFP; nie four-eyes |
| G2.8–G2.18 | extract RFP HITL, prospecting HITL, bid/no-bid, award four-eyes, TED capability, CO₂, consortium | po G2.7 | auto-award; scrape kontaktów |
