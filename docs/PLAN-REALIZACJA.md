...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S35** — KSeF. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S34 zamknięte (S21 parked); S35 Plan | Plan → plaster | **następny** |
...
| **S35** | KSeF (osobny plaster) | Plan → plaster | **następny** | Sieć prawna |
