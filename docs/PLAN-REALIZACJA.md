...
| AI1.4 | Słowniki otwarte: `twin_kind`, `data_source`, `autonomy_level`, `suggestion_kind` | 436.0 + 437.0 DONE | leftover `autonomy_level` (438.0) · `data_source` (AI5, licencja) + FK |
