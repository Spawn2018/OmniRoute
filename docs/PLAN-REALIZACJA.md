...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S13** — draft maila obok extract (M-57). Accept przez S11. Nie czat. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S12 zamknięte; S13 plan | Plan → plaster | **następny** |
...
| S13 | Żywe **M-57** draft maila obok extract | Plan → plaster | **następny** | Accept przez S11. Nie czat. Nie drugi `rate_line` |
