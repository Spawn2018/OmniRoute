...
**Stan:** B + C.1–C.5 + 0.11–0.15 leftover + **Exit Wave A (D0–0.23)** + **0.25 Money** + **1.0 charge_code** + D minimal · następny **Charge 1.1** (`rate_line`; Auth0 I1 i Wave FE mogą równolegle)
...
|---|---|---|
| następny | Charge 1.1 `rate_line` | nie charge buy+sell; nie 1.0 |
