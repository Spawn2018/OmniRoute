...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S48** — odcinek kolej z Chin na `shipment_leg` (M-50). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S47 zamknięte (S21 parked); S48 plan | Plan → plaster | **następny** |
...
| S46–S49 | M-48…M-51 obiekt nogi | 108.0 · 109.0 | S46–S47 zamknięte; S48 plan | Nie druga mapa. S48–S49 leftover |
