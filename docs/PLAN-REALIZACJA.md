...
| AI1.4 | Słowniki otwarte: `twin_kind`, `data_source`, `autonomy_level`, `suggestion_kind` | plan 439.0 (delta `/noc`) + 436.0–438.0 DONE | 439.0 = FK ledger→słownik; leftover twin_mark CHECK · data_source (AI5) |
