...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **96.0** — S34 tabela faktury sprzedaży (M-40). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S33 zamknięte (S21 parked); S34 plan 96.0 | Plan → plaster | **następny** |
...
| **S34** | Żywe **M-40** faktura | 96.0 | plan (`docs/deltas/open/96.0-sales-invoice.md`) | Fakturujesz zlecenie. Nie KSeF |
