...
| AI7.0 | Cost Allocation Engine — 12 poziomów, 6 kategorii, 23 klucze → `TRUE CONTRIBUTION MARGIN` | po AI0 | marża zostaje w `margin()`; **516.0** DONE `allocation_key`; **517.0** DONE `cost_category_mark`; leftover: 12 poziomów · SQL · TCM · AI7.1 |
