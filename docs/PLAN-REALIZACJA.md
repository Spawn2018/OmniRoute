...
| W4 | Executive AI = narracja po SQL | delta [202.0](deltas/open/202.0-executive-mark.md) HITL `executive_mark` bez sumy LLM; leftover zdania SQL / 117.0 | LLM sumuje |
