...
<!-- os-status:start -->
**Następny (zablokowany):** 52.0 U-money-align oś dziesiętna na `<Money/>`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| **U-money-align** | kwota wyrównana do przecinka + kod waluty | `<Money/>` bez osi dziesiętnej | `money.tsx` · Plan 52.0 |
