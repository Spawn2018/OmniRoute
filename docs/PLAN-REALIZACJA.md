...
<!-- os-status:start -->
**Następny:** **579.0** leftover T3 HITL `container.delivery_date`. Nie `unload_date`. Nie cutoff timestamptz. Nie `temp_min`. Nie N3. Nie ciphertext. Nie AI3-payload. Nie G0-SH.
<!-- os-status:end -->
