...
| AI1.4 | Słowniki otwarte: `twin_kind`, `data_source`, `autonomy_level`, `suggestion_kind` | 436.0–439.0 DONE | leftover FK `twin_mark` (440.0) · `data_source` (AI5) · `outcome_kind` CHECK |
