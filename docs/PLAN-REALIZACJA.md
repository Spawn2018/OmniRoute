...
| F10 | ingest FV HITL + ranking SQL | zamknięty HITL ([549.0](deltas/archived/549.0-purchase-invoice.md)); delta **550.0** HITL `invoice_match_mark` (open); leftover `invoice_match_candidate` / ranking SQL / allocation | po F9 + X9 |
