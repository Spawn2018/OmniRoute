...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **110.0** — S48 odcinek kolej z Chin (M-50). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S47 zamknięte (S21 parked); S48 plan 110.0 | Plan → plaster | **następny** |
...
| S46–S49 | M-48…M-51 obiekt nogi | 108.0 · 109.0 · 110.0 | S46–S47 zamknięte; S48 plan (`docs/deltas/open/110.0-shipment-leg-china-rail.md`) | Nie druga mapa. S49 leftover |
