...
| G2.1 | partia `tender_lot` | zamknięty ([170.0](deltas/archived/170.0-tender-lot.md); leftover G2.2–G2.18) | po G2.0; nie lane; nie kwota |
| G2.2–G2.18 | rundy, data room+NDA, extract RFP HITL, matryca Excel (LLM mapuje kolumny, kwoty z P), playbook, prospecting HITL, bid/no-bid, award four-eyes, win/loss, TED capability, CO₂, consortium | po G2.1 | auto-award; scrape kontaktów |
