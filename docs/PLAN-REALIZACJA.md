...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **99.0** — S37 bank i płatności (M-42). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S36 zamknięte (S21 parked); S37 plan 99.0 | Plan → plaster | **następny** |
...
| **S37** | Żywe **M-42** bank | 99.0 | plan (`docs/deltas/open/99.0-bank-payment.md`) | Faktura na rachunek. Nie SEPA. Nie druga marża |
| S38–S42 | M-43…M-47 kolejno Fali 6 | Plan → plaster | po S37 | Każdy ID = osobny plaster. Decimal. LLM nie liczy |
