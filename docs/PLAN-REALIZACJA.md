...
| G2.2 | korytarz `tender_lane` | delta [171.0](deltas/open/171.0-tender-lane.md) | po G2.1; nie runda; nie kwota |
| G2.3–G2.18 | rundy, data room+NDA, extract RFP HITL, matryca Excel (LLM mapuje kolumny, kwoty z P), playbook, prospecting HITL, bid/no-bid, award four-eyes, win/loss, TED capability, CO₂, consortium | po G2.2 | auto-award; scrape kontaktów |
