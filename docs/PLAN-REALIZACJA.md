...
<!-- os-status:start -->
**Następny (zablokowany):** 55.0 U-i18n-structure klucze pl na `/quality` i `/rollout`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| **U-i18n-structure** | klucze + locale format; jeden język (pl) w paczce | hardcoded string w **nowym** ekranie | nowe trasy · Plan 55.0 |
