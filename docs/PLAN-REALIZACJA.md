...
| T5 | task engine (warunki = dane) | Plan → plaster ([263.0](deltas/open/263.0-task-template.md); leftover instancja `task` / matching SQL / outbox) | po T2 | async po konsumencie outboxa (leftover M-02) |
