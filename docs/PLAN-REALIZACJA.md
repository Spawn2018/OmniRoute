...
| T3 | `container` ISO + EXP1 (VGM, free time, BL kind, cutoffy CY/CFS/VGM/SI/AMS) | zamknięty ([153.0](deltas/archived/153.0-container.md); leftover T3 `seal_no_1` [216.0](deltas/archived/216.0-container-seal.md); leftover T3 `seal_no_2` [217.0](deltas/archived/217.0-container-seal2.md); leftover T3 `seal_no_3` delta [218.0](deltas/open/218.0-container-seal3.md); leftover EXP1 VGM/cutoffy/PIN; leftover `vessel_name`/`voyage_no`) | po T1 | nie booking armatorski |
