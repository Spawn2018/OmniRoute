...
<!-- os-status:start -->
**Następny (zablokowany):** 53.0 U-condensed trzeci tryb gęstości na `/rate-lines`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| **U-condensed** | trzeci tryb gęstości na gridzie stawek | condensed globalnie albo brak na `rate_line` | DataTableShell · Plan 53.0 |
