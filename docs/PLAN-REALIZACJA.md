...
<!-- os-status:start -->
**Następny:** **598.0** T2 leftover HITL `resource.driver_card_no` (brak delty). **588.0** SH-R16-4 UXCL banner = park `/noc`. Job#2 po bannerze. Nie AI3. Nie G0-SH. Nie N3.
<!-- os-status:end -->
