...
| T4 | `parent_shipment_id`; rentowność SQL na `charge` | Plan → plaster (delta [210.0](deltas/open/210.0-shipment-parent.md); leftover T4b SQL na `charge`) | po T1 | nie druga marża |
