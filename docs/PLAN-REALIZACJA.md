...
| AI1.2 | `counterfactual_run` — scenariusz, punkt odniesienia, dźwignie, wynik; niemutowalny | plan 434.0 (delta `/noc`) | HITL etykiety jako dane; silnik = leftover AI4.1; nie klon what_if_mark |
