...
| AI2.0 | CRPS, Brier, MAE **liczone** ze złączenia AI1.0×AI1.1 | po AI1.1 | **443.0 DONE** widok MAE/CRPS; **446.0** plan `/noc` = POST `prediction_ledger` bez wpisu; leftover: Brier · dump `04b`: Oracle LML 95% interval = metoda, nie CRPS/MAE |
