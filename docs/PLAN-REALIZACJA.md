...
| AI7.0 | Cost Allocation Engine — 12 poziomów, 6 kategorii, 23 klucze → `TRUE CONTRIBUTION MARGIN` | po AI0 | marża zostaje w `margin()`; **516.0** plan HITL `allocation_key` (otwarty słownik); leftover: 12 poziomów · 6 kategorii · SQL · TCM · AI7.1 |
