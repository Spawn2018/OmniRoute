...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S34** — żywe M-40 faktura. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S33 zamknięte (S21 parked); S34 Plan | Plan → plaster | **następny** |
...
| **S34** | Żywe **M-40** faktura | Plan → plaster | **następny** | Fakturujesz zlecenie |
