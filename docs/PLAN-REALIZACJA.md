...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S36** — rozliczenie wyceny z fakturą (M-41). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S35 zamknięte (S21 parked); S36 plan M-41 | Plan → plaster | **następny** |
