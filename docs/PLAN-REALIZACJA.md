...
<!-- os-status:start -->
**Następny:** **497.0** BR6.1 leftover — HITL `sales_bind_mark` (`bind_kind` opportunity|party|other; nie HubSpot live, nie FK UUID)
<!-- os-status:end -->
...
| BR6.1 | **korytarz jako obiekt sprzedażowy** | po BR6.0 | **460.0** DONE HITL `sales_lane`; **491.0** DONE para UN/LOCODE; **492.0** DONE `volume_label` tekst; leftover: HubSpot live park · FK stance (**497.0** plan) |
