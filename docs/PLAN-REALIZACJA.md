...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **75.0** — tabela `operator_notice` (M-34). Nie filtr pending z wycen. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S11 zamknięte; S12 plan 75.0 | Plan → plaster | **następny** |
...
| S12 | Żywe **M-34** tabela powiadomień | 75.0 | **następny** | Tabela `operator_notice`. Nie filtr pending z wycen |
