...
| G2.9–G2.18 | extract RFP HITL, prospecting HITL, bid/no-bid, award four-eyes, TED capability, CO₂ | zamknięty intake ([178.0](deltas/archived/178.0-tender-rfp-intake.md)); zamknięty kind/accept ([179.0](deltas/archived/179.0-tender-rfp-draft-kind.md)); delta [180.0](deltas/open/180.0-tender-prospect.md) prospect HITL; leftover G2.11–G2.18 | auto-award; scrape kontaktów |
