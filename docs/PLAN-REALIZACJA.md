...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **111.0** — S49 odcinek drobnicy morskiej (M-51). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S48 zamknięte (S21 parked); S49 plan 111.0 | Plan → plaster | **następny** |
...
| S46–S49 | M-48…M-51 obiekt nogi | 108.0 · 109.0 · 110.0 · 111.0 | S46–S48 zamknięte; S49 plan (`docs/deltas/open/111.0-shipment-leg-ocean-lcl.md`) | Nie druga mapa. S50 leftover |
