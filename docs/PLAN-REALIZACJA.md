...
<!-- os-status:start -->
**Następny:** **326.0** G5 HITL `oog_mark` (delta `docs/deltas/open/326.0-oog-mark.md`).
<!-- os-status:end -->
...
| G5 | OOG / lashing / eskort | 326.0 Plan HITL `oog_mark` (escort_kind); leftover wymiary/cert/T1 | |
