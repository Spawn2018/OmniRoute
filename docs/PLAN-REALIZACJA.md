...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **101.0** — S39 różnice kursowe (M-44). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S38 zamknięte (S21 parked); S39 plan 101.0 | Plan → plaster | **następny** |
...
| **S39** | Żywe **M-44** różnice kursowe | 101.0 | plan (`docs/deltas/open/101.0-fx-difference.md`) | Wycena przy kursie NBP. Nie przeliczenie |
| S40–S42 | M-45…M-47 kolejno Fali 6 | Plan → plaster | po S39 | Każdy ID = osobny plaster. Decimal. LLM nie liczy |
