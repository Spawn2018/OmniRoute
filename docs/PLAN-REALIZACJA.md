...
<!-- os-status:start -->
**Następny (zablokowany):** **8.0** M-11 `resolve_email` ([delta](../deltas/open/8.0-party-email-match.md)). Nie Fala 8.
<!-- os-status:end -->
...
| F2.0 | **M-11 Automatyczne kontakty** | Plan → plaster | delta **8.0** zaakceptowana `/noc`; plaster |
