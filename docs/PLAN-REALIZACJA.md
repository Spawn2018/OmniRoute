...
| G2.19–G2.22 | `lane_pattern`, `circle_sim` ≥500k w Postgres, km ładowny/pusty/dolot, lista przewoźników | delta [185.0](deltas/open/185.0-lane-pattern.md) HITL para UN/LOCODE; leftover G2.20–G2.22 circle_sim/km/P | LLM-VRP; copy „natychmiast” bez p95 stage |
