...
<!-- os-status:start -->
**Następny (zablokowany):** 21.0 M-28 `customer_inquiry` (`/plaster`). Ślad wycen per party. Nie tabela. Nie IMAP.
<!-- os-status:end -->
...
| F3.5 | **M-28 Zapytania od klientów** | Plan → plaster | Plan (`docs/deltas/open/21.0-customer-inquiry.md`) |
