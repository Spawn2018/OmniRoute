...
<!-- os-status:start -->
**Następny:** plan **612.0** T3 `destination_city` (nie HW, nie UXCL, nie N3). **588.0** SH-R16-4 UXCL = park `/noc`.
<!-- os-status:end -->
