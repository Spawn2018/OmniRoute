...
| **EXP0.9** | UN: `adr_tunnel_code` + `segregation_group` | zamknięty HITL tunel ADR + SG ([192.0](deltas/archived/192.0-dangerous-good-adr.md)); packing group → **642.0** (delta open); leftover live IMO | LLM nie nadaje klasy |
