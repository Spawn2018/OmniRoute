...
<!-- os-status:start -->
**Następny (zablokowany):** 42.0 M-49 `intermodal_rail` tablica `/rail`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| F7.1 | **M-49 Kolej intermodalna** | Plan | kolejka (`/plan-modul`; nie zgaduj schematu) |
...
| M-48–M-51 | Modały | Fala 7 (M-48 DONE fundament 41.0) |
