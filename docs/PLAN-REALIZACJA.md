...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **109.0** — S47 odcinek kolejowy (M-49). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S46 zamknięte (S21 parked); S47 plan 109.0 | Plan → plaster | **następny** |
...
| S46–S49 | M-48…M-51 obiekt nogi | 108.0 · 109.0 | S46 zamknięty; S47 plan (`docs/deltas/open/109.0-shipment-leg-rail.md`) | Nie druga mapa. S48–S49 leftover |
