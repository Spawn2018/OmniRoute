...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S18** — wysyłka po S11+S10 (M-33). Graph send albo świadomy `mailto:`. Auto-send zakazane. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S17 zamknięte; S18 send | Plan → plaster | **następny** |
...
| **S18** | Żywe **M-33** wysyłka po S11+S10 | Plan → plaster | **następny** | Graph send albo świadomy `mailto:`. Auto-send zakazane |
