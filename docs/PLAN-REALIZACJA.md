...
<!-- os-status:start -->
**Następny (zablokowany):** 23.0 M-30 `carrier_inquiry` (`/plaster`). Ślad `channel_quote` przy lane. Nie tabela RFQ. Nie live HTTP.
<!-- os-status:end -->
...
| F3.7 | **M-30 Zapytania do agentów/armatorów** | Plan → plaster | Plan (`docs/deltas/open/23.0-carrier-inquiry.md`) |
