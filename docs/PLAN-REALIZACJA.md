...
| T7 | `fx_rate_basis` SQL; kalendarz U4 | Plan → plaster (delta [211.0](deltas/open/211.0-fx-rate-basis.md); leftover T7b override/`charge`; leftover T7c U4 D-1) | po T1+U4 | LLM/JS nie liczą |
