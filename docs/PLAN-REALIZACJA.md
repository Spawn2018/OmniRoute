...
<!-- os-status:start -->
**Następny (zablokowany):** 45.0 M-53 `sanctions` tablica `/sanctions`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| F8.0 | **M-53 Sankcje** | Plan | kolejka (`/plan-modul`; M-52 już 7.0; nie zgaduj schematu) |
