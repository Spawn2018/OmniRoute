...
| ID | Co | Status | Poza |
|---|---|---|---|
| W1 | 8 twinów (pojazd, kierowca, kontener, zlecenie, sieć, plan, urząd, ładunek) | delta [199.0](deltas/open/199.0-twin-mark.md) HITL `twin_mark` bez fizyki; leftover `plan_snapshot` / 8 silników | twin ≠ fizyka; kółka = G2.20 |
