...
| T7 | `fx_rate_basis` SQL; kalendarz U4 | zamknięty HITL ([211.0](deltas/archived/211.0-fx-rate-basis.md); leftover T7b override/`charge` — plan 615.0; leftover T7c U4 D-1) | po T1+U4 | LLM/JS nie liczą |
