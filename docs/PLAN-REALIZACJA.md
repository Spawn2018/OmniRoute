...
<!-- os-status:start -->
**Następny (zablokowany):** 67.0 S4 `/plaster` — `customer_rfq` powiązany z `inbound_message`. Nie ślad wycen. Nie silnik. Nie IMAP. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S3 zamknięte; S4 plan 67.0 | Plan → plaster | **następny** |
...
| S4 | Żywe **M-28** obiekt RFQ powiązany z wiadomością | 67.0 | **następny** | Nie ślad wycen. S5 = silnik |
