...
| BR6.2 | przetargi korporacyjne po stronie załadowcy | po G2 | **461.0** DONE HITL `shipper_tender_mark`; **493.0** DONE HITL `shipper_round_mark`; **494.0** DONE HITL `shipper_like_mark`; leftover: Alpega live park · FK stance (**498.0** plan) · auto-award |
