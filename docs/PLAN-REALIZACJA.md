...
| **EXP0.8** | `cargo_claim` deadline CMR 7/21/365 + OS&D | zamknięty HITL OS&D + terminy ([191.0](deltas/archived/191.0-cargo-claim-cmr.md)); evidence → Plan **645.0** (trzy bool); leftover Deadline Engine / S11 | nie kwota z LLM |
