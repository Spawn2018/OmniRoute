...
| T2 | `trip` + `resource`; floating trailer; multi-manning | zamknięty (`resource` [151.0](deltas/archived/151.0-resource.md); `trip` [152.0](deltas/archived/152.0-trip.md); leftover T2c `driver2` delta [212.0](deltas/open/212.0-trip-driver2.md); leftover T2c km/`party`/`/fleet`) | po T1 | nie własne HW; job S50 |
