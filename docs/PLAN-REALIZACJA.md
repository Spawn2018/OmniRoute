...
<!-- os-status:start -->
**Następny (zablokowany):** `/plan-modul` **S27** — sankcje HTTP na `party` (M-53). Nie auto-match. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S26 zamknięte (S21 parked); S27 Plan | Plan → plaster | **następny** |
