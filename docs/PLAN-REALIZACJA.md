...
<!-- os-status:start -->
**Następny (zablokowany):** 17.0 M-24 Ryzyko oferty (`/plan-modul`). Nie zgaduj schematu.
<!-- os-status:end -->
...
| F3.1 | **M-24 Ryzyko oferty** | Plan → plaster | kolejka (`/plan-modul`; nie zgaduj schematu) |
