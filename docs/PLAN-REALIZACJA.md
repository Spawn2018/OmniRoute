...
| po parks | **P0** → pełna oś pinu **2026-09-08c** (O/I/U/T/D/P/G2/F/C/V/W/X/Plat/CT/CI/G/EXP) | Plan → plaster | **O3 136.0 zamknięty; I0/U2 137.0 następny** |
...
|---|---|---|---|---|
| **I0 / U2** | `quotation.incoterm` + `trade_side` + `named_place` + wersja 2020/2010 | Plan → plaster | **delta 137.0 zaakceptowana** | DAP bez miejsca = 409; nie cytat ICC |
