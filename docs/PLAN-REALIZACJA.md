...
| AI1.4 | Słowniki otwarte: `twin_kind`, `data_source`, `autonomy_level`, `suggestion_kind` | plan 436.0 (delta `/noc`) | pierwszy = HITL `suggestion_kind` bez CHECK; leftover twin/data_source/autonomy + FK |
