...
| V2 / V2b | ETA **dwa czasy** `eta_physical`/`eta_legal` + pogoda; myto → `charge`+`source_ref` | zamknięty HITL dwa czasy na `stop` ([194.0](deltas/archived/194.0-stop-eta.md)); leftover pogoda / myto | brak taryfy = warning |
