...
| AI9.1 | przeciwdziałanie automation bias w interfejsie | równolegle od AI3 | **482.0** DONE HITL `automation_bias_mark`; leftover ui-04 pewność (**487.0** delta HITL `field_confidence_mark`); U-art50 zostaje |
