...
<!-- os-status:start -->
**Następny (zablokowany):** 54.0 U-primitives-json pin Radix w `components.json`. Nie zgaduj schematu. Nie nowa tabela.
<!-- os-status:end -->
...
| **U-primitives-json** | `frontend/components.json` base radix | `shadcn add` bez `-b radix` wciąga Base UI | CLI · Plan 54.0 |
