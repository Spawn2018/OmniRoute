...
| AI1.3 | `benefit_ledger` — zaoszczędzony czas i pieniądze **z jawną metodą punktu odniesienia** | plan 435.0 (434.0 DONE) | bez zapisanej metody liczba jest nieweryfikowalna; dump `04b`: druga marża SAP/Oracle/Shipwell = zakaz |
