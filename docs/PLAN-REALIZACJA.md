...
<!-- os-status:start -->
**Następny (zablokowany):** 17.0 M-24 `offer_risk` przy `quotation` (`/plaster`). Czyta recenzję i kartę. Nie scoring. Nie nowa tabela.
<!-- os-status:end -->
...
| F3.1 | **M-24 Ryzyko oferty** | Plan → plaster | Plan (`docs/deltas/open/17.0-offer-risk.md`) |
