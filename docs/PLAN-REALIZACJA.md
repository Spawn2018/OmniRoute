...
<!-- os-status:start -->
**Następny (zablokowany):** S6 `/plan-modul` — ewaluacja `applies_when` w SQL. Nie zapis marży do `charge`. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S5 zamknięte; S6 Plan | Plan | **następny** |
...
| S6 | Żywe **M-18** ewaluacja `applies_when` w SQL | Plan → plaster | **następny** | Nie zapis marży do `charge` |
