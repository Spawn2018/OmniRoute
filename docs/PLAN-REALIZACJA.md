...
| V3 | D&D / rollover + zegar N3 + blank sailing EXP2.7 | zamknięty HITL katalog ([196.0](deltas/archived/196.0-free-time-clock.md)); zamknięty HITL blank sailing ([565.0](deltas/archived/565.0-blank-sailing-mark.md)); zamknięty HITL `demurrage_free_days` ([566.0](deltas/archived/566.0-container-demurrage-days.md)); zamknięty HITL `detention_free_days` ([567.0](deltas/archived/567.0-container-detention-days.md)); leftover N3 countdown / szkic charge / `mixed_dd_days` | |
