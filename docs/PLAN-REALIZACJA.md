...
| AI1.4 | Słowniki otwarte: `twin_kind`, `data_source`, `autonomy_level`, `suggestion_kind` | plan 437.0 (delta `/noc`) + 436.0 DONE | 437.0 = HITL `twin_kind` bez CHECK; leftover data_source/autonomy + FK |
