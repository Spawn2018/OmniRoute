...
| po parks | **P0** → pełna oś pinu **2026-09-08c** (O/I/U/T/D/P/G2/F/C/V/W/X/Plat/CT/CI/G/EXP) | Plan → plaster | **O0 delta, wolno plaster** |
...
| **O0** | `network_member.party_id` FK tenanta | Plan → plaster | **delta, wolno plaster** | Delta [130.0-network-member-party.md](deltas/open/130.0-network-member-party.md). 409 rankingu = O3 |
