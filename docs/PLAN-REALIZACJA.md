...
<!-- os-status:start -->
**Następny (zablokowany):** `/plaster` **103.0** — S41 koszt obsługi (M-46). Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S40 zamknięte (S21 parked); S41 plan 103.0 | Plan → plaster | **następny** |
...
| **S41** | Żywe **M-46** koszt obsługi | 103.0 | plan (`docs/deltas/open/103.0-cost-to-serve.md`) | SOP przy wycenie. Nie ABC. Nie suma |
