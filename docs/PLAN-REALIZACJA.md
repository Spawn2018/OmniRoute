...
| **B0a** | `entity_event` append-only | Plan → plaster | zamknięty (`docs/deltas/archived/133.0-entity-event.md`); leftover 2a [244.0](deltas/archived/244.0-inquiry-queued-event.md); leftover 2b delta [245.0](deltas/open/245.0-inquiry-sent-event.md) | Kind: `inquiry_queued` / `inquiry_sent` / `quote_recorded`. 2a = compose z API. Ledger/what-if = B0b po T2 |
