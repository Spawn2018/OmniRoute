...
| F10 | ingest FV HITL + ranking SQL | zamknięty HITL ([549.0](deltas/archived/549.0-purchase-invoice.md)); [550.0](deltas/archived/550.0-invoice-match-mark.md) `invoice_match_mark`; leftover `invoice_match_candidate` / ranking SQL / `purchase_invoice_allocation` → **551.0** | po F9 + X9 |
