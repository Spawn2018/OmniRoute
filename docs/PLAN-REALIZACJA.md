...
| AI3.0 | `PATCH` na `extraction_draft` + edycja w interfejsie przed akceptacją | po AI2.0 | **447.0 DONE** PATCH `candidates` na pending/`rate_line`; **500.0 DONE** PATCH `carrier_quote`/`tender_rfp`; **501.0** plan — próg **70%** przed accept zbiorczym; leftover: wersja/bbox (AI3.1) · partial write · M-03 `hitl_confidence_*` (`07`) |
