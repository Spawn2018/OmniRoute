...
<!-- os-status:start -->
**Następny:** **511.0** AI3.3 leftover — pętla golden ≥5000 pytest (nie DocLayNet; nie live vision)
<!-- os-status:end -->
...
| AI3.3 | własny zbiór golden + bramka wydaniowa na progach | po AI3.2 | **450.0 DONE** pytest vs THC/BAF; **509.0 DONE** golden ≥500; **510.0 DONE** golden ≥2000; leftover: pętla 5 000 (**511.0**) · DocLayNet / PubTables-1M / CORD / Kleister (licencje, `07`) · instructor CI · 96,6% `TO_VERIFY`; FUNSD / RVL-CDIP `REJECTED` |
