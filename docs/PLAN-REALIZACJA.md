...
<!-- os-status:start -->
**Następny:** leftover **N1 stop** na `consignment` albo **AI3-payload** (park). Nie SH-R16-13. Nie AI0.
<!-- os-status:end -->
...
| **N1** | `consignment` obok `shipment` | zamknięty HITL ([260.0](deltas/archived/260.0-consignment.md); FTL=1 409 [540.0](deltas/archived/540.0-consignment-ftl-409.md); D2b FK paczki [541.0](deltas/archived/541.0-package-consignment-fk.md); leftover `stop`) | po T1, przed D2 | leftover `stop`; LTL/LCL=N |
