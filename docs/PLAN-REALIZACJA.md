...
<!-- os-status:start -->
**Następny:** **490.0** BR6.0 leftover — pipeline CRM (katalog HITL; nie silnik)
<!-- os-status:end -->
...
| BR6.0 | CRM ponad leada: okazja, aktywność, pipeline | **start HHL** | **456.0** DONE HITL `crm_opportunity`; **489.0** DONE HITL `crm_activity`; leftover: pipeline (**490.0** plan) |
