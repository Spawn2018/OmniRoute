...
<!-- os-status:start -->
**Następny (zablokowany):** S5 `/plan-modul` — istniejący silnik wyceny na tym RFQ. Nie nowy silnik. LLM nie liczy. Nie F9.1.
<!-- os-status:end -->
...
| po Q-E4 | **Fala S**, S1–S4 zamknięte; S5 Plan | Plan | **następny** |
...
| S5 | Żywe **M-21** istniejący silnik na tym RFQ | Plan → plaster | **następny** | Nie nowy silnik. LLM nie liczy |
