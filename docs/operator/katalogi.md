...
Czego tu nie ma: 70 osobnych instrukcji na pulpity odczytu (FV). Zlecenie: [zlecenie.md](zlecenie.md). Tracking: [tracking.md](tracking.md). Dokument: [dokument-zlecenia.md](dokument-zlecenia.md). Wyjątek: [wyjatek.md](wyjatek.md). Wieża: [wieza.md](wieza.md). EDI: [edi.md](edi.md). Ścieżka extract → stawka → opłata → wycena jest w [ścieżka-pieniędzy.md](ścieżka-pieniędzy.md). Kontrahent: [kontrahent.md](kontrahent.md).
