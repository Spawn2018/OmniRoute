...
- wyjątki `/exceptions` i reklamacje `/claims` — `operational_exception` / `cargo_claim`. How-to: [wyjatek.md](wyjatek.md), [reklamacja.md](reklamacja.md). Nie mapa. Nie kwota.
