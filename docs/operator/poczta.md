...
7. „Utwórz RFQ” robi zapytanie ofertowe z tej wiadomości. Jedna wiadomość = jedno zapytanie. „Wycena” otwiera `/quotations` z tym RFQ — kwota schodzi ze stawki, nie stąd.
