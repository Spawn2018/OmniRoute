...
7. „Utwórz RFQ” robi zapytanie ofertowe z tej wiadomości. Jedna wiadomość = jedno zapytanie. Kod HS/CN wybierasz z katalogu i „Podpnij HS” — to etykieta ładunku, nie kwota. „Wycena” otwiera `/quotations` z tym RFQ — kwota schodzi ze stawki, nie stąd.
