...
4. Kontakty, IBAN i domeny maila dopinasz do **tej** karty. Na kontakcie zaznaczasz HITL zgodę na śledzenie (`tracking_consent`) — to flaga na karcie, nie katalog BR2.2 i nie live GPS. Matcher maila sam nic nie wstawia.
