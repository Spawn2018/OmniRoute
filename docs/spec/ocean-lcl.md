...
**Plaster:** **44.0** (zamknięty)  
**Status:** operator **widzi** porty morskie. Nie tabela LCL. Nie CFS.

Delta: [docs/deltas/archived/44.0-ocean-lcl.md](../deltas/archived/44.0-ocean-lcl.md).
