...
| M-23 | Kurs NBP | 6.0 `nbp_rate` (delta) | **w toku** · nie przeliczenie wyceny; nie żywe M-07 `rate_line` |
...
Dziś: `tenancy.md`, `extraction.md`, `charge-code.md`, `rate-line.md`, `charge.md`, `quotation.md`, `organization-setting.md`, `geography.md` (4.0–4.2 w kodzie), `parties.md` (5.0 w kodzie), `commodity-code.md` (5.2 w kodzie), `nbp-rate.md` (6.0 delta). Szkielety uzupełniane przy plastrze — nie kompiluj całego archiwum.
