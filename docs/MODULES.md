...
| B0b | Ledger predykcji | 193.0 `prediction_ledger` · 265.0 `plan_snapshot` | **ukończony (HITL)** · przedział + wpis CRPS/MAE; **446.0** plan zdejmuje wpis; leftover Brier / champion |
