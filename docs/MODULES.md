...
| M-05 | Geografia | 4.0 `port` + 4.1 `location`/strefy + 4.2 `terminal`/WPI | **ukończony (fundament)** · operator = tekst; `operator_party_id` = 5.0 |
...
Dziś: `tenancy.md`, `extraction.md`, `charge-code.md`, `rate-line.md`, `charge.md`, `quotation.md`, `organization-setting.md`, `geography.md` (4.0–4.2 w kodzie), `parties.md` (szkielet 5.0, nie w kodzie). Szkielety uzupełniane przy plastrze — nie kompiluj całego archiwum.
