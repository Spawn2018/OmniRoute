...
| M-20 | Ekstrakcja dokumentów | 0.7–0.14 HITL + T0 + 0.18 live HTTP PG + 1.3 accept→rate_line + U-art50 + U-pdf-spans + 2.1–2.2 · 66.0 z `inbound_message` · **447.0** PATCH · **448.0** revision | **ukończony (fundament)** · **449.0** plan `extract_path`; ExtractionService nie importuje rates ani inbound |
