...
| AI9.2 | Rejestr ryzyka HITL | 481.0 `risk_register_mark` · **488.0** plan `compliance_program_mark` | **ukończony (HITL rejestr)** · leftover program PDF w delcie; U-art50 zostaje |
