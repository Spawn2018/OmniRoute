...
| M-20 | Ekstrakcja dokumentów | 0.7–0.14 HITL + T0 + 0.18 live HTTP PG + 1.3 accept→rate_line + U-art50 + U-pdf-spans + 2.1–2.2 · 66.0 z `inbound_message` · **447.0** PATCH · **448.0** revision/bbox | **ukończony (fundament)** · leftover AI3.2 obraz; ExtractionService nie importuje rates ani inbound |
