...
| M-11 | Automatyczne kontakty | 8.0 `resolve_email` (delta) | **w toku** · matcher domeny z 5.0; nie IMAP; nie portal |
...
Dziś: `tenancy.md`, `extraction.md`, `charge-code.md`, `rate-line.md`, `charge.md`, `quotation.md`, `organization-setting.md`, `geography.md` (4.0–4.2 w kodzie), `parties.md` (5.0 w kodzie, 8.0 delta matcher maila), `commodity-code.md` (5.2 w kodzie), `nbp-rate.md` (6.0 w kodzie), `dangerous-good.md` (7.0 w kodzie). Szkielety uzupełniane przy plastrze — nie kompiluj całego archiwum.
