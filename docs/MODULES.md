...
| CI9 | Umowa klienta HITL | 272.0–273.0 `customer_contract` · 274.0 `tenant_contract_kek` | **ukończony (HITL nagłówek + opaque BYTEA)** · 274.0 Kod znacznik owijki (nie klucz); leftover `wrapped_dek` / KMS |
