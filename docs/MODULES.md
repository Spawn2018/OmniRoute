...
| M-28 | Zapytania od klientów | 21.0 `customer_inquiry` · 67.0 `customer_rfq` | **ukończony (fundament)** · ślad wycen per party + obiekt RFQ z wiadomości; nie silnik wyceny; nie IMAP |
