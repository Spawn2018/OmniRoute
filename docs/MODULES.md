...
| M-09 | Kody towarowe | 5.2 `commodity_code` (delta) | **w toku** · nie podpięcie do wyceny; nie IMDG |
...
Dziś: `tenancy.md`, `extraction.md`, `charge-code.md`, `rate-line.md`, `charge.md`, `quotation.md`, `organization-setting.md`, `geography.md` (4.0–4.2 w kodzie), `parties.md` (5.0 w kodzie), `commodity-code.md` (5.2 delta). Szkielety uzupełniane przy plastrze — nie kompiluj całego archiwum.
