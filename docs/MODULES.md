...
| AI9.1 | Automation bias HITL | 482.0 `automation_bias_mark` · **487.0** plan `field_confidence_mark` | **ukończony (HITL bias)** · leftover ui-04 pewność w delcie; U-art50 zostaje |
