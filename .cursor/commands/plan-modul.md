...
1. Wypisz pozycję kolejki z CURRENT (np. Q-E1, S1 M-32) oraz czego NIE robisz. Live Auth0 / portale / konsument M-02 **pomijaj**, chyba że CURRENT to właśnie ten ID. Leftover HITL/SQL z osi = planuj. Kolizje ID z PLAN § mapa kolizji — nie nadpisuj żywego M-07/M-08/M-52/M-57.
