...
4. `PROC-UXCL.md` + `DECISION-INBOX.md` (sesja **firmy**, nie plaster)
5. Trigger A2/A3: PM-FAC / AAR. Po idle: **P-Y**. Przy `/noc` busy: `PACK-STOP.md` — nie nowy OS. G0: PRR. Nie dump. Nie elite. Recurrence ≥1 → dwuobieg. Andon ≠ skill #11. Nie `module-factory` na leftover.

## Kroki

1. Semafor: `NOC-LIVE` `busy` albo `/noc` w toku → **zakaz** edycji drzewa OmniRoute. Wolno karty w badaniach i dopisek D1/D2 do `DECISION-INBOX.md`.
