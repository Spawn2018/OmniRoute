...
8e. `python scripts/quality/factory_cycle.py --close` — bench, karta z powtórzonych czerwonych CI, podłoga jakości tylko w górę. Operator nie redaguje. **Nie** dopisuj zasad do AGENTS. **Nie** ruszaj GROUNDING.
